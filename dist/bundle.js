...
!(function (e) {
		...
		Object.create &&
			...
			(l.prototype.eventNames = function () {
				...
				for (a in (e = this._events))
					n.call(e, a) && t.push(r ? a.slice(1) : a);
			...
			(l.prototype.listeners = function (e) {
				...
				if (!t) return [];
				if (t.fn) return [t.fn];
				for (var n = 0, i = t.length, c = new Array(i); n < i; n++)
					c[n] = t[n].fn;
				return c;
			}),
			...
			(l.prototype.removeListener = function (e, a, t, n) {
				...
				if (c.fn)
					c.fn !== a || (n && !c.once) || (t && c.context !== t) || s(this, i);
				else {
					for (var o = 0, l = [], d = c.length; o < d; o++)
						(c[o].fn !== a || (n && !c[o].once) || (t && c[o].context !== t)) &&
							l.push(c[o]);
			...
			(l.prototype.removeAllListeners = function (e) {
				...
				return (
					e
						? ((a = r ? r + e : e), this._events[a] && s(this, a))
						: ((this._events = new i()), (this._eventsCount = 0)),
					this
				);
			}),
	...
	125: function (e, a, t) {
		(function (a) {
			...
			var d,
				...
				p = (d = /[^.]+$/.exec((g && g.keys && g.keys.IE_PROTO) || ""))
					? "Symbol(src)_1." + d
					: "",
				y = h.toString,
				f = m.hasOwnProperty,
			...
			function U(e, a) {
				if ("function" != typeof e || (a && "function" != typeof a))
			...
			(C.prototype.clear = function () {
				...
				(N.prototype.delete = function (e) {
					var a = this.__data__,
						t = D(a, e);
					return (
						!(t < 0) && (t == a.length - 1 ? a.pop() : S.call(a, t, 1), !0)
					);
				}),
	...
	126: function (e, a, t) {
		...
		(function (a) {
			...
			var u = "undefined" == typeof window ? null : window,
				...
				f = function (e) {
					return e && e.instanceString && _(e.instanceString)
						? e.instanceString()
						: null;
				},
				v = function (e) {
								...
								return (
									4 === e.length
										? ((a = parseInt(e[1] + e[1], 16)),
										  (t = parseInt(e[2] + e[2], 16)),
										  (n = parseInt(e[3] + e[3], 16)))
										: ((a = parseInt(e[1] + e[2], 16)),
										  (t = parseInt(e[3] + e[4], 16)),
										  (n = parseInt(e[5] + e[6], 16))),
									[a, t, n]
								);
							}
						})(e) ||
							...
							if (d) {
								if (
									((t = parseInt(d[1])) < 0
										...
										: t > 360 && (t %= 360),
									(t /= 360),
									(n = parseFloat(d[2])) < 0 || n > 100)
								)
									return;
								if (((n /= 100), (r = parseFloat(d[3])) < 0 || r > 100)) return;
								if (
									((r /= 100),
									void 0 !== (i = d[4]) && ((i = parseFloat(i)) < 0 || i > 1))
								)
									return;
								if (0 === n) c = o = s = Math.round(255 * r);
									...
									var u = r < 0.5 ? r * (1 + n) : r + n - r * n,
										h = 2 * r - u;
									(c = Math.round(255 * l(h, u, t + 1 / 3))),
										(o = Math.round(255 * l(h, u, t))),
										(s = Math.round(255 * l(h, u, t - 1 / 3)));
								}
								a = [c, o, s, i];
							}
							return a;
				...
				ue = function (e) {
					de() &&
						(te ? console.warn(e) : (console.log(e), ne && console.trace()));
				},
				he = function (e) {
					return null == e
						? e
				...
				we = (function () {
					function e(a) {
						if (
							...
							var t;
							t =
								null != a.instanceString &&
								a.instanceString() === this.instanceString()
									? a.toArray()
									: a;
				...
				Ce =
					"undefined" !== ("undefined" == typeof Set ? "undefined" : c(Set))
						? Set
						: we,
				Ne = function (e, a, t) {
					if (
						((t = !(void 0 !== t && !t)), void 0 !== e && void 0 !== a && x(e))
					) {
						var n = a.group;
						if (
							(null == n &&
								(n =
									a.data && null != a.data.source && null != a.data.target
										? "edges"
										: "nodes"),
							"nodes" === n || "edges" === n)
						) {
							...
							if (
								(null == r.position.x && (r.position.x = 0),
								null == r.position.y && (r.position.y = 0),
								a.renderedPosition)
							) {
								var i = a.renderedPosition,
									c = e.pan(),
									o = e.zoom();
								r.position = { x: (i.x - c.x) / o, y: (i.y - c.y) / o };
							}
							var s = [];
							S(a.classes)
								? (s = a.classes)
								: v(a.classes) && (s = a.classes.split(/\s+/));
					...
					return (
						...
						function (a, t, n) {
							...
							b(a) &&
								...
								(t = r.visit),
								(n = r.directed)),
								(n = 2 !== arguments.length || _(t) ? n : t),
								(t = _(t) ? t : function () {});
							for (
								var i,
									c = this._private.cy,
									o = (a = v(a) ? this.filter(a) : a),
									s = [],
									l = [],
									d = {},
									u = {},
								...
								var S = o[f],
									w = S.id();
								S.isNode() &&
									(s.unshift(S), e.bfs && ((h[w] = !0), l.push(S)), (u[w] = 0));
							}
							var C = function () {
								...
								if (!1 === c) return "break";
								for (
									var S = a.connectedEdges().filter(function (e) {
							...
							return { path: c.collection(D), found: c.collection(i) };
						}
					);
				},
				De = {
					breadthFirstSearch: Be({ bfs: !0 }),
					depthFirstSearch: Be({ dfs: !0 }),
				};
			...
			var xe = ye({
				...
				Ie = {
					dijkstra: function (e) {
						if (!b(e)) {
							var a = arguments;
							e = { root: a[0], weight: a[1], directed: a[2] };
						}
						var t = xe(e),
							n = t.root,
							r = t.weight,
						...
						for (
							var C = function (e, a) {
								for (
									var t,
										n = (c ? e.edgesTo(a) : e.edgesWith(a)).intersect(p),
										r = 1 / 0,
										i = 0;
									i < n.length;
									i++
							...
							if (((h[D] = B), B !== 1 / 0))
								for (
									var x = N.neighborhood().intersect(g), I = 0;
									I < x.length;
									I++
								) {
									var T = x[I],
										...
										P = C(N, T),
										M = B + P.dist;
									M < y(T) && (f(T, M), (u[U] = { node: N, edge: P.edge }));
								}
						}
						return {
					...
					aStar: function (e) {
						...
						for (var b, w = 0; y.size() > 0; ) {
							if (((l = y.pop()), (d = l.id()), f.delete(d), w++, d === h)) {
								for (
									var C = [], N = r, B = h, D = _[B];
									C.unshift(N), null != D && C.unshift(D), null != (N = v[B]);
				...
				ke = {
					floydWarshall: function (e) {
						...
						for (
							var f = new Array(d), _ = new Array(d), S = 0;
							S < s.length;
							S++
						) {
							var b = s[S],
				...
				Re = {
					bellmanFord: function (e) {
						...
						for (
							...
							var S = u[_],
								b = y(S);
							S.same(i) ? (b.dist = 0) : (b.dist = 1 / 0),
								(b.pred = null),
								(b.edge = null);
						}
						for (
							var w = !1,
								C = function (e, a, t, n, r, i) {
									var c = n.dist + i;
									c < r.dist &&
										!t.same(n.edge) &&
										((r.dist = c), (r.pred = e), (r.edge = t), (w = !0));
								},
								N = 1;
							N < h;
							N++
						...
						if (w)
							for (var M = 0; M < p; M++) {
								var k = d[M],
									...
									V = y(R).dist;
								if (G + E < V || (!r && V + E < G)) {
									ue("Graph contains a negative weight cycle for Bellman-Ford"),
										(g = !0);
									break;
								}
							}
				...
				Ge = function (e, a, t) {
					0 === t.length &&
						le("Karger-Stein must be run on a connected (sub)graph");
					for (
						var n = t[e],
							r = n[1],
							i = n[2],
					...
					kargerStein: function () {
						...
						if (!(n < 2)) {
							...
							for (
								...
								var S = Ve(m, v, c, 2),
									b = Ve(g, _, c, 2);
								S.length <= b.length && S.length < d
									? ((d = S.length), (u = S), p(m, h))
									: b.length <= S.length &&
									  b.length < d &&
									  ((d = b.length), (u = b), p(g, h));
							}
							for (
								var w = this.spawn(
										u.map(function (e) {
							...
							return { cut: w, partition1: C, partition2: N };
						}
				...
				ze = function (e, a, t) {
					return { x: e.x * a + t.x, y: e.y * a + t.y };
				},
				We = function (e, a, t) {
					return { x: (e.x - t.x) / a, y: (e.y - t.y) / a };
				},
				je = function (e) {
					return { x: e[0], y: e[1] };
				},
				...
				Xe = function (e, a, t, n) {
					return { x: Ye(e.x, a.x, t.x, n), y: Ye(e.y, a.y, t.y, n) };
				},
				Je = function (e, a, t) {
				...
				ea = function (e, a, t) {
					(e.x1 = Math.min(e.x1, a)),
						(e.x2 = Math.max(e.x2, a)),
						(e.w = e.x2 - e.x1),
						(e.y1 = Math.min(e.y1, t)),
						(e.y2 = Math.max(e.y2, t)),
						(e.h = e.y2 - e.y1);
				},
				aa = function (e) {
					var a =
				...
				sa = function (e, a, t, n, r, i, c) {
					var o,
						...
						u = n - d - c;
					if (
						(o = Sa(e, a, t, n, t - l + s - c, u, t + l - s + c, u, !1))
							.length > 0
					)
						return o;
					var h = t + l + c;
					if (
						(o = Sa(e, a, t, n, h, n - d + s - c, h, n + d - s + c, !1))
							.length > 0
					)
						return o;
					var m = n + d + c;
					if (
						(o = Sa(e, a, t, n, t - l + s - c, m, t + l - s + c, m, !1))
							.length > 0
					)
						return o;
					var g,
						p = t - l - c;
					if (
						(o = Sa(e, a, t, n, p, n - d + s - c, p, n + d - s + c, !1))
							.length > 0
					)
						return o;
					var y = t - l + s,
					...
					var w = t - l + s,
						C = n + d - s;
					return (g = va(e, a, t, n, w, C, s + c)).length > 0 &&
						g[0] <= w &&
						g[1] >= C
						? [g[0], g[1]]
						: [];
				...
				ua = function (e, a, t, n, r, i, c, o) {
					...
					!(function (e, a, t, n, r) {
						var i, c, o, s, l, d, u, h;
						0 === e && (e = 1e-5),
							(o = -27 * (n /= e) + (a /= e) * (9 * (t /= e) - a * a * 2)),
							(i = (c = (3 * t - a * a) / 9) * c * c + (o /= 54) * o),
							(r[1] = 0),
							(u = a / 3),
							i > 0
								? ((l =
								...
								: ((r[5] = r[3] = 0),
								  0 === i
										? ((h = o < 0 ? -Math.pow(-o, 1 / 3) : Math.pow(o, 1 / 3)),
										  (r[0] = 2 * h - u),
										  (r[4] = r[2] = -(h + u)))
										: ((s = (c = -c) * c * c),
										  (s = Math.acos(o / Math.sqrt(s))),
										  (h = 2 * Math.sqrt(c)),
										  (r[0] = -u + h * Math.cos(s / 3)),
										  (r[2] = -u + h * Math.cos((s + 2 * Math.PI) / 3)),
										  (r[4] = -u + h * Math.cos((s + 4 * Math.PI) / 3))));
					})(
						1 * t * t -
							4 * t * r +
							2 * t * c +
						...
						3 * t * t -
							...
							2 * i * a -
							o * a,
						1 * t * r - t * t + t * e - r * e + n * i - n * n + n * a - i * a,
						s
					);
					for (var l = [], d = 0; d < 6; d += 2)
						Math.abs(s[d + 1]) < 1e-7 && s[d] >= 0 && s[d] <= 1 && l.push(s[d]);
					l.push(1), l.push(0);
					for (var u, h, m, g = -1, p = 0; p < l.length; p++)
						(u =
							Math.pow(1 - l[p], 2) * t +
							2 * (1 - l[p]) * l[p] * r +
							l[p] * l[p] * c),
							(h =
								...
								2 * (1 - l[p]) * l[p] * i +
								l[p] * l[p] * o),
							(m = Math.pow(u - e, 2) + Math.pow(h - a, 2)),
							g >= 0 ? m < g && (g = m) : (g = m);
					return g;
				},
				...
				ma = function (e, a, t) {
					for (var n, r, i, c, o = 0, s = 0; s < t.length / 2; s++)
						if (
							...
							(r = t[2 * s + 1]),
							s + 1 < t.length / 2
								? ((i = t[2 * (s + 1)]), (c = t[2 * (s + 1) + 1]))
								: ((i = t[2 * (s + 1 - t.length / 2)]),
								  (c = t[2 * (s + 1 - t.length / 2) + 1])),
							n == e && i == e)
						);
						else {
				...
				ga = function (e, a, t, n, r, i, c, o, s) {
					...
					null != o[0]
						? ((l = Math.atan(o[1] / o[0])),
						  o[0] < 0 ? (l += Math.PI / 2) : (l = -l - Math.PI / 2))
						: (l = o);
					for (
						var u, h = Math.cos(-l), m = Math.sin(-l), g = 0;
						g < d.length / 2;
						g++
					)
						(d[2 * g] = (i / 2) * (t[2 * g] * h - t[2 * g + 1] * m)),
							(d[2 * g + 1] = (c / 2) * (t[2 * g + 1] * h + t[2 * g] * m)),
							(d[2 * g] += n),
							(d[2 * g + 1] += r);
					if (s > 0) {
						var p = ya(d, -s);
				...
				pa = function (e) {
					for (
						var a, t, n, r, i, c, o, s, l = new Array(e.length / 2), d = 0;
						d < e.length / 4;
						d++
					) {
						(a = e[4 * d]),
				...
				ya = function (e, a) {
					for (
						var t, n, r, i, c = new Array(2 * e.length), o = 0;
						o < e.length / 2;
						o++
					) {
						(t = e[2 * o]),
				...
				va = function (e, a, t, n, r, i, c) {
					...
					return y.length > 1
						? y[0] == y[1]
							? [f, v]
							: [f, v, y[1] * o[0] + e, y[1] * o[1] + a]
						: [f, v];
				},
				_a = function (e, a, t) {
					return (a <= e && e <= t) || (t <= e && e <= a)
						? e
						: (e <= a && a <= t) || (t <= a && a <= e)
						? a
						: t;
				...
				Sa = function (e, a, t, n, r, i, c, o, s) {
					...
					if (0 !== f) {
						var v = p / f,
							_ = y / f;
						return -0.001 <= v && v <= 1.001 && -0.001 <= _ && _ <= 1.001
							? [e + v * d, a + v * m]
							: s
							? [e + v * d, a + v * m]
							: [];
				...
				ba = function (e, a, t, n, r, i, c, o) {
					...
					for (var _ = 0; _ < l.length / 2; _++)
						(d = l[2 * _]),
							(u = l[2 * _ + 1]),
							_ < l.length / 2 - 1
								? ((h = l[2 * (_ + 1)]), (m = l[2 * (_ + 1) + 1]))
								: ((h = l[0]), (m = l[1])),
							0 !== (s = Sa(e, a, n, r, d, u, h, m)).length &&
								g.push(s[0], s[1]);
					return g;
				},
				wa = function (e, a, t) {
				...
				Na = function (e) {
					for (
						...
						(a = e[2 * s]),
							...
							(i = Math.min(i, t)),
							(o = Math.max(o, t));
					for (var l = 2 / (c - r), d = 2 / (o - i), u = 0; u < n; u++)
						(a = e[2 * u] = e[2 * u] * l),
							(t = e[2 * u + 1] = e[2 * u + 1] * d),
							(r = Math.min(r, a)),
							(c = Math.max(c, a)),
				...
				Ba = function (e, a) {
					...
					n += a;
					for (var r, i = new Array(2 * e), c = 0; c < e; c++)
						(r = c * t + n),
							(i[2 * c] = Math.cos(r)),
							(i[2 * c + 1] = Math.sin(-r));
					return i;
				...
				Ua = {
					pageRank: function (e) {
						...
						for (var U, P = new Array(d), M = new Array(d), k = 0; k < d; k++)
							P[k] = 1;
						for (var A = 0; A < r; A++) {
				...
				Ma = {
					degreeCentralityNormalized: function (e) {
						...
						if (e.directed) {
							for (var r = {}, i = {}, c = 0, o = 0, s = 0; s < n; s++) {
								...
								c < u.indegree && (c = u.indegree),
									o < u.outdegree && (o = u.outdegree),
									(r[d] = u.indegree),
									(i[d] = u.outdegree);
							}
							return {
								indegree: function (e) {
									return 0 == c
										? 0
										: (v(e) && (e = a.filter(e)), r[e.id()] / c);
								},
								outdegree: function (e) {
									return 0 === o
										? 0
										: (v(e) && (e = a.filter(e)), i[e.id()] / o);
								},
							};
						}
					...
					degreeCentrality: function (e) {
						...
						for (
							var f = r.connectedEdges().intersection(t),
								v = f.length,
								_ = 0,
								S = 0;
							S < f.length;
							...
							_ += i(f[S]);
						return { degree: Math.pow(v, 1 - o) * Math.pow(_, o) };
					},
				};
			(Ma.dc = Ma.degreeCentrality),
				(Ma.dcn = Ma.degreeCentralityNormalised =
					Ma.degreeCentralityNormalized);
			var ka = ye({
					harmonic: !0,
					weight: function () {
						return 1;
				...
				Aa = {
					closenessCentralityNormalized: function (e) {
						for (
							var a = ka(e),
								...
								o = 0,
								s = this.nodes(),
								l = this.floydWarshall({ weight: n, directed: r }),
								d = 0;
							d < s.length;
							d++
						) {
						...
						return {
							closeness: function (e) {
								return 0 == o
									? 0
									: ((e = v(e) ? i.filter(e)[0].id() : e.id()), c[e] / o);
							},
						};
					},
					closenessCentrality: function (e) {
						...
						t = this.filter(t)[0];
						for (
							var c = this.dijkstra({ root: t, weight: n, directed: r }),
								o = 0,
								s = this.nodes(),
								l = 0;
							l < s.length;
			...
			(Aa.cc = Aa.closenessCentrality),
				(Aa.ccn = Aa.closenessCentralityNormalised =
					Aa.closenessCentralityNormalized);
			var Ra = ye({ weight: null, directed: !1 }),
				Ea = {
					betweennessCentrality: function (e) {
						for (
							...
							var g = o[m],
								p = g.id();
							(s[p] = t ? g.outgoers().nodes() : g.openNeighborhood().nodes()),
								u(p, 0);
						}
						for (
							var y = function (e) {
											...
											for (var v = 0; v < s[f].length; v++) {
												...
												(_ = _.id()),
													m[_] > m[f] + w &&
														...
														(l[_] = [])),
													m[_] == m[f] + w &&
														((d[_] = d[_] + d[f]), l[_].push(f));
											}
										else
											for (var C = 0; C < s[f].length; C++) {
												var N = s[f][C].id();
												m[N] == 1 / 0 && (g.push(N), (m[N] = m[f] + 1)),
													m[N] == m[f] + 1 &&
														((d[N] = d[N] + d[f]), l[N].push(f));
											}
									}
									...
									for (; t.length > 0; )
										for (var x = t.pop(), I = 0; I < l[x].length; I++) {
											var T = l[x][I];
											(B[T] = B[T] + (d[T] / d[x]) * (1 + B[x])),
												x != o[e].id() && u(x, h(x) + B[x]);
										}
								},
								f = 0;
							f < o.length;
			...
			var Ga = ye({
				...
				Wa = function (e, a, t) {
					for (var n = new Array(a * a), r = 0; r < a * a; r++)
						n[r] = Math.pow(e[r], t);
					return Fa(n, a), n;
				},
				ja = function (e, a, t, n) {
					for (var r = 0; r < t; r++) {
						if (
							Math.round(e[r] * Math.pow(10, n)) / Math.pow(10, n) !==
							Math.round(a[r] * Math.pow(10, n)) / Math.pow(10, n)
						)
							return !1;
					}
					return !0;
				...
				Ha = function (e) {
					for (
						...
						i[a[c].id()] = c;
					for (
						var o, s = a.length, l = s * s, d = new Array(l), u = 0;
						u < l;
						u++
					)
						d[u] = 0;
					...
					!(function (e, a, t) {
						...
						Fa(d, s);
					for (var f = !0, v = 0; f && v < r.maxIterations; )
						(f = !1),
							(o = za(d, s, r.expandFactor)),
							(d = Wa(o, s, r.inflateFactor)),
							ja(d, o, l, 4) || (f = !0),
							v++;
					var _ = (function (e, a, t, n) {
						for (var r = [], i = 0; i < a; i++) {
							for (var c = [], o = 0; o < a; o++)
								Math.round(1e3 * e[i * a + o]) / 1e3 > 0 && c.push(t[o]);
					...
					return (_ = (function (e) {
						for (var a = 0; a < e.length; a++)
							for (var t = 0; t < e.length; t++)
								a != t && Oa(e[a], e[t]) && e.splice(t, 1);
						return e;
					})(_));
				},
				Qa = { markovClustering: Ha, mcl: Ha },
				qa = function (e) {
					return e;
				},
				Za = function (e, a) {
			...
			function at(e, a, t, n, r, i) {
				var c;
				return (
					(c = _(e) ? e : et[e] || et.euclidean),
					0 === a && _(e) ? c(r, i) : c(a, t, n, r, i)
				);
			}
			...
			var tt = ye({
				...
				it = function (e, a, t) {
					for (
						...
						(r[s] = e.min(t[s]).value), (i[s] = e.max(t[s]).value);
					for (var l = 0; l < a; l++) {
						o = [];
						for (var d = 0; d < n; d++)
							o[d] = Math.random() * (i[d] - r[d]) + r[d];
						c[l] = o;
					}
					return c;
				},
				...
				ot = function (e, a, t) {
					for (var n = [], r = null, i = 0; i < a.length; i++)
						t[(r = a[i]).id()] === e && n.push(r);
					return n;
				},
				st = function (e, a, t) {
				...
				lt = function (e, a, t) {
					for (var n = 0; n < t; n++) if (e === a[n]) return !0;
					return !1;
				},
				dt = function (e, a) {
					var t = new Array(a);
					if (e.length < 50)
						...
						for (var i = 0; i < a; i++)
							t[i] = e[Math.floor(Math.random() * e.length)];
					return t;
				},
				ut = function (e, a, t) {
					for (var n = 0, r = 0; r < a.length; r++)
						n += rt("manhattan", a[r], e, t, "kMedoids");
					return n;
				},
					...
					for (var l = 0; l < e.length; l++)
						for (var d = 0; d < r.attributes.length; d++) {
							...
							for (var u = 0; u < a.length; u++)
								(i += n[u][l] * r.attributes[d](a[u])), (c += n[u][l]);
							e[l][d] = i / c;
						}
				},
				mt = function (e, a, t, n, r) {
					...
					for (var c, o, s, l = 2 / (r.m - 1), d = 0; d < t.length; d++)
						for (var u = 0; u < n.length; u++) {
							c = 0;
							for (var h = 0; h < t.length; h++)
								(o = rt(r.distance, n[u], t[d], r.attributes, "cmeans")),
									(s = rt(r.distance, n[u], t[h], r.attributes, "cmeans")),
									(c += Math.pow(o / s, l));
							e[u][d] = 1 / c;
						}
				},
				gt = function (e) {
					...
					for (var d = 0; d < c.length; d++) {
						for (var u = 0, h = 0; h < o.k; h++)
							(t[d][h] = Math.random()), (u += t[d][h]);
					...
					for (var y = !0, f = 0; y && f < o.maxIterations; )
						(y = !1),
							ht(a, c, t, r, o),
							mt(t, n, a, c, o),
							st(t, n, o.sensitivityThreshold) || (y = !0),
							f++;
					return {
						clusters: (function (e, a, t, n) {
							for (var r, i, c = new Array(t.k), o = 0; o < c.length; o++)
								c[o] = [];
					...
					kMeans: function (e) {
						...
						a = i.testMode
							? "number" == typeof i.testCentroids
								? it(n, i.k, i.attributes)
								: "object" === c(i.testCentroids)
								? i.testCentroids
								: it(n, i.k, i.attributes)
							: it(n, i.k, i.attributes);
				...
				vt = function (e, a, t, n, r) {
					...
					if (
						("threshold" === r.mode && o >= r.threshold) ||
						("dendrogram" === r.mode && 1 === e.length)
					)
						return !1;
					var m,
						g = a[c],
					...
					for (var y = 0; y < e.length; y++) {
						...
						g.key === f.key
							...
							: "min" === r.linkage
							? ((i = t[g.key][f.key]),
							  t[g.key][f.key] > t[p.key][f.key] && (i = t[p.key][f.key]))
							: "max" === r.linkage
							? ((i = t[g.key][f.key]),
							  t[g.key][f.key] < t[p.key][f.key] && (i = t[p.key][f.key]))
							: (i =
									"mean" === r.linkage
										? (t[g.key][f.key] * g.size + t[p.key][f.key] * p.size) /
										  (g.size + p.size)
										: "dendrogram" === r.mode
										? l(f.value, g.value)
										: l(f.value[0], g.value[0])),
							(t[g.key][f.key] = t[f.key][g.key] = i);
					}
				...
				_t = function e(a, t, n) {
					a &&
						(a.value
							? t.push(a.value)
							: (a.left && e(a.left, t), a.right && e(a.right, t)));
				},
				St = function (e) {
					for (
						var a = this.cy(),
						...
						for (var m = 0; m <= h; m++) {
							...
							(g =
								"dendrogram" === n.mode
									? h === m
										? 1 / 0
										: i(c[h].value, c[m].value)
									: h === m
									? 1 / 0
									: i(c[h].value[0], c[m].value[0])),
								(o[h][m] = g),
								(o[m][h] = g),
								g < o[h][s[h]] && (s[h] = m);
						}
					...
					return (
						"dendrogram" === n.mode
							? ((p = (function e(a, t, n) {
									...
									return 0 === t
										? (a.left && _t(a.left, r),
										  a.right && _t(a.right, i),
										  (c = r.concat(i)),
										  [n.collection(c)])
										: 1 === t
										? a.value
											? [n.collection(a.value)]
											: (a.left && _t(a.left, r),
											  a.right && _t(a.right, i),
											  [n.collection(r), n.collection(i)])
										: a.value
										? [n.collection(a.value)]
										: (a.left && (r = e(a.left, t - 1, n)),
										  a.right && (i = e(a.right, t - 1, n)),
										  r.concat(i));
							  })(c[0], n.dendrogramDepth, a)),
							  n.addDendrogram &&
									(function e(a, t) {
										if (!a) return "";
										if (a.left && a.right) {
											...
											return (
												t.add({
													group: "edges",
													data: { source: n, target: i.id() },
												}),
												t.add({
													group: "edges",
													data: { source: r, target: i.id() },
												}),
												i.id()
											);
										}
				...
				bt = { hierarchicalClustering: St, hca: St },
				wt = ye({
					distance: "euclidean",
					preference: "median",
					damping: 0.8,
				...
				Nt = function (e, a) {
					return "median" === a
						? (function (e) {
								...
								n
									? (e = e.slice(a, t))
									: (t < e.length && e.splice(t, e.length - t),
									  a > 0 && e.splice(0, a));
				...
				Dt = function (e) {
						...
						var a,
							...
							l = (function (e) {
								var a = e.damping,
									t = e.preference;
								(0.5 <= a && a < 1) ||
									le("Damping must range on [0.5, 1).  Got: ".concat(a));
					...
					for (var m = 0; m < a; m++)
						for (var g = 0; g < a; g++)
							m !== g &&
								(n[m * a + g] = Ct(l.distance, s[m], s[g], l.attributes));
					r = Nt(n, l.preference);
					...
					for (
						var v = new Array(a), _ = new Array(a), S = new Array(a), b = 0;
						b < a;
						b++
					)
						(v[b] = 0), (_[b] = 0), (S[b] = 0);
					for (
						var C, N = new Array(a * l.minIterations), B = 0;
						B < N.length;
						B++
					)
						N[B] = 0;
					for (C = 0; C < l.maxIterations; C++) {
						for (var D = 0; D < a; D++) {
							for (var x = -1 / 0, I = -1 / 0, T = -1, U = 0, P = 0; P < a; P++)
								(v[P] = i[D * a + P]),
									(U = c[D * a + P] + n[D * a + P]) >= x
										? ((I = x), (x = U), (T = P))
										: U > I && (I = U);
							for (var M = 0; M < a; M++)
								i[D * a + M] =
									(1 - l.damping) * (n[D * a + M] - x) + l.damping * v[M];
							i[D * a + T] =
								(1 - l.damping) * (n[D * a + T] - I) + l.damping * v[T];
						}
						for (var k = 0; k < a; k++) {
							for (var A = 0, R = 0; R < a; R++)
								(v[R] = c[R * a + k]),
									(_[R] = Math.max(0, i[R * a + k])),
									(A += _[R]);
							(A -= _[k]), (_[k] = i[k * a + k]), (A += _[k]);
							for (var E = 0; E < a; E++)
								c[E * a + k] =
									(1 - l.damping) * Math.min(0, A - _[E]) + l.damping * v[E];
						...
						if (
							G > 0 &&
							(C >= l.minIterations - 1 || C == l.maxIterations - 1)
						) {
					...
					for (
						var j = (function (e, a, t) {
								for (var n = [], r = 0; r < e; r++)
									a[r * e + r] + t[r * e + r] > 0 && n.push(r);
								return n;
							})(a, i, c),
							O = (function (e, a, t) {
					...
					for (var K = new Array(j.length), Y = 0; Y < j.length; Y++)
						K[Y] = o.collection(H[j[Y]]);
					return K;
				},
				xt = { affinityPropagation: Dt, ap: Dt },
				It = ye({ root: void 0, directed: !1 }),
				Tt = {};
			[
				De,
				Ie,
				...
				xt,
				{
					hierholzer: function (e) {
						...
						var m = function (e) {
								for (var a, t, n, r = e, i = [e]; d[r].length; )
									(a = d[r].shift()),
										(t = u[a][0]),
										r != (n = u[a][1])
											? ((d[n] = d[n].filter(function (e) {
													return e != a;
											  })),
											  (r = n))
											: o ||
											  r == t ||
											  ((d[t] = d[t].filter(function (e) {
													return e != a;
											  })),
											  (r = t)),
										i.unshift(a),
							...
							g = [],
							p = [];
						for (p = m(r); 1 != p.length; )
							0 == d[p[0]].length
								? (g.unshift(s.getElementById(p.shift())),
								  g.unshift(s.getElementById(p.shift())))
								: (p = m(p.shift()).concat(p));
			...
			var Ut = function e(a) {
				...
				(this.id = "Thenable/1.0.7"),
					...
					"function" == typeof a &&
						a.call(this, this.fulfill.bind(this), this.reject.bind(this));
			};
			Ut.prototype = {
				fulfill: function (e) {
				...
				then: function (e, a) {
					var t = new Ut();
					return (
						this.onFulfilled.push(At(e, t, "fulfill")),
						this.onRejected.push(At(a, t, "reject")),
						Mt(this),
						t.proxy
					);
				},
			...
			var Pt = function (e, a, t, n) {
				...
				Mt = function (e) {
					1 === e.state
						? kt(e, "onFulfilled", e.fulfillValue)
						: 2 === e.state && kt(e, "onRejected", e.rejectReason);
				},
				kt = function (e, t, n) {
					if (0 !== e[t].length) {
						var r = e[t];
				...
				Rt = function e(a, t) {
					if (a !== t && a.proxy !== t) {
						var n;
						if (("object" === c(t) && null !== t) || "function" == typeof t)
							try {
								n = t.then;
							} catch (e) {
								return void a.reject(e);
								...
								n.call(
									...
									function (n) {
										r ||
											((r = !0),
											n === t
												? a.reject(new TypeError("circular thenable chain"))
												: e(a, n));
									},
									function (e) {
										r || ((r = !0), a.reject(e));
			...
			var Et = "undefined" != typeof Promise ? Promise : Ut,
				Gt = function (e, a, t) {
					var n = x(e),
						r = !n,
						i = (this._private = F({ duration: 1e3 }, a, t));
					if (
						((i.target = e),
						...
						(i.completes = []),
						(i.frames = []),
						i.complete && _(i.complete) && i.completes.push(i.complete),
						r)
					) {
						var c = e.position();
						(i.startPosition = i.startPosition || { x: c.x, y: c.y }),
							(i.startStyle =
								i.startStyle ||
					...
					if (n) {
						var o = e.pan();
						(i.startPan = { x: o.x, y: o.y }), (i.startZoom = e.zoom());
					}
					(this.length = 1), (this[0] = this);
				},
				Vt = Gt.prototype;
			F(Vt, {
				...
				hook: function () {
					...
					if (!e.hooked) {
						...
						(e.queue ? a.queue : a.current).push(this),
							N(e.target) && e.target.cy().addToAnimationPool(e.target),
							(e.hooked = !0);
					}
					return this;
				},
				...
				(Vt.complete = Vt.completed),
				(Vt.run = Vt.play),
				(Vt.running = Vt.playing);
			var Ft = {};
			[
				{
					animated: function () {
					...
					delay: function () {
						return function (e, a) {
							return (this._private.cy || this).styleEnabled()
								? this.animate({ delay: e, duration: e, complete: a })
								: this;
						};
					},
					delayAnimation: function () {
						return function (e, a) {
							return (this._private.cy || this).styleEnabled()
								? this.animation({ delay: e, duration: e, complete: a })
								: this;
						};
					},
					animation: function () {
						return function (e, a) {
							...
							var o = r.style();
							if (((e = F({}, e, a)), 0 === Object.keys(e).length))
								return new Gt(n[0], e);
							switch (
							...
							if (
								(c &&
									((e.style = o.getPropsList(e.style || e.css)),
									(e.css = void 0)),
								c && null != e.renderedPosition)
							) {
							...
							if (i && b(e.zoom)) {
								...
								null != f &&
									(f.zoomed && (e.zoom = f.zoom), f.panned && (e.pan = f.pan));
							}
							return new Gt(n[0], e);
						};
					},
					animate: function () {
						return function (e, a) {
							...
							for (var n = 0; n < t.length; n++) {
								...
								r.animation(e, i ? { queue: !0 } : void 0).play();
							}
							return this;
						};
					},
					stop: function () {
						return function (e, a) {
							...
							for (var r = 0; r < t.length; r++) {
								for (
									var i = t[r]._private, c = i.animation.current, o = 0;
									o < c.length;
									o++
								) {
									var s = c[o]._private;
					...
					data: function (e) {
						return (
							...
							function (a, t) {
								...
								if (v(a)) {
									var o;
									if (n.allowGetting && void 0 === t)
										return (
											c && (n.beforeGet(c), (o = c._private[n.field][a])), o
										);
									if (n.allowSetting && void 0 !== t && !n.immutableKeys[a]) {
										...
										n.updateStyle && this.updateStyle(),
											n.onSet(this),
											n.settingTriggersEvent &&
												this[n.triggerFnName](n.settingEvent);
									}
					...
					removeData: function (e) {
						return (
							...
							function (a) {
								...
								if (v(a)) {
									for (
										var r = a.split(/\s+/), i = r.length, c = 0;
										c < i;
										c++
									) {
										var o = r[c];
										if (!T(o))
											if (!t.immutableKeys[o])
												for (var s = 0, l = n.length; s < l; s++)
													n[s]._private[t.field][o] = void 0;
									}
									t.triggerEvent && this[t.triggerFnName](t.event);
								} else if (void 0 === a) {
									for (var d = 0, u = n.length; d < u; d++)
										for (
											var h = n[d]._private[t.field], m = Object.keys(h), g = 0;
											g < m.length;
											g++
										) {
											var p = m[g];
				...
				},
				{
					eventAliasesOn: function (e) {
						var a = e;
						(a.addListener = a.listen = a.bind = a.on),
							(a.unlisten = a.unbind = a.off = a.removeListener),
							(a.trigger = a.emit),
							(a.pon = a.promiseOn =
								function (e, a) {
									var t = this,
				...
				zt = {
					classes: function (e) {
						...
						for (var t = [], n = new Ce(e), r = 0; r < this.length; r++) {
							for (
								var i = this[r], c = i._private, o = c.classes, s = !1, l = 0;
								l < e.length;
								l++
							) {
								var d = e[l];
						...
						return (
							t.length > 0 && this.spawn(t).updateStyle().emit("class"), this
						);
					},
					addClass: function (e) {
					...
					toggleClass: function (e, a) {
						S(e) || (e = e.match(/\S+/g) || []);
						for (
							var t = void 0 === a, n = [], r = 0, i = this.length;
							r < i;
							r++
						)
							for (
								var c = this[r], o = c._private.classes, s = !1, l = 0;
								l < e.length;
								l++
							) {
								var d = e[l],
								...
								a || (t && !u)
									? (o.add(d), (h = !0))
									: (!a || (t && u)) && (o.delete(d), (h = !0)),
									!s && h && (n.push(c), (s = !0));
							}
						return (
							n.length > 0 && this.spawn(n).updateStyle().emit("class"), this
						);
					},
			...
			(Wt.variable = "(?:[\\w-]|(?:\\\\" + Wt.metaChar + "))+"),
				(Wt.value = Wt.string + "|" + Wt.number),
				(Wt.className = Wt.variable),
				(Wt.id = Wt.variable),
				(function () {
					var e, a, t;
					for (e = Wt.comparatorOp.split("|"), t = 0; t < e.length; t++)
						(a = e[t]), (Wt.comparatorOp += "|@" + a);
					for (e = Wt.comparatorOp.split("|"), t = 0; t < e.length; t++)
						(a = e[t]).indexOf("!") >= 0 ||
							("=" !== a && (Wt.comparatorOp += "|\\!" + a));
				})();
			var jt = 0,
				...
				hn = (function () {
					for (var e, a = {}, t = 0; t < un.length; t++)
						a[(e = un[t]).selector] = e.matches;
					return a;
				})(),
				mn =
					"(" +
				...
				yn = [
					{
						...
						populate: function (e, a, t) {
							var n = d(t, 1)[0];
							a.checks.push({ type: jt, value: "*" === n ? n : n + "s" });
						},
					},
					{
						name: "state",
					...
					},
					{
						...
						populate: function (e, a, t) {
							var n = d(t, 1)[0];
							a.checks.push({ type: Xt, value: gn(n) });
						},
					},
					{
						name: "className",
						...
						populate: function (e, a, t) {
							var n = d(t, 1)[0];
							a.checks.push({ type: Jt, value: gn(n) });
						},
					},
					{
						name: "dataExists",
						...
						populate: function (e, a, t) {
							var n = d(t, 1)[0];
							a.checks.push({ type: qt, field: gn(n) });
						},
					},
					{
						name: "dataCompare",
						...
						populate: function (e, a, t) {
							var n = d(t, 3),
								...
								c = n[2];
							(c =
								null != new RegExp("^" + Wt.string + "$").exec(c)
					...
					},
					{
						...
						populate: function (e, a, t) {
							var n = d(t, 2),
								r = n[0],
								i = n[1];
							a.checks.push({ type: Zt, field: gn(i), operator: r });
						},
					},
					{
						name: "metaCompare",
					...
					},
					{
						...
						populate: function (e, a) {
							var t = e.currentSubject,
								...
								i = e[e.length - 1];
							return (
								null != t && ((i.subject = t), (e.currentSubject = null)),
								(i.edgeCount = n),
								(i.compoundCount = r),
								(e.edgeCount = 0),
								(e.compoundCount = 0),
						...
						populate: function (e, a) {
							if (null == e.currentSubject) {
								var t = { checks: [] },
									...
									r = { checks: [] };
								return (
									t.checks.push({ type: en, source: n, target: r }),
									pn(e, 0, t),
									e.edgeCount++,
									r
								);
							...
							var i = { checks: [] },
								...
								o = { checks: [] };
							return (
								i.checks.push({ type: an, source: c, target: o }),
								pn(e, 0, i),
								e.edgeCount++,
								o
							);
						...
						populate: function (e, a) {
							if (null == e.currentSubject) {
								var t = { checks: [] },
									...
									r = { checks: [] };
								return (
									t.checks.push({ type: $t, nodes: [n, r] }),
									pn(e, 0, t),
									e.edgeCount++,
									r
								);
							...
							var i = { checks: [] },
								...
								o = { checks: [] };
							return (
								i.checks.push({ type: nn, node: c, neighbor: o }),
								pn(e, 0, i),
								o
							);
						},
						...
						populate: function (e, a) {
							if (null == e.currentSubject) {
								var t = { checks: [] },
									...
									r = e[e.length - 1];
								return (
									t.checks.push({ type: rn, parent: r, child: n }),
									pn(e, 0, t),
									e.compoundCount++,
									n
								);
							...
							if (e.currentSubject === a) {
								var i = { checks: [] },
									...
									d = { checks: [] };
								return (
									i.checks.push({ type: ln, left: c, right: o, subject: s }),
									(s.checks = a.checks),
									(a.checks = [{ type: dn }]),
									d.checks.push({ type: dn }),
									o.checks.push({ type: on, parent: d, child: l }),
									pn(e, 0, i),
									(e.currentSubject = s),
									e.compoundCount++,
									l
							...
							var u = { checks: [] },
								h = { checks: [] },
								m = [{ type: on, parent: u, child: h }];
							return (
								(u.checks = a.checks), (a.checks = m), e.compoundCount++, h
							);
						},
					},
					{
						...
						populate: function (e, a) {
							if (null == e.currentSubject) {
								var t = { checks: [] },
									...
									r = e[e.length - 1];
								return (
									t.checks.push({ type: cn, ancestor: r, descendant: n }),
									pn(e, 0, t),
									e.compoundCount++,
									n
								);
							...
							if (e.currentSubject === a) {
								...
								return (
									...
									(a.checks = [{ type: dn }]),
									d.checks.push({ type: dn }),
									o.checks.push({ type: sn, ancestor: d, descendant: l }),
									pn(e, 0, i),
									(e.currentSubject = s),
									e.compoundCount++,
									l
							...
							var u = { checks: [] },
								h = { checks: [] },
								m = [{ type: sn, ancestor: u, descendant: h }];
							return (
								(u.checks = a.checks), (a.checks = m), e.compoundCount++, h
							);
						},
					},
					{
						...
						regex: Wt.subject,
						populate: function (e, a) {
							if (null != e.currentSubject && e.currentSubject !== a)
								return (
									ue(
			...
			var fn = function (e) {
					...
					return { expr: a, match: t, name: n, remaining: e };
				},
				vn = {
					parse: function (e) {
						...
						for (
							...
							var n = fn(a);
							if (null == n.expr)
								return ue("The selector `" + e + "`is invalid"), !1;
							var r = n.match.slice(1),
								i = n.expr.populate(this, t, r);
							if (!1 === i) return !1;
							if ((null != i && (t = i), (a = n.remaining).match(/^\s*$/)))
								break;
						}
						var c = this[this.length - 1];
						null != this.currentSubject && (c.subject = this.currentSubject),
							(c.edgeCount = this.edgeCount),
							(c.compoundCount = this.compoundCount);
					...
					toString: function () {
						...
						for (
							...
							var o = this[c];
							(i += r(o, o.subject)),
								this.length > 1 && c < this.length - 1 && (i += ", ");
						}
				...
				_n = function (e, a, t) {
					var n,
						...
						u = !1;
					switch (
						(a.indexOf("!") >= 0 && ((a = a.replace("!", "")), (d = !0)),
						a.indexOf("@") >= 0 && ((a = a.replace("@", "")), (l = !0)),
						(c || s || l) && ((r = c || o ? "" + e : ""), (i = "" + t)),
						l && ((e = r = r.toLowerCase()), (t = i = i.toLowerCase())),
						a)
					) {
						case "*=":
							n = r.indexOf(i) >= 0;
			...
			(bn[jt] = function (e, a) {
				...
				(bn[nn] = function (e, a) {
					return (
						wn(e.node, a) &&
						a.neighborhood().some(function (a) {
			...
			var Cn = function (e) {
					(this.inputText = e),
						...
						null == e ||
							...
							(N(e)
								? this.addQuery({
										checks: [{ type: Ot, value: e.collection() }],
								  })
								: _(e)
								? this.addQuery({ checks: [{ type: Ht, value: e }] })
								: v(e)
								? this.parse(e) || (this.invalid = !0)
								: le("A selector must be created from a string; found "));
				},
				Nn = Cn.prototype;
			[
				vn,
				{
					...
					filter: function (e) {
						...
						if (
							1 === a.length &&
							1 === a[0].checks.length &&
							a[0].checks[0].type === Xt
						)
							return e.getElementById(a[0].checks[0].value).collection();
						var t = function (e) {
							for (var t = 0; t < a.length; t++) {
								var n = a[t];
								if (wn(n, e)) return !0;
			...
			var Bn = {
				...
				some: function (e, a) {
					for (var t = 0; t < this.length; t++) {
						if (a ? e.apply(a, [this[t], t, this]) : e(this[t], t, this))
							return !0;
					}
					return !1;
				},
			...
			(Bn.allAreNeighbours = Bn.allAreNeighbors),
				(Bn.has = Bn.contains),
				(Bn.equal = Bn.equals = Bn.same);
			var Dn,
				xn,
				In = function (e, a) {
					return function (t, n, r, i) {
						var c,
							o = t;
						if (
							(null == o ? (c = "") : N(o) && 1 === o.length && (c = o.id()),
							1 === this.length && c)
						) {
				...
				Tn = {
					parent: function (e) {
						...
						return this.spawn(a, { unique: !0 }).filter(e);
					},
					parents: function (e) {
					...
					children: In(function (e) {
						for (var a = [], t = 0; t < this.length; t++)
							for (var n = this[t]._private.children, r = 0; r < n.length; r++)
								a.push(n[r]);
						return this.spawn(a, { unique: !0 }).filter(e);
					}, "children"),
					siblings: function (e) {
					...
					descendants: function (e) {
						...
						return (
							...
							this.spawn(a, { unique: !0 }).filter(e)
						);
					},
				};
			function Un(e, a, t, n) {
				for (
					var r = [], i = new Ce(), c = e.cy().hasCompoundNodes(), o = 0;
					o < e.length;
					o++
				) {
					var s = e[o];
			...
			function Vn(e) {
				return function (a) {
					if (
						(void 0 === a && (a = !0),
						0 !== this.length && this.isNode() && !this.removed())
					) {
						for (
							var t = 0, n = this[0], r = n._private.edges, i = 0;
							i < r.length;
							i++
						) {
							var c = r[i];
			...
			F(Gn, {
				...
				F(Gn, {
					totalDegree: function (e) {
						for (var a = 0, t = this.nodes(), n = 0; n < t.length; n++)
							a += t[n].degree(e);
						return a;
					},
				});
			var Ln = function (e, a, t) {
					for (var n = 0; n < e.length; n++) {
						...
						if (!r.locked()) {
							...
							!r.isParent() ||
								(0 === c.x && 0 === c.y) ||
								r.children().shift(c, t),
								r.shiftCachedBoundingBox(c);
						}
					}
				},
				zn = {
			...
			((An = Rn =
				{
					...
					shift: function (e, a, t) {
						...
						if (
							(b(e)
								? ((n = { x: w(e.x) ? e.x : 0, y: w(e.y) ? e.y : 0 }), (t = a))
								: v(e) && w(a) && ((n = { x: 0, y: 0 })[e] = a),
							null != n)
						) {
							var r = this.cy();
							r.startBatch();
					...
					silentShift: function (e, a) {
						return (
							b(e) ? this.shift(e, !0) : v(e) && w(a) && this.shift(e, a, !0),
							this
						);
					},
					renderedPosition: function (e, a) {
						...
						if (t && t.isNode()) {
							...
							for (var l = 0; l < this.length; l++) {
								var d = this[l];
								void 0 !== a
									? d.position(e, (a - i[e]) / r)
									: void 0 !== c && d.position(We(c, r, i));
							}
						} else if (!o) return;
						return this;
					},
						...
						if (t && t.isNode()) {
							if (!i) {
								var o = t.position(),
									...
									d = l;
								l && (s = s[0]);
								var u = d ? s.position() : { x: 0, y: 0 };
								return (
									(r = { x: o.x - u.x, y: o.y - u.y }), void 0 === e ? r : r[e]
								);
							}
							for (var h = 0; h < this.length; h++) {
								var m = this[h],
									...
									y = p;
								p && (g = g[0]);
								var f = y ? g.position() : { x: 0, y: 0 };
								void 0 !== a
									? m.position(e, a + f[e])
									: void 0 !== r && m.position({ x: r.x + f.x, y: r.y + f.y });
							}
						} else if (!i) return;
						return this;
					},
				}).modelPosition = An.point =
				An.position),
				(An.modelPositions = An.points = An.positions),
				(An.renderedPoint = An.renderedPosition),
				(An.relativePoint = An.relativePosition);
			var Wn,
				jn,
				On = Rn;
			(Wn = jn = {}),
				(jn.renderedBoundingBox = function (e) {
					var a = this.boundingBox(e),
						...
						o = a.y1 * n + r.y,
						s = a.y2 * n + r.y;
					return { x1: i, x2: c, y1: o, y2: s, w: c - i, h: s - o };
				}),
				(jn.dirtyCompoundBoundsCache = function () {
					...
					return e.styleEnabled() && e.hasCompoundNodes()
						? (this.forEachUp(function (e) {
								if (e.isParent()) {
									var a = e._private;
									(a.compoundBoundsClean = !1),
										(a.bbCache = null),
										e.emitAndNotify("bounds");
								}
						  }),
						  this)
						: this;
				...
				(jn.updateCompoundBounds = function () {
					...
					function t(e) {
						if (e.isParent()) {
							...
							"px" === r.width.left.units &&
								r.width.val > 0 &&
								(o = (100 * o) / r.width.val);
							var s = r.width.right.value;
							"px" === r.width.right.units &&
								r.width.val > 0 &&
								(s = (100 * s) / r.width.val);
							var l = r.height.top.value;
							"px" === r.height.top.units &&
								r.height.val > 0 &&
								(l = (100 * l) / r.height.val);
							var d = r.height.bottom.value;
							"px" === r.height.bottom.units &&
								r.height.val > 0 &&
								(d = (100 * d) / r.height.val);
							...
							(a.autoPadding = (function (e, a, t, n) {
								...
								(a.autoWidth = Math.max(i.w, r.width.val)),
								(c.x = (-h + i.x1 + i.x2 + m) / 2),
								(a.autoHeight = Math.max(i.h, r.height.val)),
								(c.y = (-p + i.y1 + i.y2 + y) / 2);
						}
						function f(e, a, t) {
							var n = 0,
								...
								i = a + t;
							return (
								e > 0 && i > 0 && ((n = (a / i) * e), (r = (t / i) * e)),
								{ biasDiff: n, biasComplementDiff: r }
							);
						}
					}
					for (var n = 0; n < this.length; n++) {
						...
						i.compoundBoundsClean ||
							(t(r), a.batching() || (i.compoundBoundsClean = !0));
					}
					return this;
				});
			var Hn = function (e) {
						...
						if (a.pstyle(n + "label").strValue) {
							...
							if (U || P) {
								...
								var G = function (e, a) {
									...
									L = G(o, s),
									z = G(o, l);
								(c = Math.min(V.x, F.x, L.x, z.x)),
									(o = Math.max(V.x, F.x, L.x, z.x)),
									(s = Math.min(V.y, F.y, L.y, z.y)),
									(l = Math.max(V.y, F.y, L.y, z.y));
							}
							var W = x + "Rot",
								j = (I[W] = I[W] || {});
							(j.x1 = c),
				...
				Xn = function (e) {
					...
					return (
						...
						(n += t(e.includeEdges)),
						(n += t(e.includeLabels)),
						(n += t(e.includeMainLabels)),
						(n += t(e.includeSourceLabels)),
						(n += t(e.includeTargetLabels)),
						(n += t(e.includeOverlays))
					);
				},
				Jn = function (e) {
					if (e.isEdge()) {
					...
					if (
							...
							? (o || e.recalculateRenderedStyle(),
							  (t = (function (e, a) {
									var t,
										...
										_ =
											!d || (v(e) && (!p || (v(e.source()) && v(e.target()))));
									if (_) {
										var S = 0;
										d &&
											a.includeOverlays &&
											0 !== e.pstyle("overlay-opacity").value &&
											(S = e.pstyle("overlay-padding").value);
										var b = 0;
										if (
											(d && (b = e.pstyle("width").pfValue / 2),
											g && a.includeNodes)
										) {
											var w = e.position();
											(c = w.x), (o = w.y);
											...
											if (d && !u) {
												...
												if (
													((t = Math.min(y.srcX, y.midX, y.tgtX)),
													(n = Math.max(y.srcX, y.midX, y.tgtX)),
													(r = Math.min(y.srcY, y.midY, y.tgtY)),
													(i = Math.max(y.srcY, y.midY, y.tgtY)),
										...
										null != L.all
											...
											d &&
												a.includeLabels &&
												(a.includeMainLabels && Yn(h, e, null),
												p &&
													(a.includeSourceLabels && Yn(h, e, "source"),
													a.includeTargetLabels && Yn(h, e, "target")));
									}
									return (
										(h.x1 = Hn(h.x1)),
										(h.y1 = Hn(h.y1)),
										...
										(h.w = Hn(h.x2 - h.x1)),
										(h.h = Hn(h.y2 - h.y1)),
										h.w > 0 && h.h > 0 && _ && (ta(h, f), aa(h, 1)),
										h
									);
							  })(e, er)),
							  (n.bbCache = t),
							  (n.bbCacheShift.x = n.bbCacheShift.y = 0),
							  (n.bbCachePosKey = c))
							: (t = n.bbCache),
						!l && (0 !== n.bbCacheShift.x || 0 !== n.bbCacheShift.y))
					) {
						var d = ra,
							u = n.bbCacheShift,
							h = function (e, a) {
						...
						h(m, u),
							...
							null != y &&
								...
								h(y["mid-target"], u)),
							null != p &&
								(h(p.main, u), h(p.all, u), h(p.source, u), h(p.target, u));
					}
					if (((n.bbCacheShift.x = n.bbCacheShift.y = 0), !i)) {
						var f = e.isNode();
						(t = $e()),
							((a.includeNodes && f) || (a.includeEdges && !f)) &&
								(a.includeOverlays
									? qn(t, n.overlayBounds)
									: qn(t, n.bodyBounds)),
							a.includeLabels &&
								(a.includeMainLabels &&
								(!r || (a.includeSourceLabels && a.includeTargetLabels))
									? qn(t, n.labelBounds.all)
									: (a.includeMainLabels && qn(t, n.labelBounds.mainRot),
									  a.includeSourceLabels && qn(t, n.labelBounds.sourceRot),
									  a.includeTargetLabels && qn(t, n.labelBounds.targetRot))),
							(t.w = t.x2 - t.x1),
							(t.h = t.y2 - t.y1);
					}
					return t;
			...
			(jn.boundingBox = function (e) {
				...
				(jn.dirtyBoundingBoxCache = function () {
					for (var e = 0; e < this.length; e++) {
						...
						(a.bbCache = null),
							(a.bbCacheShift.x = a.bbCacheShift.y = 0),
							(a.bbCachePosKey = null),
							(a.bodyBounds = null),
							(a.overlayBounds = null),
							(a.labelBounds.all = null),
							(a.labelBounds.source = null),
							(a.labelBounds.target = null),
							(a.labelBounds.main = null),
							(a.labelBounds.sourceRot = null),
							(a.labelBounds.targetRot = null),
							(a.labelBounds.mainRot = null),
							(a.arrowBounds.source = null),
							(a.arrowBounds.target = null),
							(a.arrowBounds["mid-source"] = null),
							(a.arrowBounds["mid-target"] = null);
					}
				...
				(jn.shiftCachedBoundingBox = function (e) {
					for (var a = 0; a < this.length; a++) {
						...
						null != t.bbCache &&
							((t.bbCacheShift.x += e.x), (t.bbCacheShift.y += e.y));
					}
					return this.emitAndNotify("bounds"), this;
				}),
				...
				(Wn.boundingbox = Wn.bb = Wn.boundingBox),
				(Wn.renderedBoundingbox = Wn.renderedBoundingBox);
			var nr,
				rr,
				ir = jn;
			nr = rr = {};
			var cr = function (e) {
				(e.uppercaseName = E(e.name)),
					(e.autoName = "auto" + e.uppercaseName),
					(e.labelName = "label" + e.uppercaseName),
					(e.outerName = "outer" + e.uppercaseName),
					(e.uppercaseOuterName = E(e.outerName)),
					(nr[e.name] = function () {
						var a = this[0],
							t = a._private,
						...
						if (a) {
							if (!n) return 1;
							if (a.isParent())
								return a.updateCompoundBounds(), t[e.autoName] || 0;
							var r = a.pstyle(e.name);
							switch (r.strValue) {
								case "label":
									return (
										a.recalculateRenderedStyle(), t.rstyle[e.labelName] || 0
									);
								default:
									return r.pfValue;
							}
				...
				recycle: function (e, a) {
					if (
						...
						null != e && e.preventDefault
							? ((this.type = e.type),
							  (this.isDefaultPrevented = e.defaultPrevented ? mr : hr))
							: null != e && e.type
							? (a = e)
							: (this.type = e),
						null != a &&
							((this.originalEvent = a.originalEvent),
							(this.type = null != a.type ? a.type : this.type),
							(this.cy = a.cy),
							(this.target = a.target),
							(this.position = a.position),
							(this.renderedPosition = a.renderedPosition),
						...
						var t = this.position,
							n = this.cy.zoom(),
							r = this.cy.pan();
						this.renderedPosition = { x: t.x * n + r.x, y: t.y * n + r.y };
					}
							...
							for (
								...
								if (!T(i)) {
									...
									if (c) {
										var o = c[1],
											s = c[2] ? c[2] : null;
										a(e, br(e, { type: o, namespace: s, target: e.context }));
									}
								}
							}
					else a(e, t);
				};
			(_r.on = _r.addListener =
				function (e, a, t, n, r) {
					return (
						Sr(
							this,
							function (e, a, t, n, r, i, c) {
								_(i) &&
									e.listeners.push({
										event: a,
										callback: i,
				...
				(_r.one = function (e, a, t, n) {
					return this.on(e, a, t, n, { one: !0 });
				}),
				(_r.removeListener = _r.off =
					function (e, a, t, n) {
						var r = this;
						...
						for (
							var i = this.listeners,
								c = function (c) {
									...
									Sr(
										r,
										function (a, t, n, r, s, l) {
											if (
												(o.type === n || "*" === e) &&
												((!r && ".*" !== o.namespace) || o.namespace === r) &&
												(!s || a.qualifierCompare(o.qualifier, s)) &&
												(!l || o.callback === l)
											)
			...
			var Cr = {
					...
					eventMatches: function (e, a, t) {
						...
						return (
							null == n ||
							(e !== t.target && B(t.target) && n.matches(t.target))
						);
					},
					...
					beforeEmit: function (e, a) {
						a.conf &&
							a.conf.once &&
							a.conf.onceCollection.removeListener(
								a.event,
								a.qualifier,
								a.callback
							);
				...
				Br = {
					...
					once: function (e, a, t) {
						for (var n = Nr(a), r = 0; r < this.length; r++) {
							this[r].emitter().on(e, n, t, { once: !0, onceCollection: this });
						}
					},
					emit: function (e, a) {
						for (var t = 0; t < this.length; t++) {
					...
					emitAndNotify: function (e, a) {
						if (0 !== this.length)
							return this.cy().notify(e, this), this.emit(e, a), this;
					},
				};
			...
			var Dr = {
					...
					byGroup: function () {
						for (
							var e = this.spawn(), a = this.spawn(), t = 0;
							t < this.length;
							t++
						) {
							var n = this[t];
					...
					intersect: function (e) {
						...
						for (
							var t = [],
								...
								i = r ? n._private.map : this._private.map,
								c = r ? this : n,
								o = 0;
							o < c.length;
							o++
					...
					diff: function (e) {
						...
						return (
							...
							c(i, this, n),
							{
								left: this.spawn(t, { unique: !0 }),
								right: this.spawn(n, { unique: !0 }),
								both: this.spawn(r, { unique: !0 }),
							}
						);
					},
					add: function (e) {
					...
					merge: function (e) {
						...
						for (var r = a.map, i = 0; i < e.length; i++) {
							...
							if (!r.has(o)) {
								var s = this.length++;
								(this[s] = c), r.set(o, { ele: c, index: s });
							} else {
								var l = r.get(o).index;
								(this[l] = c), r.set(o, { ele: c, index: l });
							}
						}
						return this;
					},
					unmergeAt: function (e) {
						...
						if (this.length > 1 && !n) {
							var r = this.length - 1,
								i = this[r],
								c = i._private.data.id;
							(this[r] = void 0), (this[e] = i), t.set(c, { ele: i, index: e });
						}
					...
					reduce: function (e, a) {
						for (var t = a, n = 0; n < this.length; n++)
							t = e(t, this[n], n, this);
						return t;
					},
					max: function (e, a) {
				...
				xr = Dr;
			(xr.u = xr["|"] = xr["+"] = xr.union = xr.or = xr.add),
				(xr["\\"] =
					xr["!"] =
					xr["-"] =
					xr.difference =
					xr.relativeComplement =
					xr.subtract =
						xr.not),
				(xr.n = xr["&"] = xr["."] = xr.and = xr.intersection = xr.intersect),
				(xr["^"] =
					xr["(+)"] =
					xr["(-)"] =
					xr.symmetricDifference =
					xr.symdiff =
						xr.xor),
				(xr.fnFilter = xr.filterFn = xr.stdFilter = xr.filter),
				(xr.complement = xr.abscomp = xr.absoluteComplement);
			var Ir = function (e, a) {
					...
					forEach: function (e, a) {
						if (_(e))
							for (var t = this.length, n = 0; n < t; n++) {
								var r = this[n];
								if (!1 === (a ? e.apply(a, [r, n, this]) : e(r, n, this)))
									break;
							}
						return this;
					},
			...
			Tr.each = Tr.forEach;
			var Ur = ye({ nodeDimensionsIncludeLabels: !1 }),
				Pr = {
					layoutDimensions: function (e) {
						...
						if (((e = Ur(e)), this.takesUpSpace()))
							if (e.nodeDimensionsIncludeLabels) {
								...
								a = { w: t.w, h: t.h };
							} else a = { w: this.outerWidth(), h: this.outerHeight() };
						else a = { w: 0, h: 0 };
					...
					layoutPositions: function (e, a, t) {
							...
							d = M(function (e, t) {
								...
								s &&
									(n = (function (e, a, t) {
										var n = a.x1 + a.w / 2,
											r = a.y1 + a.h / 2;
										return { x: n + (t.x - n) * e, y: r + (t.y - r) * e };
						...
						if (a.animate) {
							...
							if (a.fit) {
								var p = r.animation({
									fit: { boundingBox: i.boundingBoxAt(d), padding: a.padding },
									duration: a.animationDuration,
									easing: a.animationEasing,
								});
								e.animations.push(p);
							...
							e.animations.forEach(function (e) {
								...
								Et.all(
									...
									e.one("layoutstop", a.stop),
										e.emit({ type: "layoutstop", layout: e });
								});
						} else
							n.positions(d),
								a.fit && r.fit(a.eles, a.padding),
								null != a.zoom && r.zoom(a.zoom),
								a.pan && r.pan(a.pan),
								e.one("layoutready", a.ready),
								e.emit({ type: "layoutready", layout: e }),
								e.one("layoutstop", a.stop),
					...
					layout: function (e) {
						return this.cy().makeLayout(F({}, e, { eles: this }));
					},
				};
			function Mr(e, a, t) {
				var n,
			...
			Rr.takesUpSpace = Ar("takesUpSpace", Gr({ ok: Vr }));
			...
			(Rr.interactive = Ar(
				"interactive",
				Gr({ ok: Fr, parentOk: Lr, edgeOkViaNode: Vr })
			)),
			...
			var zr = kr("eleVisible", function (e) {
				...
				Wr = Vr;
			(Rr.visible = Ar("visible", Gr({ ok: zr, edgeOkViaNode: Wr }))),
				(Rr.hidden = function () {
					var e = this[0];
				...
				(Rr.bypass = Rr.css = Rr.style),
				(Rr.renderedCss = Rr.renderedStyle),
				(Rr.removeBypass = Rr.removeCss = Rr.removeStyle),
				(Rr.pstyle = Rr.parsedStyle);
			var jr = {};
			function Or(e) {
				return function () {
					var a = arguments,
			...
			Hr({
				...
				Hr({ field: "active", on: "activate", off: "unactivate" }),
				Hr({ field: "pannable", on: "panify", off: "unpanify" }),
			...
			var Qr = {},
				qr = function (e) {
					return function (a) {
						for (var t = [], n = 0; n < this.length; n++) {
							...
							if (r.isNode()) {
								for (
									var i = !1, c = r.connectedEdges(), o = 0;
									o < c.length;
									o++
								) {
									var s = c[o],
										...
										d = s.target();
									if (
										(e.noIncomingEdges && d === r && l !== r) ||
										(e.noOutgoingEdges && l === r && d !== r)
									) {
										i = !0;
										break;
									}
						...
						return this.spawn(t, { unique: !0 }).filter(a);
					};
				},
				Zr = function (e) {
					return function (a) {
						for (var t = [], n = 0; n < this.length; n++) {
							...
							if (r.isNode())
								for (var i = r.connectedEdges(), c = 0; c < i.length; c++) {
									...
									e.outgoing && s === r
										? (t.push(o), t.push(l))
										: e.incoming && l === r && (t.push(o), t.push(s));
								}
						}
						return this.spawn(t, { unique: !0 }).filter(a);
					};
				...
				Kr = function (e) {
					return function (a) {
						...
						return this.spawn(n, { unique: !0 }).filter(a);
					};
				};
			function Yr(e) {
				return function (a) {
					...
					for (var i = 0; i < a.length; i++)
						for (var c = a[i]._private.edges, o = 0; o < c.length; o++) {
							var s = c[o],
								l = s._private.data,
								d =
									this.hasElementWithId(l.source) &&
									a.hasElementWithId(l.target),
								u =
									a.hasElementWithId(l.source) &&
									this.hasElementWithId(l.target);
							if (d || u) {
						...
						for (var t = [], n = this.edges(), r = e, i = 0; i < n.length; i++)
							for (
								...
								var h = d[u],
									...
									y = g === l && p === s,
									f = s === g && l === p;
								((r.codirected && y) || (!r.codirected && (y || f))) &&
									t.push(h);
							}
						return this.spawn(t, { unique: !0 }).filter(a);
					}
			...
			(Qr.clearTraversalCache = function () {
				...
				F(Qr, {
					roots: qr({ noIncomingEdges: !0 }),
					leaves: qr({ noOutgoingEdges: !0 }),
					outgoers: In(Zr({ outgoing: !0 }), "outgoers"),
					successors: Kr({ outgoing: !0 }),
					incomers: In(Zr({ incoming: !0 }), "incomers"),
					predecessors: Kr({ incoming: !0 }),
				}),
				F(Qr, {
					neighborhood: In(function (e) {
						for (var a = [], t = this.nodes(), n = 0; n < t.length; n++)
							for (
								var r = t[n], i = r.connectedEdges(), c = 0;
								c < i.length;
								c++
							) {
								var o = i[c],
				...
				(Qr.neighbourhood = Qr.neighborhood),
				(Qr.closedNeighbourhood = Qr.closedNeighborhood),
				(Qr.openNeighbourhood = Qr.openNeighborhood),
				F(Qr, {
					source: In(function (e) {
						var a,
							t = this[0];
						return (
							t && (a = t._private.source || t.cy().collection()),
							a && e ? a.filter(e) : a
						);
					}, "source"),
					target: In(function (e) {
						var a,
							t = this[0];
						return (
							t && (a = t._private.target || t.cy().collection()),
							a && e ? a.filter(e) : a
						);
					}, "target"),
					sources: Yr({ attr: "source" }),
					targets: Yr({ attr: "target" }),
				}),
				F(Qr, {
					edgesWith: In(Xr(), "edgesWith"),
					edgesTo: In(Xr({ thisIsSrc: !0 }), "edgesTo"),
				}),
				F(Qr, {
					...
					codirectedEdges: In(Jr({ codirected: !0 }), "codirectedEdges"),
				}),
				F(Qr, {
					...
					if (void 0 !== e && x(e)) {
						...
						for (var h = 0, m = a.length; h < m; h++) {
							...
							if (null != g) {
								...
								(null == t || (t.unique && !n.has(p))) &&
									(n.set(p, { index: this.length, ele: g }),
									(this[this.length] = g),
									this.length++);
							}
						}
						(this._private = { cy: e, map: n }), r && this.restore();
			...
			(ai.instanceString = function () {
				...
				(ai.unique = function () {
					return new ei(this._private.cy, this, { unique: !0 });
				}),
				...
				(ai.$id = ai.getElementById),
				(ai.poolIndex = function () {
					...
					if (null != a) {
						...
						if (b(e)) {
							if ((t.startBatch(), e.data)) {
								...
								if (a.isEdge()) {
									var i = !1,
										...
										o = e.data.source,
										s = e.data.target;
									null != o && o != r.source && ((c.source = "" + o), (i = !0)),
										null != s &&
											s != r.target &&
											((c.target = "" + s), (i = !0)),
										i && (a = a.move(c));
							...
							return (
								...
								null != e.classes && a.classes(e.classes),
								t.endBatch(),
								this
							);
						}
						...
						if ((m.clearTraversalCache(), n || g.removed))
							if (void 0 === p.id) p.id = $r(i, m);
								...
								if (i.hasElementWithId(p.id)) {
									le("Can not create second element with ID `" + p.id + "`"),
										h();
									continue;
								}
							}
						...
						if (m.isEdge()) {
							for (
								...
								w(D) && (D = p[B] = "" + p[B]),
									null == D || "" === D
										? (le(
												"Can not create edge `" + y + "` with unspecified " + B
										  ),
										  (C = !0))
							...
							x.same(I)
								? x._private.edges.push(_)
								: (x._private.edges.push(_), I._private.edges.push(_)),
								(_._private.source = x),
								(_._private.target = I);
						}
						(g.map = new be()),
							g.map.set(y, { ele: m, index: 0 }),
							(g.removed = !1),
							n && i.addToPool(m);
					}
					for (var U = 0; U < o.length; U++) {
						...
						if (A) {
							...
							if (R.empty()) M.parent = void 0;
								...
								E ||
									(R[0]._private.children.push(P),
									(P._private.parent = R[0]),
									(c.hasCompoundNodes = !0));
							}
						}
					}
					if (e.length > 0) {
						for (var V = new ei(i, e), F = 0; F < V.length; F++) {
							var L = V[F];
							L.isNode() ||
								(L.parallelEdges().clearTraversalCache(),
								L.source().clearTraversalCache(),
								L.target().clearTraversalCache());
						}
						(c.hasCompoundNodes
							? i
									.collection()
									.merge(V)
									.merge(V.connectedNodes())
									.merge(V.parent())
							: V
						)
							...
							.updateStyle(t),
							t ? V.emitAndNotify("add") : n && V.emit("add");
					}
					return r;
				}),
				(ai.removed = function () {
				...
				(ai.remove = function () {
					...
					function s(e) {
						...
						(a && e.removed()) ||
							t ||
							((r[e.id()] = !0),
							e.isNode() ? (n.push(e), c(e), o(e)) : n.unshift(e));
					}
					...
					function p(e, a) {
						...
						var t = (e = e[0])._private.children,
							n = e.id();
						fe(t, a),
							(a._private.parent = null),
							g.ids[n] || ((g.ids[n] = !0), g.push(e));
					}
					...
					x.size() > 0 &&
						(e ? x.emitAndNotify("remove") : a && x.emit("remove"));
			...
			var ti = {
				add: function (e) {
					...
					if (N(e)) {
						...
						for (
							var o = e, s = [], l = ["nodes", "edges"], d = 0, u = l.length;
							d < u;
							d++
						) {
							var h = l[d],
			...
			function ni(e, a, t, n) {
				...
				var b = function (r) {
					return (
						_ || S(),
						e === a && t === n ? r : 0 === r ? 0 : 1 === r ? 1 : y(v(r), a, n)
					);
				};
			...
			var ri = (function () {
				...
				ci = {
					...
					ease: ii(0.25, 0.1, 0.25, 1),
					"ease-in": ii(0.42, 0, 1, 1),
					"ease-out": ii(0, 0, 0.58, 1),
					"ease-in-out": ii(0.42, 0, 0.58, 1),
					"ease-in-sine": ii(0.47, 0, 0.745, 0.715),
					"ease-out-sine": ii(0.39, 0.575, 0.565, 1),
					"ease-in-out-sine": ii(0.445, 0.05, 0.55, 0.95),
					"ease-in-quad": ii(0.55, 0.085, 0.68, 0.53),
					"ease-out-quad": ii(0.25, 0.46, 0.45, 0.94),
					"ease-in-out-quad": ii(0.455, 0.03, 0.515, 0.955),
					"ease-in-cubic": ii(0.55, 0.055, 0.675, 0.19),
					"ease-out-cubic": ii(0.215, 0.61, 0.355, 1),
					"ease-in-out-cubic": ii(0.645, 0.045, 0.355, 1),
					"ease-in-quart": ii(0.895, 0.03, 0.685, 0.22),
					"ease-out-quart": ii(0.165, 0.84, 0.44, 1),
					"ease-in-out-quart": ii(0.77, 0, 0.175, 1),
					"ease-in-quint": ii(0.755, 0.05, 0.855, 0.06),
					"ease-out-quint": ii(0.23, 1, 0.32, 1),
					"ease-in-out-quint": ii(0.86, 0, 0.07, 1),
					"ease-in-expo": ii(0.95, 0.05, 0.795, 0.035),
					"ease-out-expo": ii(0.19, 1, 0.22, 1),
					"ease-in-out-expo": ii(1, 0, 0, 1),
					"ease-in-circ": ii(0.6, 0.04, 0.98, 0.335),
					"ease-out-circ": ii(0.075, 0.82, 0.165, 1),
					"ease-in-out-circ": ii(0.785, 0.135, 0.15, 0.86),
			...
			function si(e, a) {
				return null != e.pfValue || null != e.value
					? null == e.pfValue || (null != a && "%" === a.type.units)
						? e.value
						: e.pfValue
					: e;
			}
				...
				if (!c.easingImpl)
					if (null == o) c.easingImpl = ci.linear;
						...
						v(d)
							? ((u = d), (h = []))
							: ((u = d[1]),
							  (h = d.slice(2).map(function (e) {
									return +e;
							  }))),
							h.length > 0
								? ("spring" === u && h.push(c.duration),
								  (c.easingImpl = ci[u].apply(null, h)))
								: (c.easingImpl = ci[u]);
					}
				var m,
					g = c.easingImpl;
				if (
					((m = 0 === c.duration ? 1 : (t - s) / c.duration),
					c.applying && (m = c.progress),
					m < 0 ? (m = 0) : m > 1 && (m = 1),
					null == c.delay)
				) {
					...
					if (y && r && !e.locked()) {
						var f = {};
						ui(p.x, y.x) && (f.x = li(p.x, y.x, m, g)),
							ui(p.y, y.y) && (f.y = li(p.y, y.y, m, g)),
							e.position(f);
					}
					var _ = c.startPan,
						S = c.pan,
						...
						w = null != S && n;
					w &&
						(ui(_.x, S.x) && (b.x = li(_.x, S.x, m, g)),
						ui(_.y, S.y) && (b.y = li(_.y, S.y, m, g)),
						e.emit("pan"));
					var C = c.startZoom,
						N = c.zoom,
						B = null != N && n;
					B &&
						(ui(C, N) && (i.zoom = Je(i.minZoom, li(C, N, m, g), i.maxZoom)),
						e.emit("zoom")),
						(w || B) && e.emit("viewport");
					var D = c.style;
					if (D && D.length > 0 && r) {
			...
			function mi(e, a) {
					...
					for (
						...
						m.stopped
							? (i.splice(u, 1),
							  ...
							  (m.started = !1),
							  d(m.frames))
							: (m.playing || m.applying) &&
							  (m.playing && m.applying && (m.applying = !1),
							  m.started || hi(0, h, e),
							  di(a, h, e, t),
							  m.applying && (m.applying = !1),
							  d(m.frames),
							  null != m.step && m.step(e),
							  h.completed() &&
									(i.splice(u, 1),
									(m.hooked = !1),
									(m.playing = !1),
				...
				var s = r(a, !0);
				(i || s) && (t.length > 0 ? a.notify("draw", t) : a.notify("draw")),
					t.unmerge(n),
					a.emit("step");
			}
			var gi = {
						...
						if (null != e.name) {
							...
							if (null != t) {
								...
								n = v(e.eles)
									...
									? e.eles
									: this.$();
								var r = new t(F({}, e, { cy: this, eles: n }));
								return r;
							}
							le(
								"No such layout `" +
					...
					notify: function (e, a) {
						...
						if (this.batching()) {
							...
							var n = (t.batchNotifications[e] =
								t.batchNotifications[e] || this.collection());
							null != a && n.merge(a);
				...
				wi = {
					...
					initRenderer: function (e) {
						...
						if (null != a) {
							...
							var t = bi(e);
							(t.cy = this),
								(this._private.renderer = new a(t)),
								this.notify("init");
						} else
							le(
			...
			(Ni.apply = function (e) {
				...
				for (var n = 0; n < e.length; n++) {
					...
					if (!i.empty) {
						...
						a.newStyle || this.updateTransitions(r, o.diffProps),
							this.updateStyleHints(r) && t.merge(r);
					}
				}
					...
					for (var i = [], c = {}, o = 0; o < this.length; o++) {
						...
						if (u || (d && h)) {
							...
							u && h
								...
								: u
								? (m = s.properties)
								: h && (m = s.mappedProperties);
							for (var g = 0; g < m.length; g++) {
								for (
									var p = m[g], y = p.name, f = !1, v = o + 1;
									v < this.length;
									v++
								) {
									var _ = this[v];
				...
				(Ni.getContextMeta = function (e) {
					...
					return (
						(a = this.getPropertiesDiff(n, t)),
						(e._private.styleCxtKey = t),
						{ key: t, diffPropNames: a, empty: 0 === a.length }
					);
				}),
				(Ni.getContextStyle = function (e) {
					...
					if (t[a]) return t[a];
					for (var n = { _private: { key: a } }, r = 0; r < this.length; r++) {
						var i = this[r];
						if ("t" === a[r])
				...
				(Ni.applyContextStyle = function (e, a, t) {
					for (
						var n = e.diffPropNames, r = {}, i = this.types, c = 0;
						c < n.length;
						c++
					) {
						var o = n[c],
						...
						if (l !== s) {
							if (
								...
								null != l &&
								null != l.mapping &&
								l.mapping.value === s.value
							) {
								var d = l.mapping;
								if ((d.fnValue = s.value(t)) === d.prevFnValue) continue;
							}
							var u = (r[o] = { prev: l });
							this.applyParsedProperty(t, s),
								(u.next = t.pstyle(o)),
								u.next && u.next.bypass && (u.next = u.next.bypassed);
						}
					}
					return { diffProps: r };
				}),
				(Ni.updateStyleHints = function (e) {
					...
					for (
						...
						if (null != y) {
							var f = this.properties[p],
								...
								S = void 0;
							null != f.hashOverride
								? (S = f.hashOverride(e, y))
								: null != y.pfValue && (S = y.pfValue);
					...
					if (
						((a.labelKey = i(e, ["label"], P)),
						(a.labelStyleKey = Y(a.styleKeys.commonLabel, a.labelKey)),
						o ||
							((a.sourceLabelKey = i(e, ["source-label"], P)),
							(a.sourceLabelStyleKey = Y(
								a.styleKeys.commonLabel,
								a.sourceLabelKey
							)),
							(a.targetLabelKey = i(e, ["target-label"], P)),
							(a.targetLabelStyleKey = Y(
								a.styleKeys.commonLabel,
								a.targetLabelKey
							))),
						o)
				...
				(Ni.clearStyleHints = function (e) {
					...
					(a.styleKeys = {}),
						(a.styleKey = null),
						(a.labelKey = null),
						(a.labelStyleKey = null),
						(a.sourceLabelKey = null),
						(a.sourceLabelStyleKey = null),
						(a.targetLabelKey = null),
						(a.targetLabelStyleKey = null),
						(a.nodeKey = null),
						(a.hasPie = null);
				}),
				(Ni.applyParsedProperty = function (e, a) {
					...
					if (
						("curve-style" === a.name &&
							e.isEdge() &&
							(("bezier" !== a.value && e.isLoop()) ||
								("haystack" === a.value &&
									(e.source().isParent() || e.target().isParent()))) &&
							(r = a = this.parse(a.name, "bezier", s)),
						r.delete)
					)
						return (i[r.name] = void 0), m(), !0;
					if (r.deleteBypassed)
						return l
							? !!l.bypass && ((l.bypassed = void 0), m(), !0)
							: (m(), !0);
					if (r.deleteBypass)
						return l
							? !!l.bypass && ((i[r.name] = l.bypassed), m(), !0)
							: (m(), !0);
					var g = function () {
						ue(
					...
					switch (r.mapped) {
						case c.mapData:
							for (
								var p, y = r.field.split("."), f = u.data, v = 0;
								v < y.length && f;
								v++
							) {
								f = f[y[v]];
						...
						case c.data:
							for (
								var P = r.field.split("."), M = u.data, k = 0;
								k < P.length && M;
								k++
							) {
								M = M[P[k]];
							...
							if (
								(null != M && (t = this.parse(r.name, M, r.bypass, "mapping")),
								!t)
							)
								return g(), !1;
							(t.mapping = r), (r = t);
						...
						case c.fn:
							...
							if (!(t = this.parse(r.name, R, r.bypass, "mapping")))
								return (
									ue(
					...
					return (
						s
							? ((r.bypassed = d ? l.bypassed : l), (i[r.name] = r))
							: d
							? (l.bypassed = r)
							: (i[r.name] = r),
						m(),
				...
				(Ni.cleanElements = function (e, a) {
					for (var t = 0; t < e.length; t++) {
						...
						if (
							...
							for (
								var r = n._private.style, i = Object.keys(r), c = 0;
								c < i.length;
								c++
							) {
								var o = i[c],
						...
						for (var o = {}, s = !1, l = 0; l < r.length; l++) {
							...
							if (h) {
								var m = h.prev,
									...
									y = void 0;
								m &&
									(w(m.pfValue) && w(g.pfValue)
										? ((p = g.pfValue - m.pfValue), (y = m.pfValue + 1e-6 * p))
										: w(m.value) && w(g.value)
										? ((p = g.value - m.value), (y = m.value + 1e-6 * p))
										: S(m.value) &&
										  S(g.value) &&
										  ((p =
												m.value[0] !== g.value[0] ||
										  ...
										  (y = m.strValue)),
									p &&
										((o[d] = g.strValue), this.applyBypass(e, d, y), (s = !0)));
							}
						}
						if (!s) return;
						(n.transitioning = !0),
					...
					this.checkTrigger(
						...
						function (r) {
							e.dirtyCompoundBoundsCache(),
								...
								("bezier" !== e.pstyle("curve-style").value &&
									("curve-style" !== a ||
										("bezier" !== t && "bezier" !== n))) ||
				...
				(Ni.checkTriggers = function (e, a, t, n) {
					e.dirtyStyleCache(),
						this.checkZOrderTrigger(e, a, t, n),
						this.checkBoundsTrigger(e, a, t, n);
				});
			var Bi = {
					applyBypass: function (e, a, t, n) {
						...
						for (var p = !1, y = 0; y < e.length; y++) {
							for (var f = e[y], _ = {}, S = void 0, w = 0; w < r.length; w++) {
								...
								(p = this.applyParsedProperty(f, C) || p),
									n && (S.next = f.pstyle(C.name));
							}
							p && this.updateStyleHints(f),
								n && this.updateTransitions(f, _, !0);
						}
						return p;
					},
					overrideBypass: function (e, a, t) {
						...
						for (var n = 0; n < e.length; n++) {
							...
							i && i.bypass
								...
								: this.applyBypass(r, a, t),
								this.checkTriggers(r, a, l, t);
						}
					},
				...
				Di = {
					...
					containerCss: function (e) {
						...
						if (u && a && u.getComputedStyle)
							return u.getComputedStyle(a).getPropertyValue(e);
					},
				},
				xi = {
					getRenderedStyle: function (e, a) {
						return a
							? this.getStylePropertyValue(e, a, !0)
					...
					getAnimationStartStyle: function (e, a) {
						for (var t = {}, n = 0; n < a.length; n++) {
							var r = a[n].name,
								i = e.pstyle(r);
							void 0 !== i &&
								(i = b(i) ? this.parse(r, i.strValue) : this.parse(r, i)),
								i && (t[r] = i);
						}
						return t;
					},
						...
						for (o = 0; o < a.length; o++)
							if (((n = a[o]), null != (r = e.pstyle(n, !1))))
								if (null != r.pfValue) l = Y(c, l);
									...
									for (i = r.strValue, s = 0; s < i.length; s++)
										(c = i.charCodeAt(s)), (l = Y(c, l));
						return l;
					},
				};
			...
			var Ii = {
					...
					json: function () {
						for (var e = [], a = this.defaultLength; a < this.length; a++) {
							...
							e.push({ selector: n ? n.toString() : "core", style: i });
						}
						return e;
					},
				},
					...
					appendFromString: function (e) {
						...
						for (r = r.replace(/[/][*](\s|.)+?[*][/]/g, ""); ; ) {
							...
							for (var u = []; ; ) {
								...
								var m = h[1],
									g = h[2];
								if (this.properties[m])
									this.parse(m, g)
										? (u.push({ name: m, val: g }), c())
										: (ue(
									...
									ue("Skipping property: Invalid property name in: " + n), c();
							}
							if (d) {
								i();
								break;
			...
			!(function () {
				...
				Ui.types = {
					...
					mapData: { mapping: !0, regex: t("mapData") },
					mapLayoutData: { mapping: !0, regex: t("mapLayoutData") },
					mapScratch: { mapping: !0, regex: t("mapScratch") },
					fn: { mapping: !0, fn: !0 },
					url: { regexes: n, singleRegexMatchValue: !0 },
					urls: { regexes: n, singleRegexMatchValue: !0, multiple: !0 },
					propList: { propList: !0 },
				...
				var r = {
					...
					i = Ui.types,
					c = [
						{ name: "label", type: i.text, triggersBounds: r.any },
						{
							name: "text-rotation",
							type: i.textRotation,
					...
					o = [
						{ name: "source-label", type: i.text, triggersBounds: r.any },
						{
						...
						{ name: "source-text-offset", type: i.size, triggersBounds: r.any },
					],
					s = [
						{ name: "target-label", type: i.text, triggersBounds: r.any },
						{
						...
						{ name: "target-text-offset", type: i.size, triggersBounds: r.any },
					],
					l = [
						{ name: "font-family", type: i.fontFamily, triggersBounds: r.any },
						{ name: "font-style", type: i.fontStyle, triggersBounds: r.any },
						{ name: "font-weight", type: i.fontWeight, triggersBounds: r.any },
						{ name: "font-size", type: i.size, triggersBounds: r.any },
						{
							name: "text-transform",
							type: i.textTransform,
							triggersBounds: r.any,
						},
						{ name: "text-wrap", type: i.textWrap, triggersBounds: r.any },
						{
							name: "text-overflow-wrap",
							type: i.textOverflowWrap,
							triggersBounds: r.any,
						},
						{ name: "text-max-width", type: i.size, triggersBounds: r.any },
						{ name: "text-outline-width", type: i.size, triggersBounds: r.any },
						{
							name: "line-height",
					...
					d = [
						{ name: "text-valign", type: i.valign, triggersBounds: r.any },
						{ name: "text-halign", type: i.halign, triggersBounds: r.any },
						...
						{ name: "text-border-width", type: i.size, triggersBounds: r.any },
						{
					...
					h = [
						...
						{ name: "visibility", type: i.visibility, triggersZOrder: r.any },
						{
							name: "opacity",
						...
						{ name: "z-index", type: i.nonNegativeInt, triggersZOrder: r.any },
					],
					m = [
						{ name: "overlay-padding", type: i.size, triggersBounds: r.any },
					...
					y = [
						...
						{ name: "shape", type: i.nodeShape, triggersBounds: r.any },
						{
						...
						{ name: "background-gradient-stop-positions", type: i.percentages },
						{
					...
					f = [
						...
						{ name: "border-width", type: i.size, triggersBounds: r.any },
					...
					S = [
						{ name: "position", type: i.position, triggersBounds: r.any },
						{
							name: "compound-sizing-wrt-labels",
							type: i.compoundIncludeLabels,
							triggersBounds: r.any,
						},
						{ name: "min-width", type: i.size, triggersBounds: r.any },
						{
						...
						{ name: "min-height", type: i.size, triggersBounds: r.any },
						{
					...
					b = [
						...
						{ name: "segment-weights", type: i.numbers, triggersBounds: r.any },
						{
							name: "taxi-turn",
							type: i.sizeMaybePercent,
							triggersBounds: r.any,
						...
						{ name: "loop-direction", type: i.angle, triggersBounds: r.any },
						{ name: "loop-sweep", type: i.angle, triggersBounds: r.any },
						{
					...
					w = [
						{ name: "ghost", type: i.bool, triggersBounds: r.any },
						{
							name: "ghost-offset-x",
							type: i.bidirectionalSize,
							triggersBounds: r.any,
					...
					N = [];
				(Ui.pieBackgroundN = 16),
					N.push({ name: "pie-size", type: i.sizeMaybePercent });
				for (var B = 1; B <= Ui.pieBackgroundN; B++)
					N.push({ name: "pie-" + B + "-background-color", type: i.color }),
						N.push({ name: "pie-" + B + "-background-size", type: i.percent }),
						N.push({
				...
				[
					{ name: "arrow-shape", type: i.arrowShape, triggersBounds: r.any },
					...
					x.forEach(function (a) {
						var t = a + "-" + e.name,
							n = e.type,
							r = e.triggersBounds;
						D.push({ name: t, type: n, triggersBounds: r });
					});
				}, {});
				var I = (Ui.properties = [].concat(
						u,
						g,
						h,
						m,
				...
				for (var A = 0; A < P.length; A++) {
					var R = P[A],
						E = I[R.pointsTo],
						V = { name: R.name, alias: !0, pointsTo: E };
					I.push(V), (I[R.name] = V);
				}
			})(),
					...
					for (
						var a = F(
								...
								[
									...
									return (
										Ui.arrowPrefixes.forEach(function (t) {
											var n = t + "-" + a.name,
												r = a.value;
											e[n] = r;
										}),
				...
				parse: function (e, a, t, n) {
					...
					var r,
						i = $(
							...
							"" + a,
							t ? "t" : "f",
							"mapping" === n || !0 === n || !1 === n || null == n
								? "dontcare"
								: n
						),
						c = (this.propCache = this.propCache || []);
					return (
						(r = c[i]) || (r = c[i] = this.parseImplWarn(e, a, t, n)),
						(t || "mapping" === n) && (r = he(r)) && (r.value = he(r.value)),
						r
					);
				},
				parseImplWarn: function (e, a, t, n) {
					...
					return (
						r ||
							null == a ||
							ue(
								"The style property `".concat(e, ": ").concat(a, "` is invalid")
							),
						r
					);
				},
			...
			Pi.parseImpl = function (e, a, t, n) {
				...
				if (!d) return null;
				if (t && ("" === a || null === a))
					return { name: e, value: a, bypass: !0, deleteBypass: !0 };
				if (_(a))
					return { name: e, value: a, strValue: "fn", mapped: c.fn, bypass: t };
				if (!o || n || a.length < 7 || "a" !== a[1]);
				else {
					if (
						a.length >= 7 &&
						"d" === a[0] &&
						(s = new RegExp(c.data.regex).exec(a))
					) {
						if (t) return !1;
						var u = c.data;
						return {
					...
					if (
						a.length >= 10 &&
						"m" === a[0] &&
						(l = new RegExp(c.mapData.regex).exec(a))
					) {
						if (t) return !1;
						...
						if (m.pfValue === g.pfValue || m.strValue === g.strValue)
							return (
								ue(
									"`" +
										e +
				...
				if (d.multiple && "multiple" !== n) {
					var f;
					if (
						((f = o ? a.split(/\s+/) : S(a) ? a : [a]),
						d.evenMultiple && f.length % 2 != 0)
					)
						return null;
					for (
						var b = [], C = [], N = [], B = "", D = !1, x = 0;
						...
						(D = D || v(I.value)),
							b.push(I.value),
							N.push(null != I.pfValue ? I.pfValue : I.value),
							C.push(I.units),
							(B += (x > 0 ? " " : "") + I.strValue);
					}
					return d.validate && !d.validate(b, C)
						? null
						: d.singleEnum && D
						? 1 === b.length && v(b[0])
							? { name: e, value: b[0], strValue: b[0], bypass: t }
							: null
						: {
								name: e,
								value: b,
				...
				var T,
					...
					P = function () {
						for (var n = 0; n < d.enums.length; n++) {
							if (d.enums[n] === a)
								return { name: e, value: a, strValue: "" + a, bypass: t };
						}
						return null;
					};
				if (d.number) {
					...
					if (((a = parseFloat(a)), isNaN(a) && void 0 === d.enums))
						return null;
					if (isNaN(a) && void 0 !== d.enums) return (a = i), P();
					if (d.integer && (!w((U = a)) || Math.floor(U) !== U)) return null;
					if (
						(void 0 !== d.min && (a < d.min || (d.strictMin && a === d.min))) ||
						(void 0 !== d.max && (a > d.max || (d.strictMax && a === d.max)))
					)
						return null;
					var V = {
						name: e,
					...
					return (
						d.unitless || ("px" !== M && "em" !== M)
							? (V.pfValue = a)
							: (V.pfValue =
									"px" !== M && M ? this.getEmSizeInPixels() * a : a),
						("ms" !== M && "s" !== M) || (V.pfValue = "ms" === M ? a : 1e3 * a),
						("deg" !== M && "rad" !== M) ||
							(V.pfValue = "rad" === M ? a : ((T = a), (Math.PI * T) / 180)),
						"%" === M && (V.pfValue = a / 100),
						V
					);
				}
				if (d.propList) {
					...
					if ("none" === z);
						...
						for (var W = z.split(/\s*,\s*|\s+/), j = 0; j < W.length; j++) {
							...
							this.properties[O]
								? F.push(O)
								: ue("`" + O + "` is not a valid property name");
						}
				...
				if (d.regex || d.regexes) {
					...
					for (
						var q = d.regexes ? d.regexes : [d.regex], Z = 0;
						Z < q.length;
						Z++
					) {
				...
				return d.string
					? { name: e, value: "" + a, strValue: "" + a, bypass: t }
					: d.enums
					? P()
					: null;
			};
			var Mi = function e(a) {
					if (!(this instanceof e)) return new e(a);
					x(a)
						? ((this._private = { cy: a, coreStyle: {} }),
						  (this.length = 0),
						  this.resetToDefault())
						: le("A style must have a core reference");
				},
				ki = Mi.prototype;
			(ki.instanceString = function () {
				...
				(ki.style = ki.css),
				(ki.cssRule = function (e, a) {
					var t = this.parse(e, a);
					if (t) {
						var n = this.length - 1;
						this[n].properties.push(t),
							(this[n].properties[t.name] = t),
							t.name.match(/pie-(\d+)-background-size/) &&
								t.value &&
								(this._private.hasPie = !0),
							t.mapped && this[n].mappedProperties.push(t),
							!this[n].selector && (this._private.coreStyle[t.name] = t);
					}
					return this;
				}),
				...
				(Mi.types = ki.types),
				(Mi.properties = ki.properties),
				(Mi.propertyGroups = ki.propertyGroups),
				(Mi.propertyGroupNames = ki.propertyGroupNames),
				(Mi.propertyGroupKeys = ki.propertyGroupKeys);
			var Ai = {
					style: function (e) {
					...
					setStyle: function (e) {
						...
						return (
							I(e)
								? (a.style = e.generateStyle(this))
								: S(e)
								? (a.style = Mi.fromJson(this, e))
								: v(e)
								? (a.style = Mi.fromString(this, e))
								: (a.style = Mi(this)),
							a.style
						);
					},
				...
				Ri = {
					...
					selectionType: function (e) {
						var a = this._private;
						return (
							null == a.selectionType && (a.selectionType = "single"),
							void 0 === e
								? a.selectionType
								: (("additive" !== e && "single" !== e) ||
										(a.selectionType = e),
					...
					getFitViewport: function (e, a) {
						if (
							...
							if (v(e)) {
								...
								var i = e;
								((t = { x1: i.x1, y1: i.y1, x2: i.x2, y2: i.y2 }).w =
									t.x2 - t.x1),
									(t.h = t.y2 - t.y1);
							...
							if (!N(e) || !e.empty()) {
								...
								if (
									...
									return {
										zoom: (c =
											(c =
												(c = Math.min((o - 2 * a) / t.w, (s - 2 * a) / t.h)) >
												this._private.maxZoom
													? this._private.maxZoom
													: c) < this._private.minZoom
					...
					zoomRange: function (e, a) {
						...
						return (
							w(e) && w(a) && e <= a
								? ((t.minZoom = e), (t.maxZoom = a))
								: w(e) && void 0 === a && e <= t.maxZoom
								? (t.minZoom = e)
								: w(a) && void 0 === e && a >= t.minZoom && (t.maxZoom = a),
							this
						);
					},
					minZoom: function (e) {
					...
					getZoomedViewport: function (e) {
						...
						if (
							...
							w(e)
								...
								: b(e) &&
								  ...
								  null != e.position
										? (a = ze(e.position, i, r))
										: null != e.renderedPosition && (a = e.renderedPosition),
								  null == a || n.panningEnabled || (c = !0)),
							(t =
								(t = t > n.maxZoom ? n.maxZoom : t) < n.minZoom
									? n.minZoom
									: t),
							c || !w(t) || t === i || (null != a && (!w(a.x) || !w(a.y))))
						)
							return null;
						if (null != a) {
							var o = r,
						...
						return { zoomed: !0, panned: !1, zoom: t, pan: r };
					},
					zoom: function (e) {
						if (void 0 === e) return this._private.zoom;
						var a = this.getZoomedViewport(e),
							t = this._private;
						return null != a && a.zoomed
							? ((t.zoom = a.zoom),
							  a.panned && ((t.pan.x = a.pan.x), (t.pan.y = a.pan.y)),
							  this.emit("zoom" + (a.panned ? " pan" : "") + " viewport"),
							  this.notify("viewport"),
							  this)
							: this;
					},
					viewport: function (e) {
						var a = this._private,
							...
							c = !1;
						if (!e) return this;
						if ((w(e.zoom) || (t = !1), b(e.pan) || (n = !1), !t && !n))
							return this;
						if (t) {
							var o = e.zoom;
							o < a.minZoom || o > a.maxZoom || !a.zoomingEnabled
								? (i = !0)
								: ((a.zoom = o), r.push("zoom"));
						}
						if (n && (!i || !e.cancelOnFailedZoom) && a.panningEnabled) {
							var s = e.pan;
							w(s.x) && ((a.pan.x = s.x), (c = !1)),
								w(s.y) && ((a.pan.y = s.y), (c = !1)),
								c || r.push("pan");
						}
						return (
							r.length > 0 &&
						...
						if (this._private.panningEnabled) {
							...
							if (0 !== e.length) {
								...
								return {
									x:
										(r -
											(a = void 0 === a ? this._private.zoom : a) *
												(n.x1 + n.x2)) /
										2,
									y: (i - a * (n.y1 + n.y2)) / 2,
								};
					...
					size: function () {
						...
						return (t.sizeCache =
							t.sizeCache ||
							(n
								? ((e = u.getComputedStyle(n)),
								  (a = function (a) {
										return parseFloat(e.getPropertyValue(a));
								  }),
								  {
										width:
											n.clientWidth - a("padding-left") - a("padding-right"),
										height:
											n.clientHeight - a("padding-top") - a("padding-bottom"),
								  })
								: { width: 1, height: 1 }));
					},
					width: function () {
					...
					renderedExtent: function () {
						var e = this.width(),
							a = this.height();
						return { x1: 0, y1: 0, x2: e, y2: a, w: e, h: a };
					},
				};
			(Ri.centre = Ri.center),
				(Ri.autolockNodes = Ri.autolock),
				(Ri.autoungrabifyNodes = Ri.autoungrabify);
			var Ei = {
				data: Ft.data({
					field: "data",
					bindingEvent: "data",
			...
			var Gi = function (e) {
					...
					var i = void 0 !== u && void 0 !== t && !e.headless,
						c = e;
					(c.layout = F({ name: i ? "grid" : "null" }, c.layout)),
						(c.renderer = F({ name: i ? "canvas" : "null" }, c.renderer));
					...
					this.createEmitter(),
						this.selectionType(c.selectionType),
						this.zoomRange({ min: c.minZoom, max: c.maxZoom });
					...
					!(function (e, a) {
						...
						s.styleEnabled && a.style().append(t),
							(function (e, t, n) {
								...
								r.length > 0 && r.remove(),
									null != e && (b(e) || S(e)) && a.add(e),
									a
										.one("layoutready", function (e) {
											a.notifications(!0),
												a.emit(e),
												a.one("load", t),
												a.emitAndNotify("load");
										})
				...
				json: function (e) {
					...
					if (b(e)) {
						...
						e.style && a.style(e.style),
							null != e.zoom && e.zoom !== t.zoom && a.zoom(e.zoom),
							e.pan &&
								((e.pan.x === t.pan.x && e.pan.y === t.pan.y) || a.pan(e.pan)),
					...
					var g = {};
					!!e
						? (g.elements = this.elements().map(function (e) {
								return e.json();
						  }))
						: ((g.elements = {}),
						  n.forEach(function (e) {
								var a = e.group();
								g.elements[a] || (g.elements[a] = []),
									g.elements[a].push(e.json());
						  })),
						this._private.styleEnabled && (g.style = a.style().json()),
						(g.data = he(a.data()));
					var p = t.options;
					return (
						(g.zoomingEnabled = t.zoomingEnabled),
						(g.userZoomingEnabled = t.userZoomingEnabled),
						(g.zoom = t.zoom),
						(g.minZoom = t.minZoom),
						(g.maxZoom = t.maxZoom),
						(g.panningEnabled = t.panningEnabled),
						(g.userPanningEnabled = t.userPanningEnabled),
						(g.pan = he(t.pan)),
						(g.boxSelectionEnabled = t.boxSelectionEnabled),
						(g.renderer = he(p.renderer)),
						(g.hideEdgesOnViewport = p.hideEdgesOnViewport),
						(g.textureOnViewport = p.textureOnViewport),
						(g.wheelSensitivity = p.wheelSensitivity),
						(g.motionBlur = p.motionBlur),
						g
					);
				},
			}),
				(Vi.$id = Vi.getElementById),
				[ti, gi, fi, vi, _i, Si, wi, Ci, Ai, Ri, Ei].forEach(function (e) {
					F(Vi, e);
				});
			var Fi = {
					fit: !0,
			...
			Wi.prototype.run = function () {
				...
				var f = [],
					...
					b = function (e, a) {
						null == f[a] && (f[a] = []);
						var t = f[a].length;
						f[a].push(e), zi(e, { index: t, depth: a });
					};
				c.bfs({
					roots: e,
					directed: t.directed,
				...
				var D = function (e) {
						for (var a = f[e], t = 0; t < a.length; t++) {
							var n = a[t];
							null != n ? zi(n, { depth: e, index: t }) : (a.splice(t, 1), t--);
						}
					},
					x = function () {
					...
					I = function (e, a) {
						for (
							var t = Li(e),
								n = e.incomers().filter(function (e) {
				...
				for (
					var L = {},
						z = function (e) {
							...
							for (
								var a = Li(e).depth, t = e.neighborhood(), n = 0, r = 0, c = 0;
								c < t.length;
								c++
							) {
								var o = t[c];
				...
				return (
					i.layoutPositions(this, t, function (e) {
						...
						if (((s = Math.max(s, A)), t.circle)) {
							var d =
									s * n + s - (f.length > 0 && f[0].length <= 3 ? s / 2 : 0),
								u = ((2 * Math.PI) / f[n].length) * r;
							return (
								0 === n && 1 === f[0].length && (d = 1),
								{ x: Z + d * Math.cos(u), y: K + d * Math.sin(u) }
							);
						}
						return { x: Z + (r + 1 - (i + 1) / 2) * c, y: (n + 1) * o };
					}),
					this
				);
			};
			...
			Oi.prototype.run = function () {
				...
				if (
					((c = w(a.radius)
						...
						: i.length <= 1
						? 0
						: Math.min(o.h, o.w) / 2 - u),
					i.length > 1 && a.avoidOverlap)
				) {
					u *= 1.75;
				...
				return (
					i.layoutPositions(this, a, function (e, t) {
			...
			qi.prototype.run = function () {
				for (
					var e = this.options,
						a = e,
						t =
							void 0 !== a.counterclockwise ? !a.counterclockwise : a.clockwise,
						n = e.cy,
						r = a.eles.nodes().not(":parent"),
						i = $e(
							a.boundingBox
								? a.boundingBox
								: { x1: 0, y1: 0, w: n.width(), h: n.height() }
				...
				for (
					var p = a.levelWidth(r), y = [[]], f = y[0], v = 0;
					v < s.length;
					v++
				) {
					var _ = s[v];
					if (f.length > 0)
						Math.abs(f[0].value - _.value) >= p && ((f = []), y.push(f));
					f.push(_);
				}
				...
				for (var G = {}, V = 0; V < y.length; V++)
					for (var F = y[V], L = F.dTheta, z = F.r, W = 0; W < F.length; W++) {
						var j = F[W],
							...
							H = { x: c + z * Math.cos(O), y: o + z * Math.sin(O) };
						G[j.node.id()] = H;
					}
				return (
					r.layoutPositions(this, a, function (e) {
						var a = e.id();
						return G[a];
					}),
					this
			...
			(Ki.prototype.run = function () {
				...
				if (!0 === e.animate) {
					!(function a() {
						...
						l
							? (Z() - r >= e.animationThreshold && i(), q(a))
							: (gc(n, e), o());
					})();
				} else {
					for (; l; ) (l = c(s)), s++;
			...
			var Yi = function (e, a, t) {
					...
					for (s = 0; s < i.nodeSize; s++) {
						...
						((k = {}).isLocked = y.locked()),
							(k.id = y.data("id")),
							(k.parentId = y.data("parent")),
							(k.cmptId = o[y.id()]),
							(k.children = []),
							(k.positionX = y.position("x")),
							(k.positionY = y.position("y")),
							(k.offsetX = 0),
							(k.offsetY = 0),
							(k.height = u.w),
							(k.width = u.h),
							(k.maxX = k.positionX + k.width / 2),
							(k.minX = k.positionX - k.width / 2),
							(k.maxY = k.positionY + k.height / 2),
							(k.minY = k.positionY - k.height / 2),
							(k.padLeft = parseFloat(y.style("padding"))),
							(k.padRight = parseFloat(y.style("padding"))),
							(k.padTop = parseFloat(y.style("padding"))),
							(k.padBottom = parseFloat(y.style("padding"))),
							(k.nodeRepulsion = _(t.nodeRepulsion)
								? t.nodeRepulsion(y)
								: t.nodeRepulsion),
							i.layoutNodes.push(k),
							(i.idToIndex[k.id] = s);
					}
					var h = [],
						m = 0,
					...
					for (s = 0; s < i.nodeSize; s++) {
						var y,
							f = (y = i.layoutNodes[s]).parentId;
						null != f
							? i.layoutNodes[i.idToIndex[f]].children.push(y.id)
							: ((h[++g] = y.id), p.push(y.id));
					}
					...
					for (s = 0; s < i.edgeSize; s++) {
						var N = n[s],
							B = {};
						(B.id = N.data("id")),
							(B.sourceId = N.data("source")),
							(B.targetId = N.data("target"));
						var D = _(t.idealEdgeLength)
								? t.idealEdgeLength(N)
								: t.idealEdgeLength,
						...
						if (i.indexToGraph[I] != i.indexToGraph[T]) {
							for (
								var U = Xi(B.sourceId, B.targetId, i),
									P = i.graphSet[U],
									M = 0,
									k = i.layoutNodes[I];
								-1 === P.indexOf(k.id);
								...
								(k = i.layoutNodes[i.idToIndex[k.parentId]]), M++;
							for (k = i.layoutNodes[T]; -1 === P.indexOf(k.id); )
								(k = i.layoutNodes[i.idToIndex[k.parentId]]), M++;
							D *= M * t.nestingFactor;
						}
				...
				Ji = function e(a, t, n, r) {
					var i = r.graphSet[n];
					if (-1 < i.indexOf(a) && -1 < i.indexOf(t))
					...
					return { count: c, graph: n };
				},
				$i = function (e, a) {
					for (
						var t = e.clientWidth, n = e.clientHeight, r = 0;
						r < e.nodeSize;
						r++
					) {
						...
						0 !== i.children.length ||
							i.isLocked ||
							((i.positionX = Math.random() * t),
							(i.positionY = Math.random() * n));
					}
				},
				ec = function (e, a, t) {
					var n = e.boundingBox,
						r = { x1: 1 / 0, x2: -1 / 0, y1: 1 / 0, y2: -1 / 0 };
					return (
						a.boundingBox &&
							(t.forEach(function (a) {
								var t = e.layoutNodes[e.idToIndex[a.data("id")]];
								(r.x1 = Math.min(r.x1, t.positionX)),
									(r.x2 = Math.max(r.x2, t.positionX)),
									(r.y1 = Math.min(r.y1, t.positionY)),
									(r.y2 = Math.max(r.y2, t.positionY));
							}),
							(r.w = r.x2 - r.x1),
							(r.h = r.y2 - r.y1)),
						function (t, i) {
							...
							if (a.boundingBox) {
								...
								return { x: n.x1 + o * n.w, y: n.y1 + s * n.h };
							}
				...
				nc = function (e, a) {
					for (var t = 0; t < e.graphSet.length; t++)
						for (var n = e.graphSet[t], r = n.length, i = 0; i < r; i++)
							for (
								var c = e.layoutNodes[e.idToIndex[n[i]]], o = i + 1;
								o < r;
								o++
							) {
					...
					if (e.cmptId === a.cmptId || t.isCompound) {
						...
						if (c > 0)
							...
							var l,
								...
								g = h * h + m * m,
								p = Math.sqrt(g);
							(o = ((l = (e.nodeRepulsion + a.nodeRepulsion) / g) * h) / p),
								(s = (l * m) / p);
						}
						e.isLocked || ((e.offsetX -= o), (e.offsetY -= s)),
							a.isLocked || ((a.offsetX += o), (a.offsetY += s));
					}
				},
				cc = function (e, a, t, n) {
				...
				oc = function (e, a, t) {
					...
					return 0 === a && 0 < t
						...
						? ((l.x = n), (l.y = r + i / 2), l)
						: 0 < a && -1 * s <= o && o <= s
						? ((l.x = n + c / 2), (l.y = r + (c * t) / 2 / a), l)
						: 0 > a && -1 * s <= o && o <= s
						? ((l.x = n - c / 2), (l.y = r - (c * t) / 2 / a), l)
						: 0 < t && (o <= -1 * s || o >= s)
						? ((l.x = n + (i * a) / 2 / t), (l.y = r + i / 2), l)
						: 0 > t && (o <= -1 * s || o >= s)
						? ((l.x = n - (i * a) / 2 / t), (l.y = r - i / 2), l)
						: l;
				},
				sc = function (e, a) {
					for (var t = 0; t < e.edgeSize; t++) {
						...
						if (0 !== s || 0 !== l) {
							...
							i.isLocked || ((i.offsetX += y), (i.offsetY += f)),
								o.isLocked || ((o.offsetX -= y), (o.offsetY -= f));
						}
					}
				},
				lc = function (e, a) {
				...
				dc = function (e, a) {
					var t = [],
						...
						r = -1;
					for (
						t.push.apply(t, e.graphSet[0]), r += e.graphSet[0].length;
						n <= r;
				...
				uc = function (e, a) {
					for (var t = 0; t < e.nodeSize; t++) {
						0 < (r = e.layoutNodes[t]).children.length &&
							((r.maxX = void 0),
							(r.minX = void 0),
							(r.maxY = void 0),
							(r.minY = void 0));
				...
				mc = function e(a, t) {
					...
					if (null != n) {
						var r = t.layoutNodes[t.idToIndex[n]],
							i = !1;
						return (
							(null == r.maxX || a.maxX + r.padRight > r.maxX) &&
								((r.maxX = a.maxX + r.padRight), (i = !0)),
							(null == r.minX || a.minX - r.padLeft < r.minX) &&
								((r.minX = a.minX - r.padLeft), (i = !0)),
							(null == r.maxY || a.maxY + r.padBottom > r.maxY) &&
								((r.maxY = a.maxY + r.padBottom), (i = !0)),
							(null == r.minY || a.minY - r.padTop < r.minY) &&
								((r.minY = a.minY - r.padTop), (i = !0)),
							i ? e(r, t) : void 0
						);
					}
				},
					...
					for (r = 0; r < n.length; r++) {
						if ((p = n[r])) {
							...
							for (var s = 0; s < p.length; s++) {
								var l = p[s];
								(p.x1 = Math.min(p.x1, l.positionX - l.width / 2)),
									(p.x2 = Math.max(p.x2, l.positionX + l.width / 2)),
									(p.y1 = Math.min(p.y1, l.positionY - l.height / 2)),
									(p.y2 = Math.max(p.y2, l.positionY + l.height / 2));
							}
					...
					for (r = 0; r < n.length; r++) {
						...
						if ((p = n[r])) {
							for (s = 0; s < p.length; s++) {
								(l = p[s]).isLocked ||
									((l.positionX += d - p.x1), (l.positionY += u - p.y1));
							}
							(d += p.w + a.componentSpacing),
								(h += p.w + a.componentSpacing),
								(m = Math.max(m, p.h)),
								h > g &&
									((u += m + a.componentSpacing), (d = 0), (h = 0), (m = 0));
						}
					}
				},
				pc = {
			...
			yc.prototype.run = function () {
				...
				if (0 === r.h || 0 === r.w)
					n.layoutPositions(this, a, function (e) {
					...
					for (
						...
						if (R && (void 0 !== R.row || void 0 !== R.col)) {
							var E = { row: R.row, col: R.col };
							if (void 0 === E.col) for (E.col = 0; x(E.row, E.col); ) E.col++;
					...
					n.layoutPositions(this, a, function (e, a) {
						...
						var i = M[e.id()];
						if (i)
							(t = i.col * f + f / 2 + r.x1), (n = i.row * v + v / 2 + r.y1);
						else {
							for (; x(T, U); ) P();
							(t = U * f + f / 2 + r.x1),
								(n = T * v + v / 2 + r.y1),
			...
			var fc = { ready: function () {}, stop: function () {} };
			function vc(e) {
				this.options = F({}, fc, e);
			}
			...
			Sc.prototype.run = function () {
				var e = this.options,
					...
					t = _(e.positions);
				return (
					a.layoutPositions(this, e, function (a, n) {
						var r = (function (a) {
			...
			wc.prototype.run = function () {
				var e = this.options,
					...
					n = $e(
						e.boundingBox
							? e.boundingBox
							: { x1: 0, y1: 0, w: a.width(), h: a.height() }
					);
				return (
					t.layoutPositions(this, e, function (e, a) {
						return {
			...
			var Cc = [
				{ name: "breadthfirst", impl: Wi },
				{ name: "circle", impl: Oi },
				{ name: "concentric", impl: qi },
				{ name: "cose", impl: Ki },
				{ name: "grid", impl: yc },
				{ name: "null", impl: vc },
				{ name: "preset", impl: Sc },
						...
						o("none", {
							...
							o("circle", {
								...
								collide: function (e, a, t, n, r, i, c) {
									var o = r;
									return (
										Math.pow(o.x - e, 2) + Math.pow(o.y - a, 2) <=
										Math.pow((t + 2 * c) * this.radius, 2)
									);
								},
				...
				Ic = {
					...
					findNearestElements: function (e, a, t, n) {
						...
						function y(e, a) {
							...
							if (e.isEdge() && (null == a || a < p))
								if (r) {
									if (
										r.pstyle("z-compound-depth").value ===
						...
						function f(t) {
							...
							if (
								...
								l.y - s <= a &&
								a <= l.y + s &&
								o.nodeShapes[c.getNodeShape(t)].checkPoint(
									e,
									a,
									0,
									n,
						...
						function v(t) {
							...
							if (
								...
								for (var S = i.allpts, b = 0; b + 3 < S.length; b += 2)
									if (
										la(e, a, S[b], S[b + 1], S[b + 2], S[b + 3], p) &&
										g > (n = ha(e, a, S[b], S[b + 1], S[b + 2], S[b + 3]))
									)
										return y(t, n), !0;
							} else if (
								"bezier" === i.edgeType ||
							...
							for (b = 0; b < C.length; b++) {
								...
								if (
									B.roughCollide(e, a, w, N.angle, { x: N.x, y: N.y }, D, h) &&
									B.collide(e, a, w, N.angle, { x: N.x, y: N.y }, D, h)
								)
									return y(t), !0;
							}
					...
					getAllInBox: function (e, a, t, n) {
						for (
							var r,
								i,
								c = this.getCachedZSortedEles().interactive,
								o = [],
								s = Math.min(e, t),
								l = Math.max(e, t),
								d = Math.min(a, n),
								u = Math.max(a, n),
								h = $e({ x1: (e = s), y1: (a = d), x2: (t = l), y2: (n = u) }),
								m = 0;
							m < c.length;
							m++
						) {
							...
							if (g.isNode()) {
								...
								if (
									null != _.startX &&
									null != _.startY &&
									!ca(h, _.startX, _.startY)
								)
									continue;
								if (null != _.endX && null != _.endY && !ca(h, _.endX, _.endY))
									continue;
								if (
									"bezier" === _.edgeType ||
									"multibezier" === _.edgeType ||
									"self" === _.edgeType ||
									"compound" === _.edgeType ||
									"segments" === _.edgeType ||
									"haystack" === _.edgeType
									...
									("haystack" !== _.edgeType && "straight" !== _.edgeType) ||
										o.push(f);
							}
						}
						return o;
				...
				Tc = {
					calculateArrowAngles: function (e) {
						...
						if (
							...
							(a = n - o.segpts[0]), (t = r - o.segpts[1]);
						else if (d || h || m || l) {
							var g = o.allpts;
							(a = n - Ye(g[0], g[2], g[4], 0.1)),
								(t = r - Ye(g[1], g[3], g[5], 0.1));
						} else (a = n - p), (t = r - y);
						...
						if (
							...
							if ((o.ctrlpts.length / 2) % 2 == 0) {
								...
								(S = Ye(g[D], g[B], g[N], 0)),
									(b = Ye(g[D + 1], g[B + 1], g[N + 1], 0)),
									(w = Ye(g[D], g[B], g[N], 1e-4)),
									(C = Ye(g[D + 1], g[B + 1], g[N + 1], 1e-4));
							} else {
								var B, D;
								N = (B = g.length / 2 - 1) + 2;
								(S = Ye(g[(D = B - 2)], g[B], g[N], 0.4999)),
									(b = Ye(g[D + 1], g[B + 1], g[N + 1], 0.4999)),
									(w = Ye(g[D], g[B], g[N], 0.5)),
									(C = Ye(g[D + 1], g[B + 1], g[N + 1], 0.5));
							}
							(a = w - S), (t = C - b);
						}
						((o.midtgtArrowAngle = Oe(a, t)),
						(o.midDispX = a),
						(o.midDispY = t),
						(a *= -1),
						(t *= -1),
						u) &&
							(((g = o.allpts).length / 2) % 2 == 0 ||
								((a = -(g[(_ = (v = g.length / 2 - 1) + 2)] - g[v])),
								(t = -(g[_ + 1] - g[v + 1]))));
						if (((o.midsrcArrowAngle = Oe(a, t)), u))
							(a = i - o.segpts[o.segpts.length - 2]),
								(t = c - o.segpts[o.segpts.length - 1]);
						else if (d || h || m || l) {
							var x = (g = o.allpts).length;
							(a = i - Ye(g[x - 6], g[x - 4], g[x - 2], 0.9)),
								(t = c - Ye(g[x - 5], g[x - 3], g[x - 1], 0.9));
						} else (a = i - p), (t = c - y);
			...
			Tc.getArrowWidth = Tc.getArrowHeight = function (e, a) {
				...
				return (
					n ||
					((n = Math.max(Math.pow(13.37 * e, 0.9), 29) * a),
					(t[e + ", " + a] = n),
					n)
				);
			};
			...
			(Uc.findHaystackPoints = function (e) {
				for (var a = 0; a < e.length; a++) {
					...
					if (!r.haystack) {
						...
						(r.source = { x: Math.cos(i), y: Math.sin(i) }),
							(i = 2 * Math.random() * Math.PI),
							(r.target = { x: Math.cos(i), y: Math.sin(i) });
					}
					var c = n.source,
						o = n.target,
						s = c.position(),
				...
				(Uc.findSegmentsPoints = function (e, a) {
					...
					for (var d = 0; d < l; d++) {
						var u = o.pfValue[d],
							...
							y = { x: p.x1 * m + p.x2 * g, y: p.y1 * m + p.y2 * g };
				...
				(Uc.findLoopPoints = function (e, a, t, n) {
					...
					var g = l - Math.PI / 2,
						...
						y = g + d / 2,
						f = String(l + "_" + d);
					(h = void 0 === i[f] ? (i[f] = 0) : ++i[f]),
						(r.ctrlpts = [
							c.x + 1.4 * Math.cos(p) * m * (h / 3 + 1),
							c.y + 1.4 * Math.sin(p) * m * (h / 3 + 1),
							c.x + 1.4 * Math.cos(y) * m * (h / 3 + 1),
							c.y + 1.4 * Math.sin(y) * m * (h / 3 + 1),
						]);
				}),
				(Uc.findCompoundLoopPoints = function (e, a, t, n) {
					...
					var i = a.srcPos,
						...
						p = u;
					n && ((g = 0), (p = m));
					var y = { x: i.x - o / 2, y: i.y - s / 2 },
						f = { x: c.x - l / 2, y: c.y - d / 2 },
						v = { x: Math.min(y.x, f.x), y: Math.min(y.y, f.y) },
						_ = Math.max(0.5, Math.log(0.01 * o)),
						S = Math.max(0.5, Math.log(0.01 * l));
					r.ctrlpts = [
						v.x,
						v.y - (1 + Math.pow(50, 1.12) / 100) * p * (g / 3 + 1) * _,
						v.x - (1 + Math.pow(50, 1.12) / 100) * p * (g / 3 + 1) * S,
						v.y,
					];
				}),
				...
				(Uc.findBezierPoints = function (e, a, t, n, r) {
					...
					for (var f = 0; f < m; f++) {
						var v = (0.5 - a.eles.length / 2 + t) * d * (r ? -1 : 1),
							_ = void 0,
							S = Qe(v);
						y && ((g = u ? u.pfValue[f] : d), (p = h.value[f]));
						var b =
								void 0 !== (_ = n ? g : void 0 !== g ? S * g : void 0) ? _ : v,
							w = 1 - p,
							C = p,
							N = "node-position" === l ? o : s,
							B = { x: N.x1 * w + N.x2 * C, y: N.y1 * w + N.y2 * C };
				...
				(Uc.findTaxiPoints = function (e, a) {
					...
					var n = a.posPts,
						...
						w = !1;
					"auto" === l
						? (l = Math.abs(S) > Math.abs(b) ? "horizontal" : "vertical")
						: "upward" === l || "downward" === l
						? ((l = "vertical"), (w = !0))
						: ("leftward" !== l && "rightward" !== l) ||
						  ((l = "horizontal"), (w = !0));
					var C = "vertical" === l,
						N = C ? b : S,
						B = C ? v : f,
				...
				(Uc.tryToCorrectInvalidPoints = function (e, a) {
					...
					if ("bezier" === t.edgeType) {
						...
						if (u || h || f) {
							S = !0;
							var b = { x: t.ctrlpts[0] - n.x, y: t.ctrlpts[1] - n.y },
							...
							f
								? ((t.ctrlpts[0] = t.ctrlpts[0] + N.x * (p - y)),
								  (t.ctrlpts[1] = t.ctrlpts[1] + N.y * (p - y)))
								: ((t.ctrlpts[0] = x[0] + N.x * p),
								  (t.ctrlpts[1] = x[1] + N.y * p));
						}
						if (m || g || _) {
							S = !0;
							var I = { x: t.ctrlpts[0] - r.x, y: t.ctrlpts[1] - r.y },
							...
							_
								? ((t.ctrlpts[0] = t.ctrlpts[0] + U.x * (p - v)),
								  (t.ctrlpts[1] = t.ctrlpts[1] + U.y * (p - v)))
								: ((t.ctrlpts[0] = k[0] + U.x * p),
								  (t.ctrlpts[1] = k[1] + U.y * p));
						}
				...
				(Uc.storeAllpts = function (e) {
					...
					if (
						...
						for (var t = 0; t + 1 < a.ctrlpts.length; t += 2)
							a.allpts.push(a.ctrlpts[t], a.ctrlpts[t + 1]),
								t + 3 < a.ctrlpts.length &&
									a.allpts.push(
										(a.ctrlpts[t] + a.ctrlpts[t + 2]) / 2,
										(a.ctrlpts[t + 1] + a.ctrlpts[t + 3]) / 2
									);
						var n;
						a.allpts.push(a.endX, a.endY),
							(a.ctrlpts.length / 2) % 2 == 0
								? ((n = a.allpts.length / 2 - 1),
								  (a.midX = a.allpts[n]),
								  (a.midY = a.allpts[n + 1]))
								: ((n = a.allpts.length / 2 - 3),
								  0.5,
								  (a.midX = Ye(
										a.allpts[n],
										a.allpts[n + 2],
						...
						(a.allpts = [a.startX, a.startY, a.endX, a.endY]),
							(a.midX = (a.startX + a.endX + a.arrowStartX + a.arrowEndX) / 4),
							(a.midY = (a.startY + a.endY + a.arrowStartY + a.arrowEndY) / 4);
						...
						if (
							...
							var r = a.segpts.length / 2,
								i = r - 2;
							(a.midX = (a.segpts[i] + a.segpts[r]) / 2),
								(a.midY = (a.segpts[i + 1] + a.segpts[r + 1]) / 2);
						} else {
				...
				(Uc.checkForInvalidEdgeWarning = function (e) {
					...
					a.nodesOverlap ||
					(w(a.startX) && w(a.startY) && w(a.endX) && w(a.endY))
						? (a.loggedErr = !1)
						: a.loggedErr ||
						  ((a.loggedErr = !0),
						  ue(
							...
							var t = this,
								...
								r = {
									...
									set: function (e, a) {
										...
										null == t && ((t = new be()), this.map.set(e[0], t)),
											t.set(e[1], a);
									},
								},
								i = [],
							...
							if (!s.removed() && s.takesUpSpace())
								if ("haystack" !== d) {
									var u =
										...
										y = r.get(p);
									null == y && ((y = { eles: [] }), r.set(p, y), i.push(p)),
										y.eles.push(s),
										u && (y.hasUnbundled = !0),
										h && (y.hasBezier = !0);
								} else c.push(s);
									...
									for (var C = 0; C < o.eles.length; C++) {
										...
										if (
											...
											var T = S.intersectLine(g.x, g.y, y, f, p.x, p.y, 0),
												...
												A = (o.posPts = { x1: g.x, x2: p.x, y1: g.y, y2: p.y }),
												R = P[1] - T[1],
												E = P[0] - T[0],
												G = Math.sqrt(E * E + R * R),
												V = (o.vector = { x: E, y: R }),
												F = (o.vectorNorm = { x: V.x / G, y: V.y / G }),
												L = { x: -F.y, y: F.x };
											(o.nodesOverlap =
												!w(G) ||
												b.checkPoint(T[0], T[1], 0, v, _, p.x, p.y) ||
												S.checkPoint(P[0], P[1], 0, y, f, g.x, g.y)),
												(o.vectorNormInverse = L),
												(s = {
													...
													srcShape: b,
													tgtShape: S,
													posPts: { x1: A.x2, y1: A.y2, x2: A.x1, y2: A.y1 },
													intersectionPts: {
														x1: k.x2,
														y1: k.y2,
														x2: k.x1,
													...
													vector: { x: -V.x, y: -V.y },
													vectorNorm: { x: -F.x, y: -F.y },
													vectorNormInverse: { x: -L.x, y: -L.y },
												});
										}
										var z = I ? s : o;
										(B.nodesOverlap = z.nodesOverlap),
											(B.srcIntn = z.srcIntn),
											(B.tgtIntn = z.tgtIntn),
											n &&
											(u.isParent() ||
											...
											(u.parents().anySame(h) ||
												h.parents().anySame(u) ||
												(u.same(h) && u.isParent()))
												? a.findCompoundLoopPoints(N, z, C, x)
												: u === h
												? a.findLoopPoints(N, z, C, x)
												: "segments" === D
												? a.findSegmentsPoints(N, z)
												: "taxi" === D
												? a.findTaxiPoints(N, z)
												: "straight" === D ||
												  (!x &&
														o.eles.length % 2 == 1 &&
														C === Math.floor(o.eles.length / 2))
												? a.findStraightEdgePoints(N)
												: a.findBezierPoints(N, z, C, x, I),
											a.findEndpoints(N),
											a.tryToCorrectInvalidPoints(N, z),
											a.checkForInvalidEdgeWarning(N),
											a.storeAllpts(N),
											a.storeEdgeProjections(N),
											a.calculateArrowAngles(N),
											a.recalculateEdgeLabelProjections(N),
											a.calculateLabelAngles(N);
									}
								},
								v = 0;
							v < i.length;
				...
				(Uc.getSegmentPoints = function (e) {
					var a = e[0]._private.rscratch;
					if ("segments" === a.edgeType)
						return this.recalculateRenderedStyle(e), Pc(a.segpts);
				}),
				(Uc.getControlPoints = function (e) {
					...
					if (
						...
						return this.recalculateRenderedStyle(e), Pc(a.ctrlpts);
				}),
				(Uc.getEdgeMidpoint = function (e) {
					var a = e[0]._private.rscratch;
					return this.recalculateRenderedStyle(e), { x: a.midX, y: a.midY };
				});
			var Mc = {
					...
					findEndpoints: function (e) {
						...
						if (((y.srcManEndpt = D), (y.tgtManEndpt = I), _)) {
							...
							(t = S
								? [
										y.ctrlpts[y.ctrlpts.length - 2],
										y.ctrlpts[y.ctrlpts.length - 1],
								  ]
								: U),
								(n = U);
						} else if (b) {
							var P = C ? y.segpts.slice(0, 2) : [d.x, d.y];
							(t = C ? y.segpts.slice(y.segpts.length - 2) : [l.x, l.y]),
								(n = P);
						}
						if ("inside-to-node" === T) a = [d.x, d.y];
							...
							("outside-to-node" === T || "outside-to-node-or-label" === T
								? (r = t)
								: ("outside-to-line" !== T &&
										"outside-to-line-or-label" !== T) ||
								  (r = [l.x, l.y]),
							(a = c.nodeShapes[this.getNodeShape(s)].intersectLine(
								d.x,
								d.y,
								s.outerWidth(),
								s.outerHeight(),
							...
							var F = c.nodeShapes.rectangle.intersectLine(
									R,
									E,
									k,
									A,
						...
						if (
							...
							("outside-to-node" === x || "outside-to-node-or-label" === x
								? (i = n)
								: ("outside-to-line" !== x &&
										"outside-to-line-or-label" !== x) ||
								  (i = [d.x, d.y]),
							(a = c.nodeShapes[this.getNodeShape(o)].intersectLine(
								l.x,
								l.y,
								o.outerWidth(),
								o.outerHeight(),
							...
							var X = c.nodeShapes.rectangle.intersectLine(
									q,
									Z,
									H,
									Q,
						...
						(y.startX = ae[0]),
							...
							(y.arrowStartY = ee[1]),
							N &&
								(w(y.startX) && w(y.startY) && w(y.endX) && w(y.endY)
									? (y.badLine = !1)
									: (y.badLine = !0));
					},
					getSourceEndpoint: function (e) {
						...
						switch ((this.recalculateRenderedStyle(e), a.edgeType)) {
							case "haystack":
								return { x: a.haystackPts[0], y: a.haystackPts[1] };
							default:
								return { x: a.arrowStartX, y: a.arrowStartY };
						}
					},
					getTargetEndpoint: function (e) {
						...
						switch ((this.recalculateRenderedStyle(e), a.edgeType)) {
							case "haystack":
								return { x: a.haystackPts[2], y: a.haystackPts[3] };
							default:
								return { x: a.arrowEndX, y: a.arrowEndY };
						}
					},
				},
				kc = {};
			function Ac(e, a, t) {
				for (
					var n = function (e, a, t, n) {
							return Ye(e, a, t, n);
						},
						r = a._private.rstyle.bezierPts,
						i = 0;
					i < e.bezierProjPcts.length;
					i++
				) {
					var c = e.bezierProjPcts[i];
					r.push({ x: n(t[0], t[2], t[4], c), y: n(t[1], t[3], t[5], c) });
				}
			}
			(kc.storeEdgeProjections = function (e) {
				var a = e._private,
					...
					n = t.edgeType;
				if (
					((a.rstyle.bezierPts = null),
					(a.rstyle.linePts = null),
					(a.rstyle.haystackPts = null),
					"multibezier" === n ||
						"bezier" === n ||
						"self" === n ||
						"compound" === n)
					...
					a.rstyle.bezierPts = [];
					for (var r = 0; r + 5 < t.allpts.length; r += 4)
						Ac(this, e, t.allpts.slice(r, r + 6));
				} else if ("segments" === n) {
					var i = (a.rstyle.linePts = []);
					for (r = 0; r + 1 < t.allpts.length; r += 2)
						i.push({ x: t.allpts[r], y: t.allpts[r + 1] });
				} else if ("haystack" === n) {
					var c = t.haystackPts;
			...
			(Rc.recalculateEdgeLabelProjections = function (e) {
						...
						if (i[o]) {
							...
							switch (n.edgeType) {
								...
								case "multibezier":
										...
										var u,
											h = (function e() {
												...
												for (
													...
													var c = { x: n.allpts[i], y: n.allpts[i + 1] },
														o = { x: n.allpts[i + 2], y: n.allpts[i + 3] },
														s = { x: n.allpts[i + 4], y: n.allpts[i + 5] };
													a.push({
														p0: c,
														p1: o,
														p2: s,
												...
												for (var h = 0; h < a.length; h++) {
													var m = a[h],
														g = a[h - 1];
													g && (m.startDist = g.startDist + g.length),
														u(m, m.p0, l[h * d], 0, r.bezierProjPcts[0]);
													for (var p = 0; p < d - 1; p++)
														u(
															m,
															l[h * d + p],
															l[h * d + p + 1],
															r.bezierProjPcts[p],
															r.bezierProjPcts[p + 1]
														);
													u(
														m,
														l[h * d + d - 1],
														m.p2,
														r.bezierProjPcts[d - 1],
														1
													);
												}
												return (e.cache = a);
									...
									(N = Je(0, N, 1)),
										(a = Xe(S.p0, S.p1, S.p2, N)),
										(s = (function (e, a, t, n) {
											var r = Je(0, n - 0.001, 1),
												i = Je(0, n + 0.001, 1),
												c = Xe(e, a, t, r),
												o = Xe(e, a, t, i);
											return Gc(c, o);
								...
								case "haystack":
									for (
										var B, D, x, I, T = 0, U = n.allpts.length, P = 0;
										P + 3 < U &&
										(l
											? ((x = { x: n.allpts[P], y: n.allpts[P + 1] }),
											  (I = { x: n.allpts[P + 2], y: n.allpts[P + 3] }))
											: ((x = {
													x: n.allpts[U - 2 - P],
													y: n.allpts[U - 1 - P],
											  }),
				...
				(Rc.applyPrefixedLabelDimensions = function (e, a) {
					...
					Se(t.rstyle, "labelWidth", a, u),
						Se(t.rscratch, "labelWidth", a, u),
						Se(t.rstyle, "labelHeight", a, h),
						Se(t.rscratch, "labelHeight", a, h),
						Se(t.rscratch, "labelLineHeight", a, d);
				}),
				(Rc.getLabelText = function (e, a) {
					...
					"none" == i ||
						("uppercase" == i
							? (r = r.toUpperCase())
							: "lowercase" == i && (r = r.toLowerCase()));
					var o = e.pstyle("text-wrap").value;
					if ("wrap" === o) {
						var s = c("labelKey");
						if (null != s && c("labelWrapKey") === s)
							return c("labelWrapCachedText");
						for (
							var l = r.split("\n"),
								d = e.pstyle("text-max-width").pfValue,
								u = "anywhere" === e.pstyle("text-overflow-wrap").value,
								h = [],
								m = /[\s\u200b]+/,
								g = u ? "" : " ",
								p = 0;
							...
							if (f > d) {
								for (var _ = y.split(m), S = "", b = 0; b < _.length; b++) {
									...
									this.calculateLabelDimensions(e, C).width <= d
										? (S += w + g)
										: (S && h.push(S), (S = w + g));
								}
								S.match(/^[\s\u200b]+$/) || h.push(S);
						...
						c("labelWrapCachedLines", h),
							(r = c("labelWrapCachedText", h.join("\n"))),
							c("labelWrapKey", s);
					} else if ("ellipsis" === o) {
						for (
							var N = e.pstyle("text-max-width").pfValue, B = "", D = !1, x = 0;
							x < r.length;
							x++
						) {
							if (this.calculateLabelDimensions(e, B + r[x] + "…").width > N)
								break;
				...
				(Rc.calculateLabelDimensions = function (e, a) {
					...
					var i = e.pstyle("font-style").strValue,
						...
						l = this.labelCalcDiv;
					l ||
						((l = this.labelCalcDiv = document.createElement("div")),
				...
				(Rc.calculateLabelAngles = function (e) {
					...
					(n.labelAngle = a.calculateLabelAngle(e)),
						t &&
							((n.sourceLabelAngle = a.calculateLabelAngle(e, "source")),
							(n.targetLabelAngle = a.calculateLabelAngle(e, "target")));
				});
			var Vc = {},
				Fc = !1;
			Vc.getNodeShape = function (e) {
				var a = e.pstyle("shape").value;
				if ("cutrectangle" === a && (e.width() < 28 || e.height() < 28))
					return (
						Fc ||
							(ue(
						...
						var r = function (r) {
							if (r) {
								for (var i = t.onUpdateEleCalcsFns, c = 0; c < a.length; c++) {
									...
									o.isNode() &&
										!s.cleanConnected &&
										(n(o.connectedEdges()), (s.cleanConnected = !0));
								}
								if (i)
						...
						if (!this.destroyed) {
							...
							for (var r = 0; r < e.length; r++) {
								...
								(a && i.clean) ||
									...
									("none" !== o.pstyle("display").value &&
										("nodes" === s.group ? n.push(o) : t.push(o),
										(i.clean = !0)));
							}
							for (r = 0; r < n.length; r++) {
								i = (s = (o = n[r])._private).rstyle;
								var c = o.position();
								this.recalculateNodeLabelProjection(o),
									(i.nodeX = c.x),
									(i.nodeY = c.y),
									(i.nodeW = o.pstyle("width").pfValue),
									(i.nodeH = o.pstyle("height").pfValue);
							}
							...
							for (r = 0; r < t.length; r++) {
								...
								var o,
									s,
									l = s.rscratch;
								(i.srcX = l.arrowStartX),
									(i.srcY = l.arrowStartY),
									(i.tgtX = l.arrowEndX),
									(i.tgtY = l.arrowEndY),
									(i.midX = l.midX),
									(i.midY = l.midY),
									(i.labelAngle = l.labelAngle),
									(i.sourceLabelAngle = l.sourceLabelAngle),
									(i.targetLabelAngle = l.targetLabelAngle);
							}
						}
					},
				},
				zc = {
					...
					getCachedZSortedEles: function (e) {
						if (e || !this.cachedZSortedEles) {
							...
							a.sort(Ir),
								(a.interactive = a.filter(function (e) {
									return e.interactive();
								})),
								(this.cachedZSortedEles = a),
			...
			var jc = {
					getCachedImage: function (e, a, t) {
						...
						if (r)
							return (
								r.image.complete || r.image.addEventListener("load", t), r.image
							);
			...
			(Oc.binder = function (e) {
				...
				var c = function (a, r, i) {
					...
					return (
						n &&
							...
							(c[2] = { capture: null != i && i, passive: !1, once: !1 }),
						t.bindings.push({ target: e, args: c }),
						(e.addEventListener || e.on).apply(e, c),
						this
					);
				};
				return { on: c, addEventListener: c, addListener: c, bind: c };
			}),
				...
				(Oc.load = function () {
					var e = this,
						...
						t = function (a, t, n, r) {
							...
							for (var i = 0; i < t.length; i++) {
								var c = t[i];
								a.emit({ originalEvent: n, type: c, position: r });
							}
						},
						n = function (e) {
							...
							t.inDragLayer &&
								...
								(function (e, a) {
									if (
										...
										(null != a.inDragLayer || null != a.addToList)
									) {
										var t = e.descendants();
										a.inDragLayer &&
											(t.forEach(c), t.connectedEdges().forEach(c)),
											a.addToList && a.addToList.unmerge(t);
									}
								})(a, t),
								h(a, { inDragLayer: t.inDragLayer }),
							...
							if (
								...
								if (!t.same(e)) {
									var n = t
										...
										r = n.connectedEdges();
									a.inDragLayer && (r.forEach(c), n.forEach(c)),
										a.addToList &&
											n.forEach(function (e) {
												s(e, a);
											});
					...
					g
						? ((e.removeObserver = new MutationObserver(function (a) {
								for (var t = 0; t < a.length; t++) {
					...
					g &&
						((e.styleObserver = new MutationObserver(y)),
						e.styleObserver.observe(e.container, { attributes: !0 })),
						e.registerBinding(window, "resize", y),
						p &&
							((e.resizeObserver = new ResizeObserver(y)),
					...
					!(function (e, a) {
						...
						e.registerBinding(a, "transitionend", f),
							e.registerBinding(a, "animationend", f),
							e.registerBinding(a, "scroll", f);
					}),
					...
					var v = function (a) {
						for (
							var t = e.findContainerClientCoords(),
								n = t[0],
								r = t[1],
								i = t[2],
								c = t[3],
								o = a.touches ? a.touches : [a],
								s = !1,
								l = 0;
							l < o.length;
							l++
						...
						function (a) {
							if (v(a)) {
								...
								if (3 == a.which) {
									...
									u
										? (u.activate(), u.emit(g), (e.hoverData.down = u))
										: n.emit(g),
									...
									if ((u && u.activate(), null != u && e.nodeIsGrabbable(u))) {
										...
										if ((o(u), u.selected())) {
											...
											var y = n.$(function (a) {
												return (
													a.isNode() && a.selected() && e.nodeIsGrabbable(a)
												);
											});
											l(y, { addToList: h }),
												u.emit(p("grabon")),
									...
									(e.hoverData.down = u),
										(e.hoverData.downs = s),
										(e.hoverData.downTime = new Date().getTime()),
										t(u, ["mousedown", "tapstart", "vmousedown"], a, {
											x: i[0],
											y: i[1],
										}),
										null == u
							...
							function (a) {
								if (e.hoverData.capture || v(a)) {
									...
									e.hoverData.draggingEles ||
										...
										(p = e.findNearestElement(d[0], d[1], !0, !1));
									var y,
										f = e.hoverData.last,
										_ = e.hoverData.down,
										S = [d[0] - g[2], d[1] - g[3]],
									...
									(r = !0),
										t(p, ["mousemove", "vmousemove", "tapdrag"], a, {
											x: d[0],
											y: d[1],
										});
									var I = function () {
									...
									if (3 === e.hoverData.which) {
										if (y) {
											...
											_ ? _.emit(T) : c.emit(T),
												...
												(e.hoverData.cxtOver && p === e.hoverData.cxtOver) ||
													(e.hoverData.cxtOver &&
										...
										if (
											((r = !0), c.panningEnabled() && c.userPanningEnabled())
										) {
											var U;
											if (e.hoverData.justStartedPan) {
												var P = e.hoverData.mdownPos;
												(U = { x: (d[0] - P[0]) * o, y: (d[1] - P[1]) * o }),
													(e.hoverData.justStartedPan = !1);
											} else U = { x: S[0] * o, y: S[1] * o };
										...
										if (
											...
											(_ && _.grabbed()) ||
												p == f ||
												(f &&
													t(f, ["mouseout", "tapdragout"], a, {
														x: d[0],
														y: d[1],
													}),
												p &&
													t(p, ["mouseover", "tapdragover"], a, {
														x: d[0],
														y: d[1],
													}),
												(e.hoverData.last = p)),
											...
											if (y) {
												if (c.boxSelectionEnabled() && x)
													_ &&
														...
														b.emit("free"),
														e.dragData.didDrag &&
															(_.emit("dragfreeon"), b.emit("dragfree"))),
														I();
												else if (_ && _.grabbed() && e.nodeIsDraggable(_)) {
													var M = !e.dragData.didDrag;
													M && e.redrawHint("eles", !0),
														(e.dragData.didDrag = !0);
													var k = c.collection();
													e.hoverData.draggingEles || l(b, { inDragLayer: !0 });
													var A = { x: 0, y: 0 };
													if (
														w(S[0]) &&
														w(S[1]) &&
													...
													(e.hoverData.draggingEles = !0),
														k.silentShift(A).emit("position drag"),
														e.redrawHint("drag", !0),
														e.redraw();
												}
											} else
										...
										if (
											e.hoverData.dragging ||
											!c.boxSelectionEnabled() ||
											(!x && c.panningEnabled() && c.userPanningEnabled())
										) {
											if (
												!e.hoverData.selecting &&
												c.panningEnabled() &&
												c.userPanningEnabled()
											) {
												i(_, e.hoverData.downs) &&
													((e.hoverData.dragging = !0),
													(e.hoverData.justStartedPan = !0),
													(g[4] = 0),
													(e.data.bgActivePosistion = je(h)),
													e.redrawHint("select", !0),
													e.redraw());
											}
										} else I();
									...
									if (
										...
										if (
											...
											null != d ||
												...
												e.hoverData.dragged ||
												n(r) ||
												(i.$(a).unselect(["tapunselect"]),
												l.length > 0 && e.redrawHint("eles", !0),
												(e.dragData.possibleDragElements = l = i.collection())),
											s != d ||
												e.dragData.didDrag ||
												e.hoverData.selecting ||
												(null != s &&
													...
													(e.hoverData.dragging ||
														("additive" === i.selectionType() || h
															? s.selected()
																? s.unselect(["tapunselect"])
																: s.select(["tapselect"])
															: h ||
															  (i.$(a).unmerge(s).unselect(["tapunselect"]),
															  s.select(["tapselect"]))),
													e.redrawHint("eles", !0))),
											e.hoverData.selecting)
										) {
										...
										if (
											...
											u(l),
												f &&
													...
													l.emit("free"),
													e.dragData.didDrag &&
														(d.emit("dragfreeon"), l.emit("dragfree")));
										}
									}
									(o[4] = 0),
					...
					if (
								...
								if (v(a)) {
									...
									if (a.touches[1]) {
										(e.touchData.singleTouchMoved = !0),
											u(e.dragData.touchDragEles);
										var s = e.findContainerClientCoords();
										(I = s[0]),
											(T = s[1]),
											(U = s[2]),
											(P = s[3]),
											(_ = a.touches[0].clientX - I),
											(S = a.touches[0].clientY - T),
											(b = a.touches[1].clientX - I),
											(C = a.touches[1].clientY - T),
											(M =
												0 <= _ &&
												_ <= U &&
												0 <= b &&
									...
									if (a.touches[2])
										n.boxSelectionEnabled() && a.preventDefault();
									else if (a.touches[1]);
									else if (a.touches[0]) {
										...
										t(w, ["touchstart", "tapstart", "vmousedown"], a, {
											...
											null == w &&
												((e.data.bgActivePosistion = { x: c[0], y: c[1] }),
												e.redrawHint("select", !0),
												e.redraw()),
									...
									if (a.touches.length >= 1) {
										for (
											var E = (e.touchData.startPosition = []), F = 0;
											F < r.length;
											F++
										)
											E[F] = i[F] = r[F];
						...
						e.registerBinding(
							...
							(A = function (a) {
								...
								if (n || v(a)) {
									...
									var m,
										g = e.touchData.startGPosition;
									if (n && a.touches[0] && g) {
										for (var p = [], y = 0; y < o.length; y++)
											p[y] = o[y] - s[y];
									...
									if (n && e.touchData.cxt) {
										...
										if (E / B >= 2.25 || E >= 22500) {
											...
											e.touchData.start
												? (e.touchData.start.unactivate().emit(F),
									...
									if (n && e.touchData.cxt) {
										...
										(e.data.bgActivePosistion = void 0),
											e.redrawHint("select", !0),
											e.touchData.start ? e.touchData.start.emit(F) : c.emit(F),
											e.touchData.start &&
												(e.touchData.start._private.grabbed = !1),
											(e.touchData.cxtDragged = !0);
										var L = e.findNearestElement(o[0], o[1], !0, !0);
										(e.touchData.cxtOver && L === e.touchData.cxtOver) ||
											(e.touchData.cxtOver &&
									...
									} else if (n && a.touches[2] && c.boxSelectionEnabled())
										a.preventDefault(),
											(e.data.bgActivePosistion = void 0),
										...
										if (M) {
											...
											if (j && j.active()) {
												...
												u(ee),
													...
													ee.emit("free"),
													e.dragData.didDrag &&
														(j.emit("dragfreeon"), ee.emit("dragfree"));
											}
											c.viewport({ zoom: K, pan: $, cancelOnFailedZoom: !0 }),
												(N = O),
												(_ = P),
												(S = k),
												(b = A),
										...
										if (
											(e.hoverData.draggingEles ||
												e.swipePanning ||
												(L = e.findNearestElement(o[0], o[1], !0, !0)),
											n && null != ae && a.preventDefault(),
											n && null != ae && e.nodeIsDraggable(ae))
										)
											if (m) {
												ee = e.dragData.touchDragEles;
												var ne = !e.dragData.didDrag;
												ne && l(ee, { inDragLayer: !0 }),
													(e.dragData.didDrag = !0);
												var re = { x: 0, y: 0 };
												if (w(p[0]) && w(p[1]))
													if (((re.x += p[0]), (re.y += p[1]), ne))
														e.redrawHint("eles", !0),
															(ie = e.touchData.dragDelta) &&
																...
																((re.x += ie[0]), (re.y += ie[1]));
												(e.hoverData.draggingEles = !0),
													ee.silentShift(re).emit("position drag"),
													e.redrawHint("drag", !0),
													e.touchData.startPosition[0] == s[0] &&
														e.touchData.startPosition[1] == s[1] &&
														e.redrawHint("eles", !0),
													e.redraw();
											} else {
												var ie;
												...
												(ie = e.touchData.dragDelta =
													...
													? (ie.push(p[0]), ie.push(p[1]))
													: ((ie[0] += p[0]), (ie[1] += p[1]));
											}
										if (
											(t(ae || L, ["touchmove", "tapdrag", "vmousemove"], a, {
												x: o[0],
												y: o[1],
											}),
											(ae && ae.grabbed()) ||
										...
										if (
											...
											i(ae, e.touchData.starts) &&
												(a.preventDefault(),
												e.data.bgActivePosistion ||
													(e.data.bgActivePosistion = je(
														e.touchData.startPosition
													)),
												e.swipePanning
													? c.panBy({ x: p[0] * d, y: p[1] * d })
													: m &&
													  ((e.swipePanning = !0),
													  c.panBy({ x: f * d, y: U * d }),
													  ae &&
						...
						e.registerBinding(
							...
							(E = function (n) {
								...
								if (e.touchData.capture) {
									0 === n.touches.length && (e.touchData.capture = !1),
										n.preventDefault();
									var i = e.selection;
									...
									if (
										...
										g
											...
											.select()
											.emit("boxselect"),
											g.nonempty() && e.redrawHint("eles", !0),
											e.redraw();
									}
									if ((null != r && r.unactivate(), n.touches[2]))
										...
										if (null != r) {
											...
											u(p),
												...
												y &&
													...
													p.emit("free"),
													e.dragData.didDrag &&
														(r.emit("dragfreeon"), p.emit("dragfree"))),
												t(
													r,
										...
										e.touchData.singleTouchMoved ||
											(r || o.$(":selected").unselect(["tapunselect"]),
											t(r, ["tap", "vclick"], n, { x: l[0], y: l[1] })),
											null != r &&
												!e.dragData.didDrag &&
												r._private.selectable &&
												b < e.touchTapThreshold2 &&
												!e.pinching &&
												("single" === o.selectionType()
													? (o.$(a).unmerge(r).unselect(["tapunselect"]),
													  r.select(["tapselect"]))
													: r.selected()
													? r.unselect(["tapunselect"])
													: r.select(["tapselect"]),
												e.redrawHint("eles", !0)),
											(e.touchData.singleTouchMoved = !0);
									}
						...
						var F = [],
							...
							z = function (e) {
								F.push(
									(function (e) {
										return { event: e, touch: L(e) };
									})(e)
								);
							},
							W = function (e) {
								for (var a = 0; a < F.length; a++) {
									if (F[a].event.pointerId === e.pointerId)
										return void F.splice(a, 1);
								}
							},
							j = function (e) {
			...
			(Hc.generateEllipse = function () {
							...
							return (function (e, a, t, n, r, i, c, o) {
								for (
									...
									var f = n + u * t[4 * g],
										...
										N = v + S * t[p + 1];
									0 === g
										? ((d[t.length - 2] = b), (d[t.length - 1] = w))
										: ((d[4 * g - 2] = b), (d[4 * g - 1] = w)),
										(d[4 * g] = C),
										(d[4 * g + 1] = N);
									var B = t[y + 1],
										D = -t[y];
									B * t[p] + D * t[p + 1] < 0 && ((B *= -1), (D *= -1)),
										0 !==
											(s = va(e, a, n, r, b + B * m, w + D * m, m)).length &&
											l.push(s[0], s[1]);
								}
								for (var x = 0; x < d.length / 4; x++)
									0 !==
										(s = Sa(
											e,
											a,
											...
											d[4 * x + 3],
											!1
										)).length && l.push(s[0], s[1]);
								if (l.length > 2) {
									for (
										var I = [l[0], l[1]],
											T = Math.pow(I[0] - e, 2) + Math.pow(I[1] - a, 2),
											U = 1;
										U < l.length / 2;
										U++
									) {
										var P =
											Math.pow(l[2 * U] - e, 2) + Math.pow(l[2 * U + 1] - a, 2);
										P <= T &&
											((I[0] = l[2 * U]), (I[1] = l[2 * U + 1]), (T = P));
									}
									return I;
								}
								return l;
						...
						this.nodeShapes.roundrectangle =
							{
								...
								checkPoint: function (e, a, t, n, r, i, c) {
									var o = Da(n, r),
										s = 2 * o;
									return (
										!!ga(e, a, this.points, i, c, n, r - s, [0, -1], t) ||
										!!ga(e, a, this.points, i, c, n - s, r, [0, -1], t) ||
										!!fa(e, a, s, s, i - n / 2 + o, c - r / 2 + o, t) ||
										!!fa(e, a, s, s, i + n / 2 - o, c - r / 2 + o, t) ||
										!!fa(e, a, s, s, i + n / 2 - o, c + r / 2 - o, t) ||
										!!fa(e, a, s, s, i - n / 2 + o, c + r / 2 - o, t)
									);
						...
						this.nodeShapes.cutrectangle =
							{
								...
								intersectLine: function (e, a, t, n, r, i, c) {
									var o = this.generateCutTrianglePts(
											t + 2 * c,
											n + 2 * c,
											e,
											a
										...
										s = [].concat.apply(
											[],
											[
												o.topLeft.splice(0, 4),
												o.topRight.splice(0, 4),
												o.bottomRight.splice(0, 4),
												o.bottomLeft.splice(0, 4),
											]
										);
									return ba(r, i, s, e, a);
								},
					...
					return (this.nodeShapes.barrel = {
						...
						checkPoint: function (e, a, t, n, r, i, c) {
							var o = Ia(n, r),
								s = o.heightOffset,
								l = o.widthOffset;
							if (ga(e, a, this.points, i, c, n, r - 2 * s, [0, -1], t))
								return !0;
							if (ga(e, a, this.points, i, c, n - 2 * l, r, [0, -1], t))
								return !0;
							for (
								var d = this.generateBarrelBezierPts(n, r, i, c),
									u = function (e, a, t) {
										var n,
											r,
											i = t[4],
						...
						this.nodeShapes.bottomroundrectangle =
							{
								...
								checkPoint: function (e, a, t, n, r, i, c) {
									var o = Da(n, r),
										s = 2 * o;
									if (ga(e, a, this.points, i, c, n, r - s, [0, -1], t))
										return !0;
									if (ga(e, a, this.points, i, c, n - s, r, [0, -1], t))
										return !0;
									var l = n / 2 + 2 * t,
										d = r / 2 + 2 * t;
									return (
				...
				(Hc.registerNodeShapes = function () {
					...
					this.generateEllipse(),
						this.generatePolygon("triangle", Ca(3, 0)),
						this.generateRoundPolygon("round-triangle", Ca(3, 0)),
						this.generatePolygon("rectangle", Ca(4, 0)),
					...
					this.generatePolygon("diamond", t),
						...
						this.generatePolygon("pentagon", Ca(5, 0)),
						this.generateRoundPolygon("round-pentagon", Ca(5, 0)),
						this.generatePolygon("hexagon", Ca(6, 0)),
						this.generateRoundPolygon("round-hexagon", Ca(6, 0)),
						this.generatePolygon("heptagon", Ca(7, 0)),
						this.generateRoundPolygon("round-heptagon", Ca(7, 0)),
						this.generatePolygon("octagon", Ca(8, 0)),
						this.generateRoundPolygon("round-octagon", Ca(8, 0));
					var n = new Array(20),
						r = Ba(5, 0),
						i = Ba(5, Math.PI / 5),
						c = 0.5 * (3 - Math.sqrt(5));
					...
					this.generatePolygon("tag", s),
						this.generateRoundPolygon("round-tag", s),
			...
			var Qc = {
					...
					redraw: function (e) {
						e = e || pe();
						var a = this;
						void 0 === a.averageRedrawTime && (a.averageRedrawTime = 0),
							void 0 === a.lastRedrawTime && (a.lastRedrawTime = 0),
							void 0 === a.lastDrawTime && (a.lastDrawTime = 0),
							(a.requestedFrame = !0),
							(a.renderOptions = e);
					},
				...
				qc = function (e, a, t) {
					for (var n = e.beforeRenderCallbacks, r = 0; r < n.length; r++)
						n[r].fn(a, t);
				};
					...
					q(function t(n) {
						if (!e.destroyed) {
							if (a.batching());
								...
								void 0 === e.averageRedrawTime && (e.averageRedrawTime = i - r),
								...
								(e.redrawTotalTime += c),
									(e.lastRedrawTime = c),
									(e.averageRedrawTime = e.averageRedrawTime / 2 + c / 2),
									(e.requestedFrame = !1);
							} else qc(e, !1, n);
							(e.skipFrame = !1), q(t);
						}
			...
			(Kc.clientFunctions = [
				...
				(Kc.init = function (e) {
					...
					if (u) {
						...
						if (
							(t.className.indexOf(i) < 0 &&
								(t.className = (t.className || "") + " " + i),
							!c)
						) {
							var o = n.createElement("style");
							(o.id = "__________cytoscape_stylesheet"),
								(o.innerHTML = "." + i + " { position: relative; }"),
								r.insertBefore(o, r.children[0]);
						}
						"static" === u.getComputedStyle(t).getPropertyValue("position") &&
							ue(
								"A Cytoscape container has style position:static and so can not use UI extensions properly"
							);
					}
					(a.selection = [void 0, void 0, void 0, void 0, 0]),
						(a.bezierProjPcts = [0.05, 0.225, 0.4, 0.5, 0.6, 0.775, 0.95]),
						(a.hoverData = {
							down: null,
							last: null,
							downTime: null,
						...
						(a.dragData = { possibleDragElements: [] }),
						(a.touchData = {
							start: null,
							capture: !1,
						...
						(a.showFps = e.showFps),
						(a.debug = e.debug),
						(a.hideEdgesOnViewport = e.hideEdgesOnViewport),
						(a.textureOnViewport = e.textureOnViewport),
						(a.wheelSensitivity = e.wheelSensitivity),
						(a.motionBlurEnabled = e.motionBlur),
						(a.forcedPixelRatio = w(e.pixelRatio) ? e.pixelRatio : null),
						(a.motionBlur = e.motionBlur),
						(a.motionBlurOpacity = e.motionBlurOpacity),
						(a.motionBlurTransparency = 1 - a.motionBlurOpacity),
						(a.motionBlurPxRatio = 1),
						(a.mbPxRBlurry = 1),
						(a.minMbLowQualFrames = 4),
						(a.fullQualityMb = !1),
						(a.clearedForMotionBlur = []),
						(a.desktopTapThreshold = e.desktopTapThreshold),
						(a.desktopTapThreshold2 =
							e.desktopTapThreshold * e.desktopTapThreshold),
						(a.touchTapThreshold = e.touchTapThreshold),
						(a.touchTapThreshold2 = e.touchTapThreshold * e.touchTapThreshold),
						(a.tapholdDuration = 500),
						(a.bindings = []),
						(a.beforeRenderCallbacks = []),
						(a.beforeRenderPriorities = {
							animations: 400,
							eleCalcs: 300,
							eleTxrDeq: 200,
							lyrTxrDeq: 150,
						...
						a.registerNodeShapes(),
						a.registerArrowShapes(),
						a.registerCalculationListeners();
				}),
					...
					this.destroyed ||
						("init" !== e
							? "destroy" !== e
								? (("add" === e ||
										"remove" === e ||
										("move" === e && n.hasCompoundNodes()) ||
										"load" === e ||
										"zorder" === e ||
										"mount" === e) &&
										t.invalidateCachedZSortedEles(),
								  "viewport" === e && t.redrawHint("select", !0),
			...
			var Yc = function (e) {
					return function () {
						...
						if (!a.dequeueingSetup) {
							...
							t.beforeRender(function (r, i) {
								...
								l.length > 0 &&
									(e.onDeqd(a, l), !r && e.shouldRedraw(a, l, u, d) && n());
							}, i(a));
						}
					};
				},
					...
					function e(a) {
						var t =
							arguments.length > 1 && void 0 !== arguments[1]
								...
								: ce;
						o(this, e),
							(this.idsByKey = new be()),
							(this.keyForId = new be()),
							(this.cachesByLvl = new be()),
							(this.lvls = []),
							(this.getKey = a),
						...
						l(e, [
							...
							},
							{
								...
								value: function (e) {
									var a = e.id(),
										...
										n = this.getKey(e);
									this.deleteIdForKey(t, a),
										this.addIdForKey(n, a),
										this.keyForId.set(a, n);
								},
							},
							{
							...
							},
							{
								...
								value: function (e) {
									...
									return (
										n && this.invalidateKey(t),
										n || 0 === this.getNumberOfIdsForKey(t)
									);
								},
							},
						]),
				...
				eo = function (e, a) {
					...
					var t = $c(a);
					F(this, t),
						(this.lookup = new Xc(t.getKey, t.doesEleInvalidateKey)),
						this.setupDequeueing();
				},
				ao = eo.prototype;
			(ao.reasons = Jc),
				(ao.getTextureQueue = function (e) {
					return (
						(this.eleImgCaches = this.eleImgCaches || {}),
						(this.eleImgCaches[e] = this.eleImgCaches[e] || [])
					);
				}),
				...
				(ao.getElement = function (e, a, t, n, r) {
					...
					if (
						...
						return g;
					if (
						((m = d <= 25 ? 25 : d <= 50 ? 50 : 50 * Math.ceil(d / 50)),
						d > 1024 || u > 1024)
					)
						return null;
					...
					if (
						(y.context.setTransform(1, 0, 0, 1, 0, 0),
						y.context.clearRect(y.usedWidth, 0, u, m),
						_(B))
					)
						D();
					else if (_(v)) {
						if (!b) return i.queueElement(e, v.level - 1), v;
						for (var x = v.level; x > n; x--)
							B = i.getElement(e, a, t, x, Jc.downscale);
						D();
					} else {
						var I;
						if (!S && !b && !w)
						...
						y.context.translate(y.usedWidth, 0),
							y.context.scale(l, l),
							this.drawElement(y.context, e, a, h, !1),
							y.context.scale(1 / l, 1 / l),
							y.context.translate(-y.usedWidth, 0);
					}
					return (
						(g = {
						...
						(y.usedWidth += Math.ceil(u + 8)),
						y.eleCaches.push(g),
						s.set(e, n, g),
						i.checkTextureFullness(y),
						g
					);
				}),
					...
					if (a.isInvalid(e)) {
						...
						if (a.invalidate(e))
							for (var i = 0; i < t.length; i++) {
								var c = t[i],
									o = c.texture;
								(o.invalidatedWidth += c.width),
									(c.invalidated = !0),
									this.checkTextureUtility(o);
							}
				...
				(ao.addTexture = function (e, a) {
					var t = {};
					return (
						this.getTextureQueue(e).push(t),
						(t.eleCaches = []),
						(t.height = e),
						(t.width = Math.max(1024, a)),
						(t.usedWidth = 0),
						(t.invalidatedWidth = 0),
						(t.fullnessChecks = 0),
						(t.canvas = this.renderer.makeOffscreenCanvas(t.width, t.height)),
				...
				(ao.recycleTexture = function (e, a) {
					for (
						var t = this.getTextureQueue(e),
							n = this.getRetiredTextureQueue(e),
							r = 0;
						r < n.length;
						r++
					) {
				...
				(ao.queueElement = function (e, a) {
					var t = this.getElementQueue(),
						...
						i = n[r];
					if (i)
						(i.level = Math.max(i.level, a)),
							i.eles.merge(e),
							i.reqs++,
							t.updateItem(i);
					else {
						var c = { eles: e.spawn().merge(e), level: a, reqs: 1, key: r };
						t.push(c), (n[r] = c);
					}
				}),
				...
				(ao.removeFromQueue = function (e) {
					...
					null != r &&
						(1 === r.eles.length
							? ((r.reqs = re), a.updateItem(r), a.pop(), (t[n] = null))
							: r.eles.unmerge(e));
				}),
			...
			var to = function (e) {
					...
					(a.layersByLevel = {}),
						(a.firstGet = !0),
						(a.lastInvalidationTime = Z() - 500),
						(a.skipping = !1),
						(a.eleTxrDeqs = n.collection()),
						(a.scheduleElementRefinement = r(function () {
							a.refineElementTextures(a.eleTxrDeqs),
								a.eleTxrDeqs.unmerge(a.eleTxrDeqs);
						}, 50)),
						t.beforeRender(function (e, t) {
							t - a.lastInvalidationTime <= 250
								? (a.skipping = !0)
								: (a.skipping = !1);
			...
			(no.makeLayer = function (e, a) {
				...
				(no.getLayers = function (e, a, t) {
					...
					!(function () {
						var a = function (a) {
								if (
									(n.validateLayersElesOrdering(a, e), n.levelIsComplete(a, e))
								)
									return (o = s[a]), !0;
							},
							r = function (e) {
								if (!o) for (var n = t + e; -4 <= n && n <= 2 && !a(n); n += e);
							};
						r(1), r(-1);
					...
					for (
						var h = null, m = e.length / 1, g = !i, p = 0;
						p < e.length;
						p++
					) {
						var y = e[p],
						...
						if (_) h = _;
							...
							if (
								(!h || h.eles.length >= m || !oa(h.bb, y.boundingBox())) &&
								!(h = u({ insert: !0, after: h }))
							)
								return null;
							o || g ? n.queueLayer(h, y) : n.drawEleInLayer(h, y, t, a),
								h.eles.push(y),
								(v[t] = h);
						}
					}
				...
				(no.drawEleInLayer = function (e, a, t, n) {
					...
					0 !== c.w &&
						0 !== c.h &&
						a.visible() &&
						((t = this.getEleLevelForLayerLevel(t, n)),
						r.setImgSmoothing(i, !1),
						r.drawCachedElement(i, a, null, null, t, !0),
						r.setImgSmoothing(i, !0));
				}),
					...
					for (var t = B(e[0]), n = 0; n < e.length; n++)
						for (
							var r = t ? null : e[n],
								...
								o = (c.imgLayerCaches = c.imgLayerCaches || {}),
								s = -4;
							s <= 2;
							s++
						) {
							var l = o[s];
							l &&
								((r && this.getEleLevelForLayerLevel(l.level) !== r.level) ||
									a(l, i, r));
						}
				}),
				...
				(no.refineElementTextures = function (e) {
					...
					a.updateElementsInLayers(e, function (e, t, n) {
						...
						if (
							(r ||
								(((r = e.replacement = a.makeLayer(e.bb, e.level)).replaces =
									e),
								(r.eles = e.eles)),
							!r.reqs)
						)
							for (var i = 0; i < r.eles.length; i++)
								a.queueLayer(r, r.eles[i]);
					});
				}),
				...
				(no.dequeue = function (e) {
					for (
						...
						if (r.replacement) a.pop();
							...
							i && (this.drawEleInLayer(r, i, r.level, e), n++),
								0 === t.length && t.push(!0),
								0 === r.elesQueue.length &&
									(a.pop(),
									(r.reqs = 0),
									r.replaces && this.applyLayerReplacement(r),
									this.requestRedraw());
						}
					}
					return t;
			...
			var mo = {
					drawElement: function (e, a, t, n, r, i) {
						a.isNode()
							? this.drawNode(e, a, t, n, r, i)
							: this.drawEdge(e, a, t, n, r, i);
					},
					drawElementOverlay: function (e, a) {
						a.isNode()
							? this.drawNodeOverlay(e, a)
							: this.drawEdgeOverlay(e, a);
					},
							...
							if (null != d) {
								...
								if (0 !== v) {
									...
									(g = C.x),
										...
										e.translate(g, p),
										e.rotate(v),
										(y = s.getImgSmoothing(e)) || s.setImgSmoothing(e, !0);
									var N = t.getRotationOffset(a);
									(h = N.x), (m = N.y);
								} else (h = _), (m = S);
								1 !== u && ((f = e.globalAlpha), (e.globalAlpha = f * u)),
									e.drawImage(
										d.texture.canvas,
										d.x,
										0,
			...
			(mo.drawCachedElement = function (e, a, t, n, r, i) {
				...
				if (0 !== h.w && 0 !== h.h && a.visible() && (!n || ia(h, n))) {
					...
					c.drawCachedElementPortion(e, a, s, t, r, m, go, vo),
						(g && p) || c.drawCachedElementPortion(e, a, l, t, r, m, po, _o),
						g &&
							!p &&
							(c.drawCachedElementPortion(e, a, d, t, r, m, yo, _o),
							c.drawCachedElementPortion(e, a, u, t, r, m, fo, _o)),
						c.drawElementOverlay(e, a);
				}
			}),
				...
				(mo.drawLayeredElements = function (e, a, t, n) {
					...
					if (r)
						for (var i = 0; i < r.length; i++) {
							...
							0 !== o.w &&
								0 !== o.h &&
								e.drawImage(c.canvas, o.x1, o.y1, o.w, o.h);
						}
			...
			var So = {
						...
						if (
							...
							var l = i ? a.pstyle("opacity").value : 1,
								...
								m = function () {
									...
									(e.lineWidth = u),
										(e.lineCap = h),
										c.eleStrokeStyle(e, a, t),
										c.drawEdgePath(a, e, o.allpts, d),
										(e.lineCap = "butt");
								},
								g = function () {
							...
							if (0 !== t) {
								...
								(e.lineWidth = c),
									"self" !== i.edgeType || r
										? (e.lineCap = "round")
										: (e.lineCap = "butt"),
									n.colorStrokeStyle(e, o[0], o[1], o[2], t),
									n.drawEdgePath(a, e, i.allpts, "solid");
							}
						}
					},
					drawEdgePath: function (e, a, t, n) {
						...
						if (!o && !i.badLine)
							switch (
								(a.beginPath && a.beginPath(), a.moveTo(t[0], t[1]), i.edgeType)
							) {
								case "bezier":
								case "self":
								case "compound":
								case "multibezier":
									for (var h = 2; h + 3 < t.length; h += 4)
										a.quadraticCurveTo(t[h], t[h + 1], t[h + 2], t[h + 3]);
									break;
								case "straight":
								case "segments":
								case "haystack":
					...
					drawArrowhead: function (e, a, t, n, r, i, c) {
						if (
							...
							if ("none" !== o) {
								var s =
										"hollow" === a.pstyle(t + "-arrow-fill").value
											? "both"
											: "filled",
								...
								(1 === c && "hollow" !== l) ||
									...
									this.drawArrowShape(a, e, s, d, o, n, r, i),
									(e.globalCompositeOperation = h));
								var m = a.pstyle(t + "-arrow-color").value;
								this.colorFillStyle(e, m[0], m[1], m[2], c),
									this.colorStrokeStyle(e, m[0], m[1], m[2], c),
									this.drawArrowShape(a, e, l, d, o, n, r, i);
							}
						}
					},
					drawArrowShape: function (e, a, t, n, r, i, c, o) {
						...
						if (d) {
							...
							null != _
								? ((s = a = _), (u = !0))
								: ((s = a = new Path2D()), (f[v] = s));
						}
						a.beginPath && a.beginPath(),
							u ||
								(d
									? y.draw(a, 1, 0, { x: 0, y: 0 }, 1)
									: y.draw(a, p, o, m, n)),
							a.closePath && a.closePath(),
							(a = h),
							d && (a.translate(i, c), a.rotate(o), a.scale(p, p)),
							("filled" !== t && "both" !== t) || (d ? a.fill(s) : a.fill()),
							("hollow" !== t && "both" !== t) ||
								((a.lineWidth = (y.matchEdgeWidth ? n : 1) / (d ? p : 1)),
								(a.lineJoin = "miter"),
								d ? a.stroke(s) : a.stroke()),
							d && (a.scale(1 / p, 1 / p), a.rotate(-o), a.translate(-i, -c));
					},
				},
				bo = {
					...
					drawInscribedImage: function (e, a, t, n, r) {
						var i = this,
							...
							y =
								m +
								("inner" === d(t, "background-width-relative-to", "value", n)
									? 0
									: p),
							f =
								g +
								("inner" === d(t, "background-height-relative-to", "value", n)
									? 0
									: p),
						...
						(null != b && null != w) ||
							...
							(b = a.cachedW = a.width || a.offsetWidth),
							(w = a.cachedH = a.height || a.offsetHeight),
							document.body.removeChild(a));
						var C = b,
							N = w;
						if (
							("auto" !== d(t, "background-width", "value", n) &&
								(C =
									"%" === d(t, "background-width", "units", n)
										? d(t, "background-width", "pfValue", n) * y
										: d(t, "background-width", "pfValue", n)),
							"auto" !== d(t, "background-height", "value", n) &&
								(N =
									"%" === d(t, "background-height", "units", n)
										? d(t, "background-height", "pfValue", n) * f
										: d(t, "background-height", "pfValue", n)),
							0 !== C && 0 !== N)
						) {
							...
							(P += "%" === A ? (f - N) * R : R),
								v.pathCache && ((D -= o), (P -= s), (o = 0), (s = 0));
							var E = e.globalAlpha;
							if (((e.globalAlpha = S), "no-repeat" === h))
								_ &&
									(e.save(),
									v.pathCache
										? e.clip(v.pathCache)
										: (i.nodeShapes[i.getNodeShape(t)].draw(e, o, s, y, f),
										  e.clip())),
									i.safeDrawImage(e, a, 0, 0, b, w, D, P, C, N),
									_ && e.restore();
							else {
			...
			function Co(e, a, t, n, r) {
				...
				e.beginPath(),
					e.moveTo(a + i, t),
					e.lineTo(a + n - i, t),
					e.quadraticCurveTo(a + n, t, a + n, t + i),
					e.lineTo(a + n, t + r - i),
					e.quadraticCurveTo(a + n, t + r, a + n - i, t + r),
					e.lineTo(a + i, t + r),
					e.quadraticCurveTo(a, t + r, a, t + r - i),
					e.lineTo(a, t + i),
					e.quadraticCurveTo(a, t, a + i, t),
					e.closePath(),
					e.fill();
			}
			(wo.eleTextBiggerThanMin = function (e, a) {
				...
				(wo.drawElementText = function (e, a, t, n, r) {
					...
					if (a.isNode()) {
						...
						if (l || ((!d || !d.value) && (!u || !u.value) && (!h || !h.value)))
							return;
						(e.textAlign = "center"), (e.textBaseline = "bottom");
					}
					var m,
						g = !t;
					t && ((m = t), e.translate(-m.x1, -m.y1)),
						null == r
							? (c.drawText(e, a, null, g, i),
							  a.isEdge() &&
									(c.drawText(e, a, "source", g, i),
									c.drawText(e, a, "target", g, i)))
							: c.drawText(e, a, r, g, i),
						t && e.translate(m.x1, m.y1);
				}),
				(wo.getFontCache = function (e) {
					...
					return (a = { context: e }), this.fontCaches.push(a), a;
				}),
				(wo.setupTextStyle = function (e, a) {
					...
					(e.font = n + " " + c + " " + r + " " + i),
						(e.lineJoin = "round"),
						this.colorFillStyle(e, l[0], l[1], l[2], o),
						this.colorStrokeStyle(e, d[0], d[1], d[2], s);
				}),
			...
			var No = {
					drawNode: function (e, a, t) {
						...
						if (w(u.x) && w(u.y) && (!o || a.visible())) {
							...
							(n = a.width() + 2 * f),
								...
								t && ((m = t), e.translate(-m.x1, -m.y1));
							for (
								var v = a.pstyle("background-image"),
									_ = v.value,
								...
								if (D) {
									...
									C++,
										(b[N] = s.getCachedImage(B, x, function () {
											(l.backgroundTimestamp = Date.now()),
												a.emitAndNotify("background");
										}));
								}
							}
							...
							if (p) {
								...
								var V = (s.nodePathCache = s.nodePathCache || []),
									F = $(
										"polygon" === E ? E + "," + G.join(",") : E,
										"" + r,
										"" + n
									),
									L = V[F];
								null != L
									? ((h = L), (y = !0), (d.pathCache = h))
									: ((h = new Path2D()), (V[F] = d.pathCache = h));
							}
							var z = function () {
									if (!y) {
										var t = u;
										p && (t = { x: 0, y: 0 }),
											s.nodeShapes[s.getNodeShape(a)].draw(
												h || e,
												t.x,
												t.y,
												n,
								...
								W = function () {
									for (
										...
										S[i] &&
											b[i].complete &&
											!b[i].error &&
											(r++, s.drawInscribedImage(e, b[i], a, i, t));
									(l.backgrounding = !(r === C)),
										n !== l.backgrounding && a.updateStyle(!1);
								},
								j = function () {
									var t =
											arguments.length > 0 &&
								...
								O = function () {
									var a =
										...
										n = I > 0 ? 0 : 255;
									0 !== I &&
										(s.colorFillStyle(e, n, n, n, t), p ? e.fill(h) : e.fill());
								},
								H = function () {
									if (T > 0) {
										if (
											((e.lineWidth = T), (e.lineCap = "butt"), e.setLineDash)
										)
											switch (M) {
												case "dotted":
													e.setLineDash([1, 1]);
					...
					drawNodeOverlay: function (e, a, t, n, r) {
						if (a.visible()) {
							...
							if (c > 0) {
								...
								this.colorFillStyle(e, o[0], o[1], o[2], c),
					...
					drawPie: function (e, a, t, n) {
						...
						var r = a.cy().style(),
							...
							d = Math.min(s, l) / 2,
							u = 0;
						this.usePaths() && ((c = 0), (o = 0)),
							"%" === i.units
								? (d *= i.pfValue)
								: void 0 !== i.pfValue && (d = i.pfValue / 2);
						for (var h = 1; h <= r.pieBackgroundN; h++) {
							...
							0 === m ||
								...
								e.arc(c, o, d, f, v),
								e.closePath(),
								this.colorFillStyle(e, g[0], g[1], g[2], p),
								e.fill(),
								(u += y));
						}
					},
			...
			(Bo.getPixelRatio = function () {
				...
				(Bo.paintCache = function (e) {
					for (
						var a,
							t = (this.paintCaches = this.paintCaches || []),
							n = !0,
							r = 0;
						r < t.length;
						r++
					...
					return n && ((a = { context: e }), t.push(a)), a;
				}),
				(Bo.createGradientStyleFor = function (e, a, t, n, r) {
					...
					if (!i) return null;
					for (var w = s.length === o.length, C = o.length, N = 0; N < C; N++)
						i.addColorStop(
							w ? s[N] : N / (C - 1),
							"rgba(" + o[N][0] + "," + o[N][1] + "," + o[N][2] + "," + r + ")"
						);
					return i;
				}),
				...
				(Bo.eleFillStyle = function (e, a, t) {
					...
					if ("linear-gradient" === n || "radial-gradient" === n)
						this.gradientFillStyle(e, a, n, t);
					else {
				...
				(Bo.eleStrokeStyle = function (e, a, t) {
					...
					if ("linear-gradient" === n || "radial-gradient" === n)
						this.gradientStrokeStyle(e, a, n, t);
					else {
				...
				(Bo.matchCanvasSize = function (e) {
					...
					(e !== a.data.bufferCanvases[a.MOTIONBLUR_BUFFER_NODE] &&
						e !== a.data.bufferCanvases[a.MOTIONBLUR_BUFFER_DRAG]) ||
						(c = o);
					var s,
						l = r * c,
						d = i * c;
					if (l !== a.canvasWidth || d !== a.canvasHeight) {
						...
						for (var h = 0; h < a.CANVAS_LAYERS; h++)
							((s = t.canvases[h]).width = l),
								(s.height = d),
								(s.style.width = r + "px"),
								(s.style.height = i + "px");
						for (h = 0; h < a.BUFFER_COUNT; h++)
							((s = t.bufferCanvases[h]).width = l),
								(s.height = d),
								(s.style.width = r + "px"),
								(s.style.height = i + "px");
						(a.textureMult = 1),
							c <= 1 &&
								((s = t.bufferCanvases[a.TEXTURE_BUFFER]),
								(a.textureMult = 2),
								(s.width = l * a.textureMult),
								(s.height = d * a.textureMult)),
							(a.canvasWidth = l),
							(a.canvasHeight = d);
					}
				}),
				...
				(Bo.render = function (e) {
					...
					a ||
						(c.prevPxRatio !== o &&
							(c.invalidateContainerClientCoordsCache(),
							c.matchCanvasSize(c.container),
							c.redrawHint("eles", !0),
							c.redrawHint("drag", !0)),
						(c.prevPxRatio = o)),
						!a && c.motionBlurTimeout && clearTimeout(c.motionBlurTimeout),
						h &&
							(null == c.mbFrames && (c.mbFrames = 0),
							c.mbFrames++,
							c.mbFrames < 3 && (f = !1),
							c.mbFrames > c.minMbLowQualFrames &&
								(c.motionBlurPxRatio = c.mbPxRBlurry)),
						c.clearingMotionBlur && (c.motionBlurPxRatio = 1),
						c.textureDrawLastFrame &&
							!u &&
							((d[c.NODE] = !0), (d[c.SELECT_BOX] = !0));
					var v = s.style(),
						_ = s.zoom(),
						S = void 0 !== r ? r : _,
						b = s.pan(),
						w = { x: b.x, y: b.y },
						C = { zoom: _, pan: { x: b.x, y: b.y } },
						N = c.prevViewport;
					void 0 === N ||
						C.zoom !== N.zoom ||
						C.pan.x !== N.pan.x ||
					...
					function D(e, a, t, n, r) {
						...
						(e.globalCompositeOperation = "destination-out"),
							c.colorFillStyle(e, 255, 255, 255, c.motionBlurTransparency),
							e.fillRect(a, t, n, r),
							(e.globalCompositeOperation = i);
					}
					function x(e, n) {
						var o, s, d, u;
						c.clearingMotionBlur ||
						(e !== l.bufferContexts[c.MOTIONBLUR_BUFFER_NODE] &&
							e !== l.bufferContexts[c.MOTIONBLUR_BUFFER_DRAG])
							? ((o = w), (s = S), (d = c.canvasWidth), (u = c.canvasHeight))
							: ((o = { x: b.x * m, y: b.y * m }),
							  (s = _ * m),
							  (d = c.canvasWidth * m),
							  (u = c.canvasHeight * m)),
							...
							"motionBlur" === n
								? D(e, 0, 0, d, u)
								: a || (void 0 !== n && !n) || e.clearRect(0, 0, d, u),
							t || (e.translate(o.x, o.y), e.scale(s, s)),
					...
					if ((u || (c.textureDrawLastFrame = !1), u)) {
						if (((c.textureDrawLastFrame = !0), !c.textureCache)) {
							(c.textureCache = {}),
								(c.textureCache.bb = s.mutableElements().boundingBox()),
								(c.textureCache.texture =
									c.data.bufferCanvases[c.TEXTURE_BUFFER]);
							var I = c.data.bufferContexts[c.TEXTURE_BUFFER];
							I.setTransform(1, 0, 0, 1, 0, 0),
								I.clearRect(
									0,
									0,
									c.canvasWidth * c.textureMult,
									c.canvasHeight * c.textureMult
								),
								c.render({
									forcedContext: I,
									drawOnlyNodeLayer: !0,
					...
					var k = s.extent(),
						A =
							...
							c.swipePanning ||
							c.data.wheelZooming ||
							c.hoverData.draggingEles ||
							c.cy.animated(),
						R = c.hideEdgesOnViewport && A,
						E = [];
					if (
						((E[c.NODE] =
							(!d[c.NODE] && h && !c.clearedForMotionBlur[c.NODE]) ||
							c.clearingMotionBlur),
						E[c.NODE] && (c.clearedForMotionBlur[c.NODE] = !0),
						(E[c.DRAG] =
							(!d[c.DRAG] && h && !c.clearedForMotionBlur[c.DRAG]) ||
							c.clearingMotionBlur),
						E[c.DRAG] && (c.clearedForMotionBlur[c.DRAG] = !0),
						d[c.NODE] || t || n || E[c.NODE])
					) {
						...
						x(
							(T =
								a ||
								(G
									? c.data.bufferContexts[c.MOTIONBLUR_BUFFER_NODE]
									: l.contexts[c.NODE])),
							h && !G ? "motionBlur" : void 0
						),
							R
								? c.drawCachedNodes(T, B.nondrag, o, k)
								: c.drawLayeredElements(T, B.nondrag, o, k),
							c.debug && c.drawDebugPoints(T, B.nondrag),
							t || h || (d[c.NODE] = !1);
					}
					if (!n && (d[c.DRAG] || t || E[c.DRAG])) {
						...
						x(
							(T =
								a ||
								(G
									? c.data.bufferContexts[c.MOTIONBLUR_BUFFER_DRAG]
									: l.contexts[c.DRAG])),
							h && !G ? "motionBlur" : void 0
						),
							R
								? c.drawCachedNodes(T, B.drag, o, k)
								: c.drawCachedElements(T, B.drag, o, k),
							c.debug && c.drawDebugPoints(T, B.drag),
							t || h || (d[c.DRAG] = !1);
					}
					if (c.showFps || (!n && d[c.SELECT_BOX] && !t)) {
						if (
							(x((T = a || l.contexts[c.SELECT_BOX])),
							1 == c.selection[4] &&
								(c.hoverData.selecting || c.touchData.selecting))
						) {
							_ = c.cy.zoom();
							...
							(T.lineWidth = V),
								(T.fillStyle =
									"rgba(" +
									v.core("selection-box-color").value[0] +
									"," +
									v.core("selection-box-color").value[1] +
									"," +
									v.core("selection-box-color").value[2] +
									"," +
									v.core("selection-box-opacity").value +
									")"),
								T.fillRect(
									c.selection[0],
									c.selection[1],
									c.selection[2] - c.selection[0],
									c.selection[3] - c.selection[1]
								),
								V > 0 &&
									((T.strokeStyle =
										"rgba(" +
										v.core("selection-box-border-color").value[0] +
										"," +
										v.core("selection-box-border-color").value[1] +
										"," +
										v.core("selection-box-border-color").value[2] +
										"," +
										v.core("selection-box-opacity").value +
										")"),
									T.strokeRect(
						...
						if (l.bgActivePosistion && !c.hoverData.selecting) {
							...
							(T.fillStyle =
								"rgba(" +
								v.core("active-bg-color").value[0] +
								"," +
								v.core("active-bg-color").value[1] +
								"," +
								v.core("active-bg-color").value[2] +
								"," +
								v.core("active-bg-opacity").value +
								")"),
								T.beginPath(),
								T.arc(
									F.x,
									F.y,
									v.core("active-bg-size").pfValue / _,
									0,
									2 * Math.PI
								),
								T.fill();
						...
						if (c.showFps && L) {
							...
							T.setTransform(1, 0, 0, 1, 0, 0),
								(T.fillStyle = "rgba(255, 0, 0, 0.75)"),
								(T.strokeStyle = "rgba(255, 0, 0, 0.75)"),
								(T.lineWidth = 1),
								T.fillText("1 frame = " + L + " ms = " + z + " fps", 0, 20);
							T.strokeRect(0, 30, 250, 20),
								T.fillRect(0, 30, 250 * Math.min(z / 60, 1), 20);
						}
						t || (d[c.SELECT_BOX] = !1);
					}
					if (h && 1 !== m) {
						var W = l.contexts[c.NODE],
							...
							Q = function (e, a, t) {
								e.setTransform(1, 0, 0, 1, 0, 0),
									t || !f
										? e.clearRect(0, 0, c.canvasWidth, c.canvasHeight)
										: D(e, 0, 0, c.canvasWidth, c.canvasHeight);
								var n = m;
								e.drawImage(
									a,
									0,
						...
						(d[c.NODE] || E[c.NODE]) && (Q(W, j, E[c.NODE]), (d[c.NODE] = !1)),
							(d[c.DRAG] || E[c.DRAG]) &&
								(Q(O, H, E[c.DRAG]), (d[c.DRAG] = !1));
					}
					(c.prevViewport = C),
						c.clearingMotionBlur &&
							((c.clearingMotionBlur = !1),
							(c.motionBlurCleared = !0),
							(c.motionBlur = !0)),
						h &&
							(c.motionBlurTimeout = setTimeout(function () {
								(c.motionBlurTimeout = null),
									(c.clearedForMotionBlur[c.NODE] = !1),
									(c.clearedForMotionBlur[c.DRAG] = !1),
									(c.motionBlur = !1),
									(c.clearingMotionBlur = !u),
									(c.mbFrames = 0),
									(d[c.NODE] = !0),
									(d[c.DRAG] = !0),
									c.redraw();
			...
			for (
				var Do = {
						drawPolygonPath: function (e, a, t, n, r, i) {
							var c = n / 2,
								o = r / 2;
							e.beginPath && e.beginPath(),
								e.moveTo(a + c * i[0], t + o * i[1]);
							for (var s = 1; s < i.length / 2; s++)
								e.lineTo(a + c * i[2 * s], t + o * i[2 * s + 1]);
							e.closePath();
						},
						...
						drawRoundRectanglePath: function (e, a, t, n, r) {
							...
							e.beginPath && e.beginPath(),
								e.moveTo(a, t - c),
								e.arcTo(a + i, t - c, a + i, t, o),
								e.arcTo(a + i, t + c, a, t + c, o),
								e.arcTo(a - i, t + c, a - i, t, o),
								e.arcTo(a - i, t - c, a, t - c, o),
								e.lineTo(a, t - c),
								e.closePath();
						...
						drawBarrelPath: function (e, a, t, n, r) {
							...
							e.beginPath && e.beginPath(),
								e.moveTo(o, l + m),
								e.lineTo(o, d - m),
								e.quadraticCurveTo(o + g, d, o + h, d),
								e.lineTo(s - h, d),
								e.quadraticCurveTo(s - g, d, s, d - m),
								e.lineTo(s, l + m),
								e.quadraticCurveTo(s - g, l, s - h, l),
								e.lineTo(o + h, l),
								e.quadraticCurveTo(o + g, l, o, l + m),
								e.closePath();
						},
					},
					xo = Math.sin(0),
				...
				(To[Mo] = Math.sin(Mo)), (Uo[Mo] = Math.cos(Mo));
			Do.drawEllipsePath = function (e, a, t, n, r) {
				if ((e.beginPath && e.beginPath(), e.ellipse))
					e.ellipse(a, t, n / 2, r / 2, 0, 0, 2 * Math.PI);
				else
					for (
						var i, c, o = n / 2, s = r / 2, l = 0 * Math.PI;
						l < 2 * Math.PI;
						l += Po
					)
						(i = a - o * To[l] * xo + o * Uo[l] * Io),
							(c = t + s * Uo[l] * xo + s * To[l] * Io),
							0 === l ? e.moveTo(i, c) : e.lineTo(i, c);
				e.closePath();
			};
			var ko = {};
			function Ao(e) {
			...
			(ko.createBuffer = function (e, a) {
				...
				(ko.bufferCanvasImage = function (e) {
					...
					if (void 0 !== e.scale) (r *= e.scale), (i *= e.scale), (s = e.scale);
						...
						var l = 1 / 0,
							d = 1 / 0;
						w(e.maxWidth) && (l = (s * e.maxWidth) / r),
							w(e.maxHeight) && (d = (s * e.maxHeight) / i),
							(r *= s = Math.min(l, d)),
							(i *= s);
					}
					c || ((r *= o), (i *= o), (s *= o));
					...
					if (r > 0 && i > 0) {
						...
						if (e.full)
							h.translate(-t.x1 * s, -t.y1 * s),
								h.scale(s, s),
								this.drawElements(h, m),
								h.scale(1 / s, 1 / s),
								h.translate(t.x1 * s, t.y1 * s);
						else {
							var g = a.pan(),
			...
			function Fo(e) {
				...
				(a.data.canvasContainer.style["-webkit-tap-highlight-color"] =
					"rgba(0,0,0,0)"),
					(t.position = "relative"),
					(t.zIndex = "0"),
					(t.overflow = "hidden");
				var n = e.cy.container();
				n.appendChild(a.data.canvasContainer),
					(n.style["-webkit-tap-highlight-color"] = "rgba(0,0,0,0)");
				var r = {
				...
				for (var i = 0; i < Vo.CANVAS_LAYERS; i++) {
					...
					(a.data.contexts[i] = c.getContext("2d")),
						Object.keys(r).forEach(function (e) {
							c.style[e] = r[e];
						}),
						(c.style.position = "absolute"),
						c.setAttribute("data-id", "layer" + i),
						(c.style.zIndex = String(Vo.CANVAS_LAYERS - i)),
						a.data.canvasContainer.appendChild(c),
						(a.data.canvasNeedsRedraw[i] = !1);
				}
				(a.data.topCanvas = a.data.canvases[0]),
					a.data.canvases[Vo.NODE].setAttribute(
						"data-id",
						"layer" + Vo.NODE + "-node"
					),
					a.data.canvases[Vo.SELECT_BOX].setAttribute(
						"data-id",
						"layer" + Vo.SELECT_BOX + "-selectbox"
					),
					a.data.canvases[Vo.DRAG].setAttribute(
						"data-id",
						"layer" + Vo.DRAG + "-drag"
					);
				for (i = 0; i < Vo.BUFFER_COUNT; i++)
					(a.data.bufferCanvases[i] = document.createElement("canvas")),
						(a.data.bufferContexts[i] =
							a.data.bufferCanvases[i].getContext("2d")),
						(a.data.bufferCanvases[i].style.position = "absolute"),
						a.data.bufferCanvases[i].setAttribute("data-id", "buffer" + i),
						(a.data.bufferCanvases[i].style.zIndex = String(-i - 1)),
						(a.data.bufferCanvases[i].style.visibility = "hidden");
				a.pathsEnabled = !0;
				var o = $e(),
					s = function (e) {
					...
					y = (a.data.eleTxrCache = new eo(a, {
						...
						getRotationPoint: function (e) {
							return { x: ((a = l(e)).x1 + a.x2) / 2, y: (a.y1 + a.y2) / 2 };
							var a;
						},
				...
				a.onUpdateEleCalcs(function (e, a) {
					y.invalidateElements(a),
						f.invalidateElements(a),
						v.invalidateElements(a),
						_.invalidateElements(a),
						S.invalidateElements(a);
					for (var t = 0; t < a.length; t++) {
						var n = a[t]._private;
				...
				var b = function (e) {
					for (var a = 0; a < e.length; a++)
						S.enqueueElementRefinement(e[a].ele);
				};
			...
			(Vo.CANVAS_LAYERS = 3),
				...
				(Vo.BUFFER_COUNT = 3),
				(Vo.TEXTURE_BUFFER = 0),
				(Vo.MOTIONBLUR_BUFFER_NODE = 1),
				(Vo.MOTIONBLUR_BUFFER_DRAG = 2),
				(Vo.redrawHint = function (e, a) {
					var t = this;
					switch (e) {
						case "eles":
			...
			(Vo.path2dEnabled = function (e) {
				...
				(Vo.setImgSmoothing = function (e, a) {
					null != e.imageSmoothingEnabled
						? (e.imageSmoothingEnabled = a)
						: ((e.webkitImageSmoothingEnabled = a),
						  (e.mozImageSmoothingEnabled = a),
						  (e.msImageSmoothingEnabled = a));
				}),
				...
				(Vo.makeOffscreenCanvas = function (e, a) {
					...
					return (
						...
						("undefined" == typeof OffscreenCanvas
							? "undefined"
							: c(OffscreenCanvas))
							? (t = new OffscreenCanvas(e, a))
							: (((t = document.createElement("canvas")).width = e),
							  (t.height = a)),
						t
					);
				}),
			...
			function Oo(e, a, t) {
				...
				if ("core" === e) {
					...
					(c.stop = function () {
						...
						if (e && e.animate) {
							...
							if (a) for (var t = 0; t < a.length; t++) a[t].stop();
						}
				...
				return W({ map: Wo, keys: [e, a], value: n });
			}
			function Ho(e, a) {
				return j({ map: Wo, keys: [e, a] });
			}
			function Qo(e, a, t, n, r) {
				return W({ map: jo, keys: [e, a, t, n], value: r });
			}
			function qo(e, a, t, n) {
				return j({ map: jo, keys: [e, a, t, n] });
			}
			var Zo = function () {
				return 2 === arguments.length
					...
					: 5 === arguments.length
					? Qo.apply(null, arguments)
					: void le("Invalid extension access syntax");
			};
			(Gi.prototype.extension = Zo),
			...
			(Yo.instanceString = function () {
				...
				(Yo.css = function (e, a) {
					var t = this.length - 1;
					if (v(e)) this[t].properties.push({ name: e, value: a });
					else if (b(e))
						for (var n = e, r = Object.keys(n), i = 0; i < r.length; i++) {
							...
							if (null != o) {
								...
								if (null != s) {
									var l = s.name,
										d = o;
									this[t].properties.push({ name: l, value: d });
								}
							}
						}
					return this;
			...
			var Xo = function (e) {
				return (
					void 0 === e && (e = {}),
					b(e) ? new Gi(e) : v(e) ? Zo.apply(Zo, arguments) : void 0
				);
			};
			(Xo.use = function (e) {
				...
				(Xo.version = "3.12.1"),
				(Xo.stylesheet = Xo.Stylesheet = Ko),
				(e.exports = Xo);
				...
				if (!e.setImmediate) {
					...
					(h = h && h.setTimeout ? h : e),
						...
						(h.setImmediate = function (e) {
							...
							for (
								var a = new Array(arguments.length - 1), t = 0;
								t < a.length;
								t++
							)
								a[t] = arguments[t + 1];
							var r = { callback: e, args: a };
							return (l[s] = r), n(s), s++;
						}),
						(h.clearImmediate = m);
				}
	...
	129: function (e, a) {
		...
		function h() {
			d &&
				s &&
				((d = !1), s.length ? (l = s.concat(l)) : (u = -1), l.length && m());
		}
		function m() {
			if (!d) {
				var e = o(h);
		...
		(function () {
			...
			(o = Math.floor),
				...
				(m = function (e, a, t, n, r) {
					var i;
					if ((null == t && (t = 0), null == r && (r = c), t < 0))
						throw new Error("lo must be non-negative");
					for (null == n && (n = e.length); t < n; )
						r(a, e[(i = o((t + n) / 2))]) < 0 ? (n = i) : (t = i + 1);
				...
				(l = function (e, a) {
					...
					return (
						null == a && (a = c),
						(t = e.pop()),
						e.length ? ((n = e[0]), (e[0] = t), _(e, 0, a)) : (n = t),
						n
					);
				}),
				(h = function (e, a, t) {
				...
				(s = function (e, a) {
					...
					for (
						...
						(t = i[n]), s.push(_(e, t, a));
					return s;
				}),
				(f = function (e, a, t) {
					var n;
					if ((null == t && (t = c), -1 !== (n = e.indexOf(a))))
						return v(e, 0, n, t), _(e, n, t);
				}),
				(p = function (e, a, t) {
					var n, r, i, o, l;
					if ((null == t && (t = c), !(r = e.slice(0, a)).length)) return r;
					for (s(r, t), i = 0, o = (l = e.slice(a)).length; i < o; i++)
						(n = l[i]), u(r, n, t);
				...
				(y = function (e, a, t) {
					...
					if ((null == t && (t = c), 10 * a <= e.length)) {
						...
						for (
							r = i[i.length - 1], o = 0, u = (h = e.slice(a)).length;
							o < u;
							o++
						)
							t((n = h[o]), r) < 0 &&
								(m(i, n, 0, null, t), i.pop(), (r = i[i.length - 1]));
						return i;
					}
					for (
						s(e, t), y = [], d = 0, p = g(a, e.length);
						0 <= p ? d < p : d > p;
						0 <= p ? ++d : --d
					)
						y.push(l(e, t));
				...
				(_ = function (e, a, t) {
					var n, r, i, o, s;
					for (
						null == t && (t = c), r = e.length, s = a, i = e[a], n = 2 * a + 1;
						n < r;

					)
						(o = n + 1) < r && !(t(e[n], e[o]) < 0) && (n = o),
							(e[a] = e[n]),
							(n = 2 * (a = n) + 1);
	...
	319: function (e, a, t) {
		...
		function S(e) {
			((!e.__d && (e.__d = !0) && 1 === r.push(e)) ||
				c !== n.debounceRendering) &&
				((c = n.debounceRendering) || i)(b);
		}
		function b() {
			var e, a, t, n, i, c, o;
			for (
		...
		function w(e, a, t, n, r, i, c, o, s) {
			var u,
				...
				b = S.length;
			if (
				(o == l && (o = null != i ? i[0] : b ? v(t, 0) : null),
				(u = 0),
				(a.__k = C(a.__k, function (t) {
					if (null != t) {
						if (
							((t.__ = a),
							(t.__b = a.__b + 1),
							null === (g = S[u]) || (g && t.key == g.key && t.type === g.type))
						)
							S[u] = void 0;
						else
							for (h = 0; h < b; h++) {
						...
						if (
							((p = x(e, t, (g = g || l), n, r, i, c, o, s)),
							(h = t.ref) &&
								g.ref != h &&
								(_ || (_ = []),
								g.ref && _.push(g.ref, null, t),
								_.push(h, t.__c || p, t)),
							null != p)
						) {
							if ((null == f && (f = p), null != t.__d))
								(p = t.__d), (t.__d = null);
							else if (i == g || p != o || null == p.parentNode) {
								e: if (null == o || o.parentNode !== e) e.appendChild(p);
								else {
									for (y = o, h = 0; (y = y.nextSibling) && h < b; h += 2)
										if (y == p) break e;
									e.insertBefore(p, o);
								}
				...
				(a.__e = f),
				null != i && "function" != typeof a.type)
			)
				for (u = i.length; u--; ) null != i[u] && m(i[u]);
			for (u = b; u--; ) null != S[u] && P(S[u], S[u]);
			if (_) for (u = 0; u < _.length; u++) U(_[u], _[++u], _[++u]);
		}
		function C(e, a, t) {
		...
		function B(e, a, t, n, r) {
			...
			if (
				...
				if (((i = e.style), "string" == typeof t)) i.cssText = t;
					...
					if (t) for (o in t) (n && t[o] === n[o]) || N(i, o, t[o]);
				}
			else
				"o" === a[0] && "n" === a[1]
					? ((s = a !== (a = a.replace(/Capture$/, ""))),
					  (l = a.toLowerCase()),
					  (a = (l in e ? l : a).slice(2)),
					  t
							? (n || e.addEventListener(a, D, s), ((e.l || (e.l = {}))[a] = t))
							: e.removeEventListener(a, D, s))
					: "list" !== a && "tagName" !== a && "form" !== a && !r && a in e
					? (e[a] = null == t ? "" : t)
					: "function" != typeof t &&
		...
		function x(e, a, t, r, i, c, o, s, l) {
			...
			try {
				e: if ("function" == typeof B) {
					if (
						((S = a.props),
						(b = (d = B.contextType) && r[d.__c]),
						(N = d ? (b ? b.props.value : d.__) : r),
						t.__c
							? (_ = (u = a.__c = t.__c).__ = u.__E)
						...
						null != B.getDerivedStateFromProps &&
							...
							h(u.__s, B.getDerivedStateFromProps(S, u.__s))),
						(g = u.props),
						(p = u.state),
						m)
					)
						...
						if (
							(null == B.getDerivedStateFromProps &&
								...
								u.componentWillReceiveProps(S, N),
							!u.__e &&
								null != u.shouldComponentUpdate &&
								!1 === u.shouldComponentUpdate(S, u.__s, N))
						) {
							for (
								u.props = S,
									u.state = u.__s,
								...
								a.__k[d] && (a.__k[d].__ = a);
							break e;
						}
						null != u.componentWillUpdate && u.componentWillUpdate(S, u.__s, N),
					...
					(u.context = N),
						...
						null != u.getChildContext && (r = h(h({}, r), u.getChildContext())),
						m ||
							null == u.getSnapshotBeforeUpdate ||
							(v = u.getSnapshotBeforeUpdate(g, p)),
						w(e, a, t, r, i, c, o, s, l),
						(u.base = a.__e),
						u.__h.length && o.push(u),
						_ && (u.__E = u.__ = null),
		...
		function T(e, a, t, n, r, i, c, o) {
			...
			if (((r = "svg" === a.type || r), null == e && null != i))
				for (s = 0; s < i.length; s++)
					if (
						null != (u = i[s]) &&
						(null === a.type ? 3 === u.nodeType : u.localName === a.type)
					) {
						(e = u), (i[s] = null);
						break;
					}
			if (null == e) {
				...
				(e = r
					? document.createElementNS("http://www.w3.org/2000/svg", a.type)
					: document.createElement(a.type)),
					(i = null);
			}
			if (null === a.type)
				null != i && (i[i.indexOf(e)] = null), p !== y && (e.data = y);
			else if (a !== t) {
				if (
					(null != i && (i = d.slice.call(e.childNodes)),
					(h = (p = t.props || l).dangerouslySetInnerHTML),
					(m = y.dangerouslySetInnerHTML),
					!o)
				) {
					if (p === l)
					...
					(m || h) &&
						((m && h && m.__html == h.__html) ||
							(e.innerHTML = (m && m.__html) || ""));
				}
				(function (e, a, t, n, r) {
					var i;
					...
					(a.__k = a.props.children),
					m || w(e, a, t, n, "foreignObject" !== a.type && r, i, c, l, o),
					o ||
						("value" in y &&
							void 0 !== y.value &&
							y.value !== e.value &&
		...
		function P(e, a, t) {
			...
			if ((r = e.__k)) for (c = 0; c < r.length; c++) r[c] && P(r[c], a, t);
			null != i && m(i);
		}
		function M(e, a, t) {
		...
		function k(e, a, t) {
			...
			n.__ && n.__(e, a),
				...
				x(
					...
					t && !r ? [t] : i ? null : d.slice.call(a.childNodes),
					c,
					t || l,
					r
				),
			...
			z = (function () {
				function e(a) {
					...
					!(function (e, a) {
						...
						(this.menu = !1),
						(this.nodes = t.nodes()),
						(this.searchMatchNodes = t.collection());
				}
				var a, t, n;
				return (
					(a = e),
					(t = [
						...
						},
						{
							...
							value: function (e) {
								...
								return (
									this.bus.emit("highlight", e),
									Promise.resolve()
										.then(function () {
											t.batch(function () {
												n.removeClass("faded highlighted hidden"),
										...
										.then(function () {
											(a.highlightInProgress = !1),
												a.bus.emit("highlightend", e);
										})
								);
							},
						},
						...
						},
						{
							...
							value: function (e) {
								var a = this,
									...
									o = function (e, a) {
										return 0 === a.indexOf(e)
											? 1 -
													Math.abs(a.length - e.length) /
														Math.max(a.length, e.length)
											: 0;
									},
									s = G()(
										function (e) {
								...
								return (
									this.cachedNodeWords ||
										(this.cy.batch(function () {
											a.nodes.forEach(c);
										}),
										(this.cachedNodeWords = !0)),
									(this.searchMatchNodes = this.nodes
										.filter(function (e) {
											return s(e) > 0.25;
										})
										.sort(function (e, a) {
				...
				nodes: [
					{
						data: {
							...
							Strength: 1,
							selected: !1,
							cytoscape_alias_list: ["글 묘사"],
							canonicalName: "글 묘사",
							Quality: 70,
							SUID: 4,
							NodeType: "Main",
							name: "글 묘사",
							NOTE: "https://www.notion.so/violet-note/8ff7a8fa9f6e4906ab1a02ef4828ceae?pvs=4",
							MINDMAP: "https://whimsical.com/8vKrVAva9QELmkU9gbpe3z",
							shared_name: "글 묘사",
							Maintopic1: "글쓰기 노트",
							Maintopic2: "생생 짧게 쉽게",
						},
					...
					},
					{
						data: {
							...
							NodeType: "Main",
							name: "발표 원칙",
							NOTE: "https://www.notion.so/violet-note/e196abdef9004ec3b80803c15a2cefde?pvs=4",
							MINDMAP: "https://whimsical.com/PyVvBRccuobfnEmD2KHvte",
							shared_name: "발표 원칙",
							Maintopic1: "천천히 끊기 사례",
						},
					...
					},
					{
						data: {
							...
							NodeType: "Main",
							name: "대화 원칙",
							NOTE: "https://www.notion.so/violet-note/b94210a78a47484c89571becc1d77d8e?pvs=4",
							shared_name: "대화 원칙",
							MINDMAP: "https://whimsical.com/7pn5GLYfhkH5uU6NJJoRJm",
							Maintopic1: "대화 노트",
							Maintopic2: "질문 흐름 낮게 좋게 짧게",
						},
					...
					},
					{
						data: {
							...
							NodeType: "Main",
							name: "HTML",
							NOTE: "https://www.notion.so/violet-note/WEB1-HTML-Internet-27d15643a6ab40bd874f6ea157c49c4c?pvs=4",
							MINDMAP: "https://whimsical.com/html-RbCPZMZXwzhdkHqFFjkRTY",
							shared_name: "HTML",
							Maintopic1: "코딩 노트",
							Maintopic2: "",
						},
					...
					},
					{
						data: {
							...
							Strength: 9,
							selected: !1,
							cytoscape_alias_list: ["중요"],
							canonicalName: "중요",
							Quality: 99,
							SUID: 0,
							NodeType: "Main",
							name: "중요",
							NOTE: "https://www.notion.so/violet-note/4da535b0ba0d480c9f710f10d1776fd1?pvs=4",
							MINDMAP: "https://whimsical.com/VQuSmUEB9vcwnQJMPa8yqU",
							shared_name: "중요",
							Maintopic1: "중요 노트",
							Maintopic2: "",
						},
				...
				edges: [
					{
						data: {
							...
							selected: !1,
							SUID: 9999999,
							canonicalName: "HTML (cc) Javascript",
							name: "HTML (cc) Javascript",
							interaction: "cc",
							shared_interaction: "cc",
							shared_name: "HTML (cc) Javascript",
						},
						selected: !1,
					},
				],
		...
		H.nodes.forEach(function (e) {
			var a = e.data;
			(a.NodeTypeFormatted = a.NodeType),
				(e.data.orgPos = { x: e.position.x, y: e.position.y }),
		...
		function K(e, a) {
			return !a || ("object" !== q(a) && "function" != typeof a)
				? (function (e) {
						if (void 0 === e)
							...
							a.mount(n),
								...
								a.on(
									...
									(this.onTap = function (e) {
										e.target === a
											? (t.unhighlight(), t.hideInfo(), t.closeMenu())
		...
		function ae(e, a) {
			return !a || ("object" !== $(a) && "function" != typeof a)
				? (function (e) {
						if (void 0 === e)
							throw new ReferenceError(
								"this hasn't been initialised - super() hasn't been called"
		...
		function ue(e, a) {
			return !a || ("object" !== le(a) && "function" != typeof a)
				? (function (e) {
						if (void 0 === e)
							throw new ReferenceError(
								"this hasn't been initialised - super() hasn't been called"
		...
		var ge = (function (e) {
			function a(e) {
				...
				!(function (e, a) {
					...
					(t = ue(this, he(a).call(this, e)));
				var n = e.controller,
					r = n.bus;
				return (
					(t.state = { open: n.isMenuOpen() }),
					r.on(
						"openMenu",
						(t.onOpenMenu = function () {
							t.setState({ open: !0 }), t.focusTextBox();
						})
					),
					r.on(
						"closeMenu",
				...
				(n = [
					{
						...
						value: function () {
							...
							e.removeListener("openMenu", this.onOpenMenu),
								e.removeListener("closeMenu", this.onCloseMenu),
					...
					},
					{
						...
						value: function () {
							...
							return (
								...
								g("div", { class: "menu-parent" }, [
									g("div", {
										class: ce()({ "menu-toggle": !0, "menu-open": n }),
										onClick: function () {
											return a.toggleMenu();
										},
									}),
									g("div", { class: ce()({ menu: !0, "menu-closed": i }) }, [
										g("input", {
											type: "text",
											class: "menu-search",
											placeholder: "Search",
		...
		function fe(e, a) {
			return !a || ("object" !== pe(a) && "function" != typeof a)
				? (function (e) {
						if (void 0 === e)
							throw new ReferenceError(
								"this hasn't been initialised - super() hasn't been called"
		...
		var Se = (function (e) {
				function a(e) {
					...
					var r = new z({ cy: n }),
						i = r.bus;
					return (
						s && ((window.cy = n), (window.controller = r)),
						(t.state = { controller: r, cy: n }),
						i.on(
							"showInfo",
							(t.onShowInfo = function (e) {
								t.setState({ infoNode: e });
							})
						),
						i.on(
							"hideInfo",
							(t.onHideInfo = function () {
								t.setState({ infoNode: null });
							})
						),
						t
					);
					...
					(n = [
						{
							...
							value: function () {
								...
								e.removeListener("showInfo", this.onShowInfo),
									e.removeListener("hideInfo", this.onHideInfo);
							},
						},
						{
							key: "render",
							value: function () {
								...
								return g("div", { class: "app" }, [
									g(J, { cy: a, controller: t }),
									n
										? g("div", { class: "app-node-info" }, [g(re, { node: n })])
										: null,
									g(ge, { controller: t }),
								]);
							},
		...
		be.setAttribute("id", "root"),
			document.body.appendChild(be),
			k(g(Se), be),
			console.log("oVIOLETo mindmap");
	},
	48: function (e, a) {
		var t;
		t = (function () {
		...
		(function (a) {
			...
			e.exports = function (e, a, n) {
				...
				return (
					...
					f(n) &&
						((u = !!n.leading),
						(c = (h = "maxWait" in n) ? g(v(n.maxWait) || 0, a) : c),
